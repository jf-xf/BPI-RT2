...
proto_dhcpv6_init_config() {
	...
	proto_config_add_string dslite_mode
	proto_config_add_string dslite_peeraddr
...
proto_dhcpv6_setup() {
	...
	[ -n "$dslite_mode" ] && proto_export "DSLITE_MODE=$dslite_mode"
	[ -n "$dslite_peeraddr" ] && proto_export "DSLITE_PEERADDR=$dslite_peeraddr"
