...
static dal_mapper_t dal_ca8277b_mapper =
{
    ...
    .rt_epon_mibCounter_reset           = dal_rt_ca8277b_epon_mibCounter_reset,
...
static const struct proc_ops ca_rtk_to_pon_fop = {
    .proc_open           = ca_rtk_to_pon_open_proc,
    .proc_write          = ca_rtk_to_pon_write,
    .proc_read           = seq_read,
    .proc_lseek          = seq_lseek,
    .proc_release        = single_release,
};
...
{
    char tmpBuf[16] = {0},buf[4];
    ssize_t len = 0,pkt_len = 0,i;
    struct file *f;
    mm_segment_t old_fs;
    ssize_t ret;
    loff_t pos = 0;
