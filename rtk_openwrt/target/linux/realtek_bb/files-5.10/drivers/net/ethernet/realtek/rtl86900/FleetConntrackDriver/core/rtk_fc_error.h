...
#ifndef __RTK_FC_ERROR_H__
#define __RTK_FC_ERROR_H__
...
#include "rt_flow_ext.h" //for rt_flow_callback_func_ret_t
...
#define  RTK_FC_RET_CODE_BASIS 0x10000				//(RT_ERR_COMMON_END+1)					// 0x10000

typedef enum rtk_fc_ret_e
{
	RTK_FC_RET_OK=0,

	/* API error */
	RTK_FC_RET_ERR 		= (RTK_FC_RET_CODE_BASIS << 0), 									//0x10000
	RTK_FC_RET_ERR_NULL_POINTER,						//input pointer is null
	RTK_FC_RET_ERR_INVALID_PARAM,						//parameters is invalid
	RTK_FC_RET_ERR_CHIP_NOT_SUPPORT,
	RTK_FC_RET_ERR_BUF_OVERFLOW,

	RTK_FC_RET_ERR_INDEX_OUT_OF_RANGE,												// 0x10005
	RTK_FC_RET_ERR_ENTRY_FULL,						//the entry table is full
	RTK_FC_RET_ERR_ENTRY_EXIST,						//for any table if the adding entry has existed in tables
	RTK_FC_RET_ERR_ENTRY_NOT_FOUND,					//for any table if the search/delete entry can not found in tables
	RTK_FC_RET_ERR_FLOW_NOT_FOUND,					//FLOW entry is not found
	RTK_FC_RET_ERR_FLOW_FULL,							//FLOW table is overflow				// 0x1000a
	RTK_FC_RET_ERR_FLOW_TIMEOUT,						//FLOW entry is timeout
	RTK_FC_RET_ERR_FLOW_LRU,							//FLOW entry is LRU

	RTK_FC_RET_ERR_OVER_RATE_LIMIT,
	RTK_FC_RET_ERR_EXHAUST_SKB,

	/* Learning error */
	RTK_FC_RET_LRN_FAIL	= (RTK_FC_RET_CODE_BASIS << 1),								// 0x20000
	RTK_FC_RET_LRN_NULL_POINTER,
	RTK_FC_RET_LRN_SKIP_UNKNOWNSA,
	RTK_FC_RET_LRN_SKIP_NOL4,
	RTK_FC_RET_LRN_SKIP_LOCALINOUT,
	RTK_FC_RET_LRN_SKIP_CTRLPKT,
	//============================
	RTK_FC_RET_LRN_SKIP_MCPKT,
	RTK_FC_RET_LRN_SKIP_FROMCPUPKT,
	RTK_FC_RET_LRN_SKIP_DUPLICATE,
	RTK_FC_RET_LRN_SKIP_COLLISION,
	RTK_FC_RET_LRN_SKIP_FLOODING,
	//============================
	RTK_FC_RET_LRN_NOT_SUPPORT,
	RTK_FC_RET_LRN_NOT_SUPPORT_ALG,
	RTK_FC_RET_LRN_SHORTCUT_MISS,
	RTK_FC_RET_LRN_HASHING_FAILED,
	RTK_FC_RET_LRN_NO_INGRESS_DATA_AVAILABLE,
	//============================
	RTK_FC_RET_LRN_SHORTCUT_TX,
	RTK_FC_RET_LRN_SKIP_IGMP_MLD,
	RTK_FC_RET_LRN_SKIP_ICMPv6,
	RTK_FC_RET_LRN_SKIP_ALG,
	RTK_FC_RET_LRN_SKIP_TTL,
	//============================
	RTK_FC_RET_LRN_SKIP_SHORTCUT,
	RTK_FC_RET_LRN_SKIP_FRAG,
	RTK_FC_RET_LRN_DISABLE_SW_ACCELERATION,
	RTK_FC_RET_LRN_DISABLE_HW_ACCELERATION,
	RTK_FC_RET_LRN_TRAP_TO_PS,   // return value from callback function: RTK_FC_RET_CALLBACK_FUNC_TRAP
		

	/* drop code */
	RTK_FC_RET_DROP			= (RTK_FC_RET_CODE_BASIS << 2),							// 0x40000
	RTK_FC_RET_DROP_PORTLEARNING_LIMIT,
	RTK_FC_RET_DROP_GROUPLEARNING_LIMIT,
	RTK_FC_RET_DROP_VLANGROUPLEARNING_LIMIT,
	RTK_FC_RET_DROP_WIFILEARNING_LIMIT,
	RTK_FC_RET_DROP_WIFI_BLOCK_RELAY,
	RTK_FC_RET_DROP_WAN_ACCESS_LIMIT,
	RTK_FC_RET_DROP_SHAPING_RATE_LIMIT,
	RTK_FC_RET_DROP_CALLBACK_FUNC, // return value from callback function: RT_FLOW_CB_FUNC_RET_DROP
	RTK_FC_RET_DROP_SW_RATE_LIMIT,
	RTK_FC_RET_DROP_DUMMY,
	RTK_FC_RET_DROP_INVALID_STREAMID,
	RTK_FC_RET_DROP_NO_MEMORY,
	RTK_FC_RET_DROP_MTU_FAIL_NO_SW_ID_IFNO, // for 8277C: MTU check failed and can not recover wifi rx sw_id by LUT.
	RTK_FC_RET_DROP_IPSEC_SC_FIFO_FULL,
	RTK_FC_RET_DROP_IPSEC_SC_NAT_T_HDRERR,
	RTK_FC_RET_DROP_IPSEC_SC_IPI_FULL,
	RTK_FC_RET_DROP_IPSEC_SLOW_IPI_FULL,
	RTK_FC_RET_DROP_IPSEC_DMAALLOC_FAIL,
	RTK_FC_RET_DROP_END,
...
#if defined(__KERNEL__) && !defined(__RTK_RG_ERROR_H__)
//1 To compatible with ApolloPro ASIC driver
/* ERROR NO =============================================================== */
typedef enum rtk_rg_err_code_e
{
	...
	RT_ERR_RG_ACL_TRAP_TO_PS,				//hit ACL_RG Trap_to_PS rule 						//0x100b2
