...
static rt_epon_info_notify_cb dal_rt_rtl8277c_epon_info_callback = NULL;



int nic_register_rxhook(int portmask,int priority,p2rfunc_t rx);
static void _dal_rt_rtl8277c_epon_infoChange_notify(rtk_epon_info_notify_t info);
...
void _dal_rtl8277c_epon_infoChange_notify(rt_epon_info_notify_t info)
{
    if(NULL!=dal_rt_rtl8277c_epon_info_callback)
        dal_rt_rtl8277c_epon_info_callback(info);
}




ca_uint32_t dal_rt_rtl8277c_epon_register_status_intr(ca_device_id_t device_id,ca_uint32_t event_id,ca_void_t *event,ca_uint32_t len,ca_void_t *cookie)
{
    ...
    if(evt_ptr->status == 1)
    {
        ...
        _dal_rtl8277c_epon_infoChange_notify(eventInfo);    
    }
    else
    {
...
ca_uint32_t dal_rt_rtl8277c_epon_link_intr(ca_device_id_t device_id,ca_uint32_t event_id,ca_void_t *event,ca_uint32_t len,ca_void_t *cookie)
{
...
ca_uint32_t dal_rt_rtl8277c_epon_mpcp_event_intr(ca_device_id_t device_id,ca_uint32_t event_id,ca_void_t *event,ca_uint32_t len,ca_void_t *cookie)
{
...
ca_uint32_t dal_rt_rtl8277c_epon_mpcp_register_rx_intr(ca_device_id_t device_id,ca_uint32_t event_id,ca_void_t *event,ca_uint32_t len,ca_void_t *cookie)
{
 ...
 */
int32 
dal_rt_rtl8277c_epon_deinit(uint8 pon_mode)
{
    int ret;
    uint16 llidIdx = 0;
    ca_uint32_t ppid = 0;
    ...
    if((ret = ca_event_deregister(0,CA_EVENT_EPON_REG_STAT_CHNG,dal_rt_rtl8277c_epon_register_status_intr))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init event epon stat changing event deregister Error!!\n");
    }
        /*laser link status change*/        
    if((ret = ca_event_deregister(0,CA_EVENT_EPON_PORT_LINK,dal_rt_rtl8277c_epon_link_intr))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init  event epon port link deregister Error!!\n");
    }    
        /*mpcp event handle*/
    if((ret = ca_event_deregister(0,CA_EVENT_EPON_MPCP_EVENT,dal_rt_rtl8277c_epon_mpcp_event_intr))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init  event CA_EVENT_EPON_MPCP_EVENT deregister Error!!\n");
    }          
        /*register packet rx notify*/
    if((ret = ca_event_deregister(0,CA_EVENT_EPON_MPCP_REG_RX,dal_rt_rtl8277c_epon_mpcp_register_rx_intr))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init  event CA_EVENT_EPON_MPCP_REG_RX deregister Error!!\n");
    }          
 ...
 */
int32 
dal_rt_rtl8277c_epon_init(void)
{
	int ret;
...
//    mdelay(1000);
    ...
    dal_rt_rtl8277c_ponmisc_mode_set(RT_EPON_MODE,RT_BOTH10G_SPEED);
#endif
    ...
    if((ret = dal_rt_rtl8277c_ponmisc_tcont_llid_logic2phy_get(0,&llidIdx) != RT_ERR_OK))
    {
    ...
    if((ret = dal_rtl8277c_trap_oamPduAction_set(ACTION_TRAP2CPU)) != RT_ERR_OK)
    {
    ...
    printk("%s %d FPGA epon init at 10G10G EPON\n",__FUNCTION__,__LINE__);
#endif


    /*register event Notify*/
        /*register status change*/        
    if((ret = ca_event_register(0,CA_EVENT_EPON_REG_STAT_CHNG,dal_rt_rtl8277c_epon_register_status_intr,NULL))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init event epon stat changing event register Error!!\n");
    }
        /*laser link status change*/        
    if((ret = ca_event_register(0,CA_EVENT_EPON_PORT_LINK,dal_rt_rtl8277c_epon_link_intr,NULL))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init  event epon port link register Error!!\n");
    }    
        /*mpcp event handle*/
    if((ret = ca_event_register(0,CA_EVENT_EPON_MPCP_EVENT,dal_rt_rtl8277c_epon_mpcp_event_intr,NULL))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init  event CA_EVENT_EPON_MPCP_EVENT Error!!\n");
    }          
        /*register packet rx notify*/
    if((ret = ca_event_register(0,CA_EVENT_EPON_MPCP_REG_RX,dal_rt_rtl8277c_epon_mpcp_register_rx_intr,NULL))!=CA_E_OK)
    {
        printk("EPON dal_rt_rtl8277c_epon_init  event CA_EVENT_EPON_MPCP_REG_RX Error!!\n");
    }          

	epon_init = INIT_COMPLETED;
    return RT_ERR_OK;    
} /* end of dal_rt_rtl8277c_epon_init */

/* Function Name:
 *      dal_rt_rtl8277c_epon_oam_tx
 * Description:
 ...
 */
int32
dal_rt_rtl8277c_epon_oam_tx(uint32 msgLen, uint8 *pMsg, uint8 llidIdx)
{
...
} /* end of dal_rt_rtl8277c_epon_oam_tx */

/* Function Name:
 *      dal_rt_rtl8277c_epon_oam_rx_callback_register
 * Description:
 ...
 */
int32
dal_rt_rtl8277c_epon_oam_rx_callback_register(rt_epon_oam_rx_callback oamRx)
{
    int32   ret;
    rt_port_t pon;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_oam_rx_callback_register */

/* Function Name:
 *      dal_rt_rtl8277c_epon_dyinggasp_set
 * Description:
 ...
 */
int32
dal_rt_rtl8277c_epon_dyinggasp_set(uint32 msgLen, uint8 *pMsg)
{
...
} /* end of dal_rt_rtl8277c_epon_dyinggasp_set */

/* Function Name:
 *      dal_rt_rtl8277c_epon_llid_entry_get
 * Description:
 *      Get llid entry
 * Input:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_llid_entry_get(rt_epon_llid_entry_t *pLlidEntry)  
{
    ...
    ret = dal_rt_rtl8277c_epon_losState_get(&losState);
    if(ret != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_EPON), "");
        return RT_ERR_FAILED;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_llid_entry_get */





int32 dal_rt_rtl8277c_raw_epon_mpcp_registration_set
(
...
/* Function Name:
 *      dal_rt_rtl8277c_epon_llid_entry_set
 * Description:
 *      Set llid entry
 * Input:
 *      llidIdx: LLID table index
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_llid_entry_set(rt_epon_llid_entry_t *pLlidEntry)  
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    if(pLlidEntry->valid == DISABLED)
    {
        ...
        if((ret = dal_rt_rtl8277c_raw_epon_mpcp_registration_set(0, port_id, (ca_uint8_t)llid, 0))!=CA_E_OK)
        {
            if(ret != CA_E_NOT_FOUND)
            {
                RT_ERR(ret, (MOD_DAL|MOD_EPON), "");
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_llid_entry_set */

/* Function Name:
 *      dal_rt_rtl8277c_epon_registerReq_get
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_registerReq_get(rt_epon_regReq_t *pRegEntry)
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_registerReq_get */




/* Function Name:
 *      dal_rt_rtl8277c_epon_registerReq_set
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_registerReq_set(rt_epon_regReq_t *pRegEntry)
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    if(pRegEntry->doRequest == ENABLED)
    {
        ...
        if((ret = dal_rt_rtl8277c_raw_epon_mpcp_registration_set(0, port_id, (ca_uint8_t)llid, 1))!=CA_E_OK)
        {
            if(ret != CA_E_NOT_FOUND)
            {
                RT_ERR(ret, (MOD_DAL|MOD_EPON), "");
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_registerReq_set */

/* Function Name:
 *      dal_rt_rtl8277c_epon_churningKey_get
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_churningKey_get(rt_epon_churningKeyEntry_t *pEntry)
{
    ca_status_t ret=CA_E_OK;
#if 1
    rt_port_t pon_port;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_churningKey_get */

/* Function Name:
 *      dal_rt_rtl8277c_epon_churningKey_set
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_churningKey_set(rt_epon_churningKeyEntry_t *pEntry)
{
#if 1
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
...
#endif
    return RT_ERR_OK;
}   /* end of dal_rtl8277c_epon_churningKey_set */

/* Function Name:
 *      dal_rt_rtl8277c_epon_usFecState_get
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_usFecState_get(rt_enable_t *pState)
{
    #if 1
    ca_status_t             ret=CA_E_OK;
    rt_port_t               pon_port;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_usFecState_get */

/* Function Name:
 *      dal_rt_rtl8277c_epon_usFecState_set
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_usFecState_set(rt_enable_t state)
{
#if 1
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
...
#endif
    return ret;
}   /* end of dal_rt_rtl8277c_epon_usFecState_set */

/* Function Name:
 *      dal_rtl8277c_epon_dsFecState_get
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_dsFecState_get(rt_enable_t *pState)
{
#if 1
    ca_status_t             ret=CA_E_OK;
    rt_port_t               pon_port;
...
#endif
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_dsFecState_get */

/* Function Name:
 *      dal_rt_rtl8277c_epon_dsFecState_set
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_dsFecState_set(rt_enable_t state)
{
#if 1
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
...
#endif
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_dsFecState_set */

/* Function Name:
 *      dal_rt_rtl8277c_epon_mibCounter_get
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_mibCounter_get(rt_epon_counter_t *pCounter)
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    pCounter->mpcpTxRegAck = mpcp_mac_ctrl.mpcp_tx_reg_ack;
    
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_mibCounter_get */

/* Function Name:
 *      dal_rt_rtl8277c_epon_mibCounter_reset
 * Description:
 ...
 */
int32 dal_rt_rtl8277c_epon_mibCounter_reset(void)
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    aal_epon_fec_stats_t        stats;
    uint32                      readClearStatus=0;
    aal_epon_fec_cfg_t          fec_1g_cfg;
    aal_epon_fec_msk_t          fec_1g_msk;
    aal_epon_mac_stats_port_mpcp_t stats_port_mpcp;
    aal_epon_mac_stats_port_mpcp_ctrl_t mpcp_mac_ctrl;
    ...
    if (onu_type == AAL_ONU_TYPE_1G_1G)
    {
        /*clear mib for 1G FEC */    
        __PON_LOCK();
        ret = aal_epon_fec_cfg_get(0, port_id,&fec_1g_cfg);

        if(fec_1g_cfg.cnt_clr == 0)
        {
            readClearStatus=0;
            memset(&fec_1g_msk, 0, sizeof(fec_1g_msk));
            memset((void *)&fec_1g_cfg, 0, sizeof(fec_1g_cfg));
        ...
        /*restore config*/
        if(readClearStatus == 0)
        {
            memset(&fec_1g_msk, 0, sizeof(fec_1g_msk));
            memset((void *)&fec_1g_cfg, 0, sizeof(fec_1g_cfg));
            fec_1g_msk.s.cnt_clr = 1;
            fec_1g_cfg.cnt_clr = 0;
            ret = aal_epon_fec_cfg_set(0, port_id, fec_1g_msk, &fec_1g_cfg);
        }
        __PON_UNLOCK();

    }else{ /*10G FEC mib counter always read clear*/
        /*clear mib for 10G FEC */    
        __PON_LOCK();
        ret = aal_epon_fec_xg_stats_get(0, port_id, &stats);
        __PON_UNLOCK();
    }

    /*clear mib for epon_mac */    
    __PON_LOCK();
    /*set epon mac mib to read clear*/
    ret = aal_epon_mac_mib_rc_get(0, port_id, &read_clear);
    if(read_clear == CA_FALSE)
    {
        readClearStatus=0;
        (void)aal_epon_mac_mib_rc_set(0, port_id, CA_TRUE);  /* PON MIB read-keep */    
    }
    else
    {
        readClearStatus=1;
    ...
    if(readClearStatus == 0)
    {
        (void)aal_epon_mac_mib_rc_set(0, port_id, CA_FALSE);   
    }
    __PON_UNLOCK();
...
/* Function Name:
 *      dal_rt_rtl8277c_epon_losState_get
 * Description:
 ...
 *      None
 */
int32 dal_rt_rtl8277c_epon_losState_get(rt_enable_t *pState)
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_losState_get */
...
/* Function Name:
 *      dal_rt_rtl8277c_epon_lofState_get
 * Description:
 ...
 *      None
 */
int32 dal_rt_rtl8277c_epon_lofState_get(rt_enable_t *pState)
{
    ca_status_t ret=CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;
}   /* end of dal_rt_rtl8277c_epon_lofState_get */




/* Function Name:
 *      dal_rt_rtl8277c_epon_mpcp_gate_timer_set
 * Description:
 ...
 */
int32 
dal_rt_rtl8277c_epon_mpcp_gate_timer_set(uint32 gateTimer,rt_enable_t deregistration)
{
    ca_status_t         ret = CA_E_OK;
    rt_port_t pon_port;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;    
}/* end of dal_rt_rtl8277c_epon_mpcp_gate_timer_set */




/* Function Name:
 *      dal_rt_rtl8277c_epon_mpcp_gate_timer_get
 * Description:
 ...
 */
int32 
dal_rt_rtl8277c_epon_mpcp_gate_timer_get(uint32 *pGateTimer,rt_enable_t *pDeregistration)
{
    ca_status_t         ret = CA_E_OK;
    aal_mpcp_cfg_t      cfg;
    rt_port_t pon_port;
    ...
    *pDeregistration = cfg.gatetimer_dereg_en;
    ...
    return RT_ERR_OK;    
}/* end of dal_rt_rtl8277c_epon_mpcp_gate_timer_get */




/* Function Name:
 *      dal_rt_rtl8277c_epon_info_notify_callback_register
 * Description:
 ...
 * Note:
 */
int32 dal_rt_rtl8277c_epon_info_notify_callback_register(rt_epon_info_notify_cb callBack)
{
    
    dal_rt_rtl8277c_epon_info_callback = callBack;
...
/* Function Name:
 *      dal_rt_rt8277c_epon_ponLoopback_set
 * Description:
 ...
 *      None
 */
int32 dal_rt_rt8277c_epon_ponLoopback_set(uint32 llid,rt_enable_t enable)
{
