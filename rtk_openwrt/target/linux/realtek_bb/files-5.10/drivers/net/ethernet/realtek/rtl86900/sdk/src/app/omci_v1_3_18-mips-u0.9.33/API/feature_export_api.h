...
enum
{
    ...
    FEATURE_API_BDP_00000040,
    FEATURE_API_BDP_00000080,
    FEATURE_API_BDP_00000100,
    FEATURE_API_BDP_00000200,
    FEATURE_API_BDP_00000400,
    FEATURE_API_RDP_00000001_X_BDG_CONN,
    FEATURE_API_RDP_00000001_RESET_PPTP,
    FEATURE_API_RDP_00000004,
    FEATURE_API_MC_00000001,
    FEATURE_API_MC_00000002,
    FEATURE_API_MC_00000004,
    FEATURE_API_ME_00000002,
    FEATURE_API_ME_00000004,
    FEATURE_API_ME_00000008,
    FEATURE_API_ME_00000010,
    FEATURE_API_ME_00000020_IS_ENABLED,
    FEATURE_API_ME_00000020_IS_SUPPORTED,
    FEATURE_API_ME_00000020_UPGRADE_CFG,
    FEATURE_API_ME_00000040_IS_SUPPORTED,
    FEATURE_API_ME_00000040_GET_INFO,
    FEATURE_API_ME_00000040_SET_INFO,
    FEATURE_API_ME_00000080,
    FEATURE_API_ME_00000100,
    FEATURE_API_ME_00000400_IS_ENABLED,
    FEATURE_API_ME_00000400_DRV_CFG,
    FEATURE_API_ME_00000800_IS_ENABLED,
    FEATURE_API_ME_00000800_DRV_CFG,
    FEATURE_API_ME_00001000,
    FEATURE_API_ME_00002000,
    FEATURE_API_ME_00004000,
    FEATURE_API_ME_00008000,
    FEATURE_API_ME_00010000,
    FEATURE_API_ME_00020000,
    FEATURE_API_ME_00040000,
    FEATURE_API_ME_00080000,
    FEATURE_API_VOICE_RTK_CFG_OP,
    FEATURE_API_RDP_00000008_ADD_IF_TR69,
    FEATURE_API_RDP_00000008_UPDATE_IF_TR69,
    FEATURE_API_RDP_00000010_ADD_IF_SIP,
    FEATURE_API_RDP_00000010_UPDATE_IF_SIP,
    FEATURE_API_ME_00080000_FORCE_METERTYPE,
    FEATURE_API_MCAST_RG_IGMP_SET,
    FEATURE_API_MCAST_RG_IGMP_GET,
    FEATURE_API_ME_00400000,
    FEATURE_API_END
};
