...
#include <dal/rtl8277c/dal_rtl8277c_vlan.h>
#include <dal/rtl8277c/dal_rtl8277c_port.h>
#include <dal/rtl8277c/dal_rtl8277c_qos.h>
#include <dal/rtl8277c/dal_rtl8277c_stat.h>
#include <dal/rtl8277c/dal_rtl8277c_rate.h>
#include <dal/rtl8277c/dal_rtl8277c_sec.h>
#include <dal/rtl8277c/dal_rtl8277c_intr.h>
#include <dal/rtl8277c/dal_rtl8277c_epon.h>
#include <dal/rtl8277c/dal_rtl8277c_trap.h>
#include <dal/rtl8277c/dal_rtl8277c_i2c.h>
...
#include <dal/rtl8277c/dal_rtl8277c_mirror.h>
...
#include <dal/rtl8277c/dal_rt_rtl8277c_epon.h>
...
static dal_mapper_t dal_rtl8277c_mapper =
{
    0,//Kem TBD
    ._init = NULL,

    /*sec*/
    .sec_init = dal_rtl8277c_sec_init,
    .sec_portAttackPreventState_get = dal_rtl8277c_sec_portAttackPreventState_get,
    .sec_portAttackPreventState_set = dal_rtl8277c_sec_portAttackPreventState_set,
    .sec_attackPrevent_get = dal_rtl8277c_sec_attackPrevent_get,
    .sec_attackPrevent_set = dal_rtl8277c_sec_attackPrevent_set,
    .sec_attackFloodThresh_get = dal_rtl8277c_sec_attackFloodThresh_get,
    .sec_attackFloodThresh_set = dal_rtl8277c_sec_attackFloodThresh_set,
    .sec_attackFloodThreshUnit_get = dal_rtl8277c_sec_attackFloodThreshUnit_get,
    .sec_attackFloodThreshUnit_set = dal_rtl8277c_sec_attackFloodThreshUnit_set,

    /* statistics */
    .stat_init                                  = dal_rtl8277c_stat_init,
    .stat_global_reset                          = NULL,
    .stat_port_reset                            = dal_rtl8277c_stat_port_reset,
    .stat_log_reset                             = NULL,
    ...
    .stat_port_get                              = dal_rtl8277c_stat_port_get,
    .stat_port_getAll                           = dal_rtl8277c_stat_port_getAll,
    .stat_log_get                               = NULL,
    ...
    /* Switch */
    .switch_init = dal_rtl8277c_switch_init,
    .switch_phyPortId_get = dal_rtl8277c_switch_phyPortId_get,
    ...
    .switch_chip_reset = dal_rtl8277c_switch_chip_reset,
    .switch_version_get = dal_rtl8277c_switch_version_get,
    .switch_patch_info_get = NULL,
    .switch_csExtId_get = NULL,
    .switch_maxPktLenByPort_get = dal_rtl8277c_switch_maxPktLenByPort_get,
    .switch_maxPktLenByPort_set = dal_rtl8277c_switch_maxPktLenByPort_set,
    .switch_changeDuplex_get = NULL,
    .switch_changeDuplex_set = NULL,
    .switch_system_init = NULL,
    .switch_thermal_get = dal_rtl8277c_switch_thermal_get,

    /* Port */
    .port_init                                  = dal_rtl8277c_port_init,
    .port_link_get                              = dal_rtl8277c_port_link_get,
    .port_speedDuplex_get                       = dal_rtl8277c_port_speedDuplex_get,
    .port_flowctrl_get                          = dal_rtl8277c_port_flowctrl_get,
    .port_phyAutoNegoEnable_get                 = dal_rtl8277c_port_phyAutoNegoEnable_get,
    .port_phyAutoNegoEnable_set                 = dal_rtl8277c_port_phyAutoNegoEnable_set,
    .port_phyAutoNegoAbility_get                = dal_rtl8277c_port_phyAutoNegoAbility_get,
    .port_phyAutoNegoAbility_set                = dal_rtl8277c_port_phyAutoNegoAbility_set,
    .port_phyForceModeAbility_get               = dal_rtl8277c_port_phyForceModeAbility_get,
    .port_phyForceModeAbility_set               = dal_rtl8277c_port_phyForceModeAbility_set,
    .port_phyMasterSlave_get                    = NULL,
    .port_phyMasterSlave_set                    = NULL,
    .port_phyTestMode_get                       = NULL,
    .port_phyTestMode_set                       = NULL,
    .port_phyReg_get                            = dal_rtl8277c_port_phyReg_get,
    .port_phyReg_set                            = dal_rtl8277c_port_phyReg_set,
    ...
    .port_isolationEntry_get                    = dal_rtl8277c_port_isolationEntry_get,
    .port_isolationEntry_set                    = dal_rtl8277c_port_isolationEntry_set,
    ...
    .port_adminEnable_get                       = dal_rtl8277c_port_adminEnable_get,
    .port_adminEnable_set                       = dal_rtl8277c_port_adminEnable_set,
    ...
    .port_phyPowerDown_set                      = dal_rtl8277c_port_phyPowerDown_set,
    .port_phyPowerDown_get                      = dal_rtl8277c_port_phyPowerDown_get,
    .port_enhancedFid_get                       = NULL,
    .port_enhancedFid_set                       = NULL,
    .port_rtctResult_get                        = NULL,
    .port_rtct_start                            = NULL,
    .port_macForceAbility_set                   = dal_rtl8277c_port_macForceAbility_set,
    .port_macForceAbility_get                   = dal_rtl8277c_port_macForceAbility_get,
    .port_macForceAbilityState_set              = NULL,
    .port_macForceAbilityState_get              = dal_rtl8277c_port_macForceAbilityState_get,
    ...
    .port_serdesMode_set                        = dal_rtl8277c_port_serdesMode_set,
    .port_serdesMode_get                        = dal_rtl8277c_port_serdesMode_get,
    .port_serdesModeSpeed_set                   = dal_rtl8277c_port_serdesModeSpeed_set,
    .port_serdesModeSpeed_get                   = dal_rtl8277c_port_serdesModeSpeed_get,
    .port_serdesNWay_set                        = dal_rtl8277c_port_serdesNWay_set,
    .port_serdesNWay_get                        = dal_rtl8277c_port_serdesNWay_get,
    .port_eeeEnable_get                         = dal_rtl8277c_port_eeeEnable_get,
    .port_eeeEnable_set                         = dal_rtl8277c_port_eeeEnable_set,
    ...
    /* Trap */
    .trap_init                                  = dal_rtl8277c_trap_init,
    ...
    .trap_oamPduAction_get                      = dal_rtl8277c_trap_oamPduAction_get,
    .trap_oamPduAction_set                      = dal_rtl8277c_trap_oamPduAction_set,
    ...
    .trap_omciAction_get                      = dal_rtl8277c_trap_omciAction_get,
    .trap_omciAction_set                      = dal_rtl8277c_trap_omciAction_set,

    /*SVLAN*/
    .svlan_init = dal_rtl8277c_success,
    .svlan_create = NULL,
    .svlan_destroy = NULL,
    ...
    .svlan_extPortPvid_set                      = NULL,
     ...
     /* VLAN */
    .vlan_init                                  = dal_rtl8277c_vlan_init,
    .vlan_create                                = dal_rtl8277c_vlan_create,
    .vlan_destroy                               = dal_rtl8277c_vlan_destroy,
    .vlan_destroyAll                            = dal_rtl8277c_vlan_destroyAll,
    .vlan_fid_get                               = NULL,
    .vlan_fid_set                               = NULL,
    .vlan_fidMode_get                           = dal_rtl8277c_vlan_fidMode_get,
    .vlan_fidMode_set                           = dal_rtl8277c_vlan_fidMode_set,
    .vlan_port_get                              = dal_rtl8277c_vlan_port_get,
    .vlan_port_set                              = dal_rtl8277c_vlan_port_set,
    .vlan_stg_get                               = NULL,
    .vlan_stg_set                               = NULL,
    .vlan_portAcceptFrameType_get               = NULL,
    .vlan_portAcceptFrameType_set               = NULL,
    .vlan_vlanFunctionEnable_get                = dal_rtl8277c_vlan_vlanFunctionEnable_get,
    .vlan_vlanFunctionEnable_set                = dal_rtl8277c_vlan_vlanFunctionEnable_set,
    ...
    .vlan_portPvid_get                          = dal_rtl8277c_vlan_portPvid_get,
    .vlan_portPvid_set                          = dal_rtl8277c_vlan_portPvid_set,
    ...
    /* Mirror */
    .mirror_init                                = dal_rtl8277c_mirror_init,
    .mirror_portBased_set                       = dal_rtl8277c_mirror_portBased_set,
    .mirror_portBased_get                       = dal_rtl8277c_mirror_portBased_get,
    .mirror_portIso_set                         = NULL,
    .mirror_portIso_get                         = NULL,

    /* STP */
    .stp_init = dal_rtl8277c_success,
    .stp_mstpState_get = NULL,
    .stp_mstpState_set = NULL,

    /*rate*/
    .rate_init = dal_rtl8277c_rate_init,
    .rate_portIgrBandwidthCtrlRate_get = dal_rtl8277c_rate_portIgrBandwidthCtrlRate_get,
    .rate_portIgrBandwidthCtrlRate_set = dal_rtl8277c_rate_portIgrBandwidthCtrlRate_set,
    .rate_portIgrBandwidthCtrlIncludeIfg_get = NULL,
    .rate_portIgrBandwidthCtrlIncludeIfg_set = NULL,
    .rate_portEgrBandwidthCtrlRate_get = dal_rtl8277c_rate_portEgrBandwidthCtrlRate_get,
    .rate_portEgrBandwidthCtrlRate_set = dal_rtl8277c_rate_portEgrBandwidthCtrlRate_set,
    ...
    .rate_stormControlMeterIdx_get = dal_rtl8277c_rate_stormControlMeterIdx_get,
    .rate_stormControlMeterIdx_set = dal_rtl8277c_rate_stormControlMeterIdx_set,
    .rate_stormControlPortEnable_get = dal_rtl8277c_rate_stormControlPortEnable_get,
    .rate_stormControlPortEnable_set = dal_rtl8277c_rate_stormControlPortEnable_set,
    .rate_stormControlEnable_get = NULL,
    .rate_stormControlEnable_set = NULL,
    .rate_stormBypass_set = NULL,
    .rate_stormBypass_get = NULL,
    .rate_shareMeter_set = dal_rtl8277c_rate_shareMeter_set,
    .rate_shareMeter_get = dal_rtl8277c_rate_shareMeter_get,
    .rate_shareMeterBucket_set = dal_rtl8277c_rate_shareMeterBucket_set,
    .rate_shareMeterBucket_get = dal_rtl8277c_rate_shareMeterBucket_get,
    .rate_shareMeterExceed_get = NULL,
    .rate_shareMeterExceed_clear = NULL,
    .rate_shareMeterMode_set = dal_rtl8277c_rate_shareMeterMode_set,
    .rate_shareMeterMode_get = dal_rtl8277c_rate_shareMeterMode_get,
    ...
    .time_init = dal_rtl8277c_success,
    ...
    .acl_dbgHitReason_get = NULL,
     ...
     /* L2 */
    .l2_init                                    = dal_rtl8277c_l2_init,
    .l2_flushLinkDownPortAddrEnable_get         = dal_rtl8277c_l2_flushLinkDownPortAddrEnable_get,
    .l2_flushLinkDownPortAddrEnable_set         = dal_rtl8277c_l2_flushLinkDownPortAddrEnable_set,
    ...
    .l2_portLimitLearningCnt_get                = dal_rtl8277c_l2_portLimitLearningCnt_get,
    .l2_portLimitLearningCnt_set                = dal_rtl8277c_l2_portLimitLearningCnt_set,
    .l2_portLimitLearningCntAction_get          = dal_rtl8277c_l2_portLimitLearningCntAction_get,
    .l2_portLimitLearningCntAction_set          = dal_rtl8277c_l2_portLimitLearningCntAction_set,
    .l2_aging_get                               = dal_rtl8277c_l2_aging_get,
    .l2_aging_set                               = dal_rtl8277c_l2_aging_set,
    .l2_portAgingEnable_get                     = dal_rtl8277c_l2_portAgingEnable_get,
    .l2_portAgingEnable_set                     = dal_rtl8277c_l2_portAgingEnable_set,
    .l2_lookupMissAction_get                    = dal_rtl8277c_l2_lookupMissAction_get,
    .l2_lookupMissAction_set                    = dal_rtl8277c_l2_lookupMissAction_set,
    .l2_portLookupMissAction_get                = dal_rtl8277c_l2_portLookupMissAction_get,
    .l2_portLookupMissAction_set                = dal_rtl8277c_l2_portLookupMissAction_set,
    ...
    .l2_newMacOp_get                            = dal_rtl8277c_l2_newMacOp_get,
    .l2_newMacOp_set                            = dal_rtl8277c_l2_newMacOp_set,
    .l2_nextValidAddr_get                       = dal_rtl8277c_l2_nextValidAddr_get,
    .l2_nextValidAddrOnPort_get                 = dal_rtl8277c_l2_nextValidAddrOnPort_get,
    .l2_nextValidMcastAddr_get                  = NULL,
    .l2_nextValidIpMcastAddr_get                = NULL,
    .l2_nextValidEntry_get                      = dal_rtl8277c_l2_nextValidEntry_get,
    .l2_addr_add                                = dal_rtl8277c_l2_addr_add,
    .l2_addr_del                                = dal_rtl8277c_l2_addr_del,
    .l2_addr_get                                = dal_rtl8277c_l2_addr_get,
    .l2_addr_delAll                             = dal_rtl8277c_l2_addr_delAll,
    .l2_mcastAddr_add                           = NULL,
    .l2_mcastAddr_del                           = NULL,
    .l2_mcastAddr_get                           = NULL,
    .l2_illegalPortMoveAction_get               = dal_rtl8277c_l2_illegalPortMoveAction_get,
    .l2_illegalPortMoveAction_set               = dal_rtl8277c_l2_illegalPortMoveAction_set,
    ...
    .l2_hashValue_get                           = NULL,
     ...
     /*interrupt*/
    .intr_init = dal_rtl8277c_intr_init,
    .intr_polarity_set = NULL,
    .intr_polarity_get = NULL,
    .intr_imr_set = dal_rtl8277c_intr_imr_set,
    .intr_imr_get = dal_rtl8277c_intr_imr_get,
    .intr_ims_get = NULL,
    .intr_ims_clear = NULL,
...
#if defined(CONFIG_COMMON_RT_API)
    .rt_intr_isr_callback_register = dal_rt_rtl8277c_intr_isr_rx_callback_register,
#endif

    /*cpu*/
    .cpu_init = dal_rtl8277c_success,
    ...
    /* QoS */
    .qos_init = dal_rtl8277c_qos_init,
    .qos_priSelGroup_get = dal_rtl8277c_qos_priSelGroup_get,
    .qos_priSelGroup_set = dal_rtl8277c_qos_priSelGroup_set,
    .qos_portPri_get = NULL,
    .qos_portPri_set = NULL,
    .qos_dscpPriRemapGroup_get = dal_rtl8277c_qos_dscpPriRemapGroup_get,
    .qos_dscpPriRemapGroup_set = dal_rtl8277c_qos_dscpPriRemapGroup_set,
    .qos_1pPriRemapGroup_get = NULL,
    .qos_1pPriRemapGroup_set = NULL,
    .qos_priMap_get = dal_rtl8277c_qos_priMap_get,
    .qos_priMap_set = dal_rtl8277c_qos_priMap_set,
    .qos_portPriMap_get = dal_rtl8277c_qos_portPriMap_get,
    .qos_portPriMap_set = dal_rtl8277c_qos_portPriMap_set,
    ...
    .qos_schedulingQueue_get = dal_rtl8277c_qos_schedulingQueue_get,
    .qos_schedulingQueue_set = dal_rtl8277c_qos_schedulingQueue_set,
    .qos_portPriSelGroup_get = dal_rtl8277c_qos_portPriSelGroup_get,
    .qos_portPriSelGroup_set = dal_rtl8277c_qos_portPriSelGroup_set,
    ...
    /* Classification */
    .classify_init                              = dal_rtl8277c_success,
...
#if defined(CONFIG_COMMON_RT_API)
    .rt_l2_ivlSvl_get                   = dal_rt_rtl8277c_l2_ivlSvl_get,
    .rt_l2_ivlSvl_set                   = dal_rt_rtl8277c_l2_ivlSvl_set,
    .rt_cls_init                        = dal_rt_rtl8277c_cls_init,
    .rt_cls_veipPortRule_set            = dal_rt_rtl8277c_cls_veipPortRule_set,
    .rt_cls_rule_add                    = dal_rt_rtl8277c_cls_rule_add,
    .rt_cls_rule_delete                 = dal_rt_rtl8277c_cls_rule_delete,
    .rt_cls_rule_get                    = dal_rt_rtl8277c_cls_rule_get,
    .rt_cls_pon_sid_set                 = dal_rt_rtl8277c_cls_pon_sid_set,
    .rt_cls_fwdPort_set                 = dal_rt_rtl8277c_cls_fwdPort_set,
    .rt_trap_portIgmpMldPktAction_get   = dal_rtl8277c_trap_portIgmpMldPktAction_get,
    .rt_trap_portIgmpMldPktAction_set   = dal_rtl8277c_trap_portIgmpMldPktAction_set,
    .rt_trap_portDhcpPktAction_get      = dal_rtl8277c_trap_portDhcpPktAction_get,
    .rt_trap_portDhcpPktAction_set      = dal_rtl8277c_trap_portDhcpPktAction_set,
    .rt_trap_portPppoePktAction_get     = dal_rtl8277c_trap_portPppoePktAction_get,
    .rt_trap_portPppoePktAction_set     = dal_rtl8277c_trap_portPppoePktAction_set,
    .rt_trap_portStpPktAction_get       = dal_rtl8277c_trap_portStpPktAction_get,
    .rt_trap_portStpPktAction_set       = dal_rtl8277c_trap_portStpPktAction_set,
    .rt_trap_portHostPktAction_get      = dal_rtl8277c_trap_portHostPktAction_get,
    .rt_trap_portHostPktAction_set      = dal_rtl8277c_trap_portHostPktAction_set,
    .rt_trap_portEthertypePktAction_get = dal_rtl8277c_trap_portEthertypePktAction_get,
    .rt_trap_portEthertypePktAction_set = dal_rtl8277c_trap_portEthertypePktAction_set,
    .rt_trap_portArpPktAction_get       = dal_rtl8277c_trap_portArpPktAction_get,
    .rt_trap_portArpPktAction_set       = dal_rtl8277c_trap_portArpPktAction_set,
    .rt_trap_pattern_get                = dal_rtl8277c_trap_pattern_get,
    .rt_trap_pattern_set                = dal_rtl8277c_trap_pattern_set,
    .rt_time_init                       = dal_rtl8277c_time_init,
    .rt_time_curTime_get                = dal_rtl8277c_rt_time_curTime_get,
    .rt_time_offsetTime_set             = NULL,
    .rt_time_ptpPortEnable_set          = NULL,
    .rt_time_ptpPortEnable_get          = NULL,
    .rt_time_ptpIgrAction_set           = NULL,
    .rt_time_ptpIgrAction_get           = NULL,
    .rt_time_ptpEgrAction_set           = NULL,
    .rt_time_ptpEgrAction_get           = NULL,
    .rt_time_ponTodTime_set             = dal_rtl8277c_rt_time_ponTodTime_set,
    .rt_time_ponTodTime_get             = dal_rtl8277c_rt_time_ponTodTime_get,
    .rt_time_ponTodTimeEnable_set       = dal_rtl8277c_rt_time_ponTodTimeEnable_set,
    .rt_time_ponTodTimeEnable_get       = dal_rtl8277c_rt_time_ponTodTimeEnable_get,
    /*RT GPON common API*/
#if defined(CONFIG_GPON_FEATURE)
    .rt_gpon_init                       = dal_rt_rtl8277c_gpon_init,
    .rt_gpon_serialNumber_set           = dal_rt_rtl8277c_gpon_serialNumber_set,
    .rt_gpon_registrationId_set         = dal_rt_rtl8277c_gpon_registrationId_set,
    .rt_gpon_activate                   = dal_rt_rtl8277c_gpon_activate,
    .rt_gpon_deactivate                 = dal_rt_rtl8277c_gpon_deactivate,
    .rt_gpon_omci_tx                    = dal_rt_rtl8277c_gpon_omci_tx,
    .rt_gpon_omci_rx_callback_register  = dal_rt_rtl8277c_gpon_omci_rx_callback_register,
    .rt_gpon_onuState_get               = dal_rt_rtl8277c_gpon_onuState_get,
    .rt_gpon_tcont_set                  = dal_rt_rtl8277c_gpon_tcont_set,
    .rt_gpon_tcont_get                  = dal_rt_rtl8277c_gpon_tcont_get,
    .rt_gpon_tcont_del                  = dal_rt_rtl8277c_gpon_tcont_del,
    .rt_gpon_usFlow_set                 = dal_rt_rtl8277c_gpon_usFlow_set,
    .rt_gpon_usFlow_get                 = dal_rt_rtl8277c_gpon_usFlow_get,
    .rt_gpon_usFlow_del                 = dal_rt_rtl8277c_gpon_usFlow_del,
    .rt_gpon_usFlow_delAll              = dal_rt_rtl8277c_gpon_usFlow_delAll,
    .rt_gpon_dsFlow_set                 = dal_rt_rtl8277c_gpon_dsFlow_set,
    .rt_gpon_dsFlow_get                 = dal_rt_rtl8277c_gpon_dsFlow_get,
    .rt_gpon_dsFlow_del                 = dal_rt_rtl8277c_gpon_dsFlow_del,
    .rt_gpon_dsFlow_delAll              = dal_rt_rtl8277c_gpon_dsFlow_delAll,
    .rt_gpon_loop_gemport_set           = dal_rt_rtl8277c_loop_gemPort_set,
    .rt_gpon_loop_gemport_get           = dal_rt_rtl8277c_loop_gemPort_get,
    .rt_gpon_ponQueue_set               = dal_rt_rtl8277c_gpon_ponQueue_set,
    .rt_gpon_ponQueue_get               = dal_rt_rtl8277c_gpon_ponQueue_get,
    .rt_gpon_ponQueue_del               = dal_rt_rtl8277c_gpon_ponQueue_del,
    .rt_gpon_scheInfo_get               = dal_rt_rtl8277c_gpon_scheInfo_get,
    .rt_gpon_flowCounter_get            = dal_rt_rtl8277c_gpon_flowCounter_get,
    .rt_gpon_pmCounter_get              = dal_rt_rtl8277c_gpon_pmCounter_get,
    .rt_gpon_ponTag_get                 = dal_rt_rtl8277c_gpon_ponTag_get,
    .rt_gpon_msk_set                    = dal_rt_rtl8277c_gpon_msk_set,
    .rt_gpon_omci_mic_generate          = dal_rt_rtl8277c_gpon_omci_mic_generate,
    .rt_gpon_mcKey_set                  = dal_rt_rtl8277c_gpon_mcKey_set,
    .rt_gpon_attribute_get              = dal_rt_rtl8277c_gpon_attribute_get,
    .rt_gpon_attribute_set              = dal_rt_rtl8277c_gpon_attribute_set,
    .rt_gpon_usFlow_phyData_get         = dal_rt_rtl8277c_gpon_usFlow_phyData_get,
    .rt_gpon_omcc_get                   = dal_rt_rtl8277c_gpon_omcc_get,
    .rt_gpon_omci_mirror_set            = dal_rt_rtl8277c_gpon_omci_mirror_set,
    .rt_gpon_omci_mirror_get            = dal_rt_rtl8277c_gpon_omci_mirror_get,
    .rt_gpon_fec_get                    = dal_rt_rtl8277c_gpon_fec_get,
    .rt_gpon_ploam_rx_register          = dal_rt_rtl8277c_gpon_ploam_rx_register,
#endif
#if defined(CONFIG_EPON_FEATURE)
    .rt_epon_init                       = dal_rt_rtl8277c_epon_init,
    .rt_epon_oam_tx                     = dal_rt_rtl8277c_epon_oam_tx,
    .rt_epon_oam_rx_callback_register   = dal_rt_rtl8277c_epon_oam_rx_callback_register,
    .rt_epon_dyinggasp_set              = dal_rt_rtl8277c_epon_dyinggasp_set,
    .rt_epon_mpcp_info_get              = dal_rtl8277c_epon_mpcp_info_get,
    .rt_epon_mpcp_queue_threshold_get   = dal_rtl8277c_epon_mpcp_queue_threshold_get,
    .rt_epon_mpcp_queue_threshold_set   = dal_rtl8277c_epon_mpcp_queue_threshold_set,
    .rt_epon_llid_entry_set             = dal_rt_rtl8277c_epon_llid_entry_set,
    .rt_epon_llid_entry_get             = dal_rt_rtl8277c_epon_llid_entry_get,
    .rt_epon_registerReq_get            = dal_rt_rtl8277c_epon_registerReq_get,
    .rt_epon_registerReq_set            = dal_rt_rtl8277c_epon_registerReq_set,
    .rt_epon_churningKey_get            = dal_rt_rtl8277c_epon_churningKey_get,
    .rt_epon_churningKey_set            = dal_rt_rtl8277c_epon_churningKey_set,
    .rt_epon_usFecState_get             = dal_rt_rtl8277c_epon_usFecState_get,
    .rt_epon_usFecState_set             = dal_rt_rtl8277c_epon_usFecState_set,
    .rt_epon_dsFecState_get             = dal_rt_rtl8277c_epon_dsFecState_get,
    .rt_epon_dsFecState_set             = dal_rt_rtl8277c_epon_dsFecState_set,
    .rt_epon_mibCounter_get             = dal_rt_rtl8277c_epon_mibCounter_get,
    .rt_epon_mibCounter_reset           = dal_rt_rtl8277c_epon_mibCounter_reset,
    .rt_epon_losState_get               = dal_rt_rtl8277c_epon_losState_get,
    .rt_epon_lofState_get               = dal_rt_rtl8277c_epon_lofState_get,
    .rt_epon_mpcp_gate_timer_set        = dal_rt_rtl8277c_epon_mpcp_gate_timer_set,
    .rt_epon_mpcp_gate_timer_get        = dal_rt_rtl8277c_epon_mpcp_gate_timer_get,
    .rt_epon_info_notify_callback_register = dal_rt_rtl8277c_epon_info_notify_callback_register,
    .rt_epon_ponLoopback_set            = dal_rt_rt8277c_epon_ponLoopback_set,
#endif
#if defined(CONFIG_GPON_FEATURE)||defined(CONFIG_EPON_FEATURE)
    .rt_ponmisc_init                    = dal_rt_rtl8277c_ponmisc_init,
    .rt_ponmisc_mode_get                = dal_rt_rtl8277c_ponmisc_mode_get,
    .rt_ponmisc_mode_set                = dal_rt_rtl8277c_ponmisc_mode_set,
    .rt_ponmisc_ponQueue_mode_get       = dal_rt_rtl8277c_ponmisc_ponQueue_mode_get,
    .rt_ponmisc_burstPolarityReverse_get = dal_rt_rtl8277c_ponmisc_burstPolarityReverse_get,
    .rt_ponmisc_burstPolarityReverse_set = dal_rt_rtl8277c_ponmisc_burstPolarityReverse_set,
    .rt_ponmisc_forceLaserState_get     = dal_rt_rtl8277c_ponmisc_forceLaserState_get,
    .rt_ponmisc_rxlosPolarityReverse_get = dal_rt_rtl8277c_ponmisc_rxlosPolarityReverse_get,
    .rt_ponmisc_rxlosPolarityReverse_set = dal_rt_rtl8277c_ponmisc_rxlosPolarityReverse_set,
    .rt_ponmisc_forceLaserState_set     = dal_rt_rtl8277c_ponmisc_forceLaserState_set,
    .rt_ponmisc_forcePRBS_get           = dal_rt_rtl8277c_ponmisc_forcePRBS_get,
    .rt_ponmisc_forcePRBS_set           = dal_rt_rtl8277c_ponmisc_forcePRBS_set,
    .rt_ponmisc_forcePRBS_rx_get           = dal_rt_rtl8277c_ponmisc_forcePRBS_rx_get,
    .rt_ponmisc_forcePRBS_rx_set           = dal_rt_rtl8277c_ponmisc_forcePRBS_rx_set,
    .rt_ponmisc_prbsRxStatus_get           = dal_rt_rtl8277c_ponmisc_prbsRxStatus_get,
    .rt_ponmisc_selfRogue_cfg_get       = dal_rt_rtl8277c_ponmisc_selfRogue_cfg_get,
    .rt_ponmisc_selfRogue_cfg_set       = dal_rt_rtl8277c_ponmisc_selfRogue_cfg_set,
    .rt_ponmisc_selfRogue_count_get     = dal_rt_rtl8277c_ponmisc_selfRogue_count_get,
    .rt_ponmisc_selfRogue_count_clear   = dal_rt_rtl8277c_ponmisc_selfRogue_count_clear,
#endif
#endif

#if defined(CONFIG_GPON_FEATURE)||defined(CONFIG_EPON_FEATURE)
    /*PON MAC*/
    .ponmac_init = dal_rtl8277c_ponmac_init,
    .ponmac_queue_add = dal_rtl8277c_ponmac_queue_add,
    .ponmac_queue_get = dal_rtl8277c_ponmac_queue_get,
    .ponmac_queue_del = dal_rtl8277c_ponmac_queue_del,
    ...
    .ponmac_losState_get = dal_rtl8277c_ponmac_losState_get,
    .ponmac_serdesCdr_reset = dal_rtl8277c_ponmac_serdesCdr_reset,
    .ponmac_linkState_get = dal_ca8277c_ponmac_linkState_get,
    ...
    .ponmac_egrBandwidthCtrlRate_get = dal_rtl8277c_ponmac_egrBandwidthCtrlRate_get,
    .ponmac_egrBandwidthCtrlRate_set = dal_rtl8277c_ponmac_egrBandwidthCtrlRate_set,
    .ponmac_egrScheduleIdRate_get = NULL,
    .ponmac_egrScheduleIdRate_set = NULL,
    .ponmac_egrBandwidthCtrlIncludeIfg_get = dal_rtl8277c_ponmac_egrBandwidthCtrlIncludeIfg_get,
    .ponmac_egrBandwidthCtrlIncludeIfg_set = dal_rtl8277c_ponmac_egrBandwidthCtrlIncludeIfg_set,
    .ponmac_egrScheduleIdIncludeIfg_get = NULL,
    .ponmac_egrScheduleIdIncludeIfg_set = NULL,
    .ponmac_txDisableGpio_get = dal_rtl8277c_ponmac_txDisableGpio_get,
    .ponmac_txDisableGpio_set = dal_rtl8277c_ponmac_txDisableGpio_set,
    .ponmac_txPowerDisableGpio_get = dal_rtl8277c_ponmac_txPowerDisableGpio_get,
    .ponmac_txPowerDisableGpio_set = dal_rtl8277c_ponmac_txPowerDisableGpio_set,
#endif
    /*gpio function*/
    .gpio_init = dal_rtl8277c_gpio_init,
    .gpio_state_set = dal_rtl8277c_gpio_state_set,
    .gpio_state_get = dal_rtl8277c_gpio_state_get,
    .gpio_mode_set = dal_rtl8277c_gpio_mode_set,
    .gpio_mode_get = dal_rtl8277c_gpio_mode_get,
    .gpio_databit_get = dal_rtl8277c_gpio_databit_get,
    .gpio_databit_set = dal_rtl8277c_gpio_databit_set,
    .gpio_intr_get = NULL,
    .gpio_intr_set = NULL,
    ...
    /* RLDP and RLPP */
    .rldp_init = dal_rtl8277c_success,
    ...
    /*led*/
    .led_init               = dal_rtl8277c_led_init,
    .led_operation_get      = NULL,
    .led_operation_set      = NULL,
    .led_serialMode_get     = NULL,
    .led_serialMode_set     = NULL,
    .led_blinkRate_get      = dal_rtl8277c_led_blinkRate_get,
    .led_blinkRate_set      = dal_rtl8277c_led_blinkRate_set,
    .led_config_set         = dal_rtl8277c_success,
    .led_config_get         = dal_rtl8277c_success,
    .led_modeForce_get      = dal_rtl8277c_led_modeForce_get,
    .led_modeForce_set      = dal_rtl8277c_led_modeForce_set,
    .led_parallelEnable_get = dal_rtl8277c_success,
    .led_parallelEnable_set = dal_rtl8277c_success,
    ...
    /* I2C */
    .i2c_init = dal_rtl8277c_i2c_init,
    .i2c_enable_set = dal_rtl8277c_i2c_enable_set,
    .i2c_enable_get = dal_rtl8277c_i2c_enable_get,
    .i2c_width_set = NULL,
    .i2c_width_get = NULL,
    .i2c_write = dal_rtl8277c_i2c_write,
    .i2c_seq_write = dal_rtl8277c_i2c_seq_write,
    .i2c_read = dal_rtl8277c_i2c_read,
    .i2c_seq_read = dal_rtl8277c_i2c_seq_read,
    .i2c_clock_set = dal_rtl8277c_i2c_clock_set,
    .i2c_clock_get = dal_rtl8277c_i2c_clock_get,
...
#if defined(CONFIG_EPON_FEATURE)
    /* EPON */
    .epon_init = dal_rtl8277c_epon_init,
    .epon_intrMask_get = NULL,
    .epon_intrMask_set = NULL,
    .epon_intr_get = NULL,
    .epon_intr_disableAll = NULL,
    .epon_llid_entry_set = dal_rtl8277c_epon_llid_entry_set,
    .epon_llid_entry_get = dal_rtl8277c_epon_llid_entry_get,
    ...
    .epon_registerReq_get = dal_rtl8277c_epon_registerReq_get,
    .epon_registerReq_set = dal_rtl8277c_epon_registerReq_set,
    .epon_churningKey_set = dal_rtl8277c_epon_churningKey_set,
    .epon_churningKey_get = dal_rtl8277c_epon_churningKey_get,
    .epon_usFecState_get = dal_rtl8277c_epon_usFecState_get,
    .epon_usFecState_set = dal_rtl8277c_epon_usFecState_set,
    .epon_dsFecState_get = dal_rtl8277c_epon_dsFecState_get,
    .epon_dsFecState_set = dal_rtl8277c_epon_dsFecState_set,
    .epon_mibCounter_get = dal_rtl8277c_epon_mibCounter_get,
    .epon_mibGlobal_reset = NULL,
    .epon_mibLlidIdx_reset = NULL,
    .epon_losState_get = dal_rtl8277c_epon_losState_get,
    ...
    .epon_llidEntryNum_get = dal_rtl8277c_epon_llidEntryNum_get,
    ...
    /*MDIO*/
    .mdio_init = dal_rtl8277c_mdio_init,
    .mdio_cfg_set = dal_rtl8277c_mdio_cfg_set,
    .mdio_cfg_get = dal_rtl8277c_mdio_cfg_get,
    .mdio_c22_write = dal_rtl8277c_mdio_c22_write,
    .mdio_c22_read = dal_rtl8277c_mdio_c22_read,
    .mdio_c45_write = dal_rtl8277c_mdio_c45_write,
    .mdio_c45_read = dal_rtl8277c_mdio_c45_read,
#if defined(CONFIG_COMMON_RT_API)
    .mdio_write = dal_rtl8277c_mdio_write,
    .mdio_read = dal_rtl8277c_mdio_read,
#endif
};
...
static int ca_rtk_debug_read(struct seq_file *seq, void *v)
{
    ...
    seq_printf(seq, "0x1AAABBBX : start bc thread ,AAA:max_pkt_len ,BBB:min_pkt_len ,X:to which ldipd, if X=0xf,will create ldpid 0~7 thread\n");
    seq_printf(seq, "0x20000000 : stop bc thread\n");
    seq_printf(seq, "0x400000XX : set bc thread Header_A ,XX:Header_A.lspid\n");
    seq_printf(seq, "ca rtk debug status: 0x%x\n", ca_rtk_debug);

    return 0;
}

#define SEND_MAX_THREAD 8
static struct task_struct *pSendBCToLanThread[SEND_MAX_THREAD];
unsigned char tmpData[16] = {
    0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x11,0x80,0x00,0x00,0x00};
static unsigned char startFlag = 0;
static int minPkt_len = 64;
static int maxPkt_len = 496;
static int glbLspid = 0x11;

static int send_bc_to_lan_thread(void *data)
{
    struct sk_buff *p_skb = NULL;
    HEADER_A_T ni_header_a;
    int num = (int)data,sendN = 0,pkt_len;
    ...
    {
        if(pkt_len > maxPkt_len)
            pkt_len = minPkt_len;

        p_skb = netdev_alloc_skb(NULL, pkt_len+16);
        if (p_skb == NULL)
        {
        ...
        memcpy(p_skb->data,tmpData,16);
        p_skb->len = pkt_len;

        ni_header_a.bits.pkt_size = p_skb->len;
        ni_header_a.bits.ldpid = num;
        ni_header_a.bits.lspid = glbLspid;
...
static ssize_t ca_rtk_debug_write(struct file *file, const char __user *buffer, size_t count, loff_t *ppos)
{
    char tmpBuf[16] = {0};
    ssize_t len = 0;
    uint32 i,tmpVal = 0,tmpMinLen,tmpMaxLen,toLdpid;
    char tmpStr[64] = {0};

    len = min(count, (unsigned long)(sizeof(tmpBuf) - 1));
    if (buffer && !copy_from_user(tmpBuf, buffer, len))
    {
        tmpBuf[len] = '\0';
        tmpVal = simple_strtoul(tmpBuf, NULL, 16);
        if(0x10000000 &  tmpVal)
        {
            if(startFlag == 0)
            {
                for(i=0;i<SEND_MAX_THREAD;i++)
                {
                    pSendBCToLanThread[i]=NULL;
                }
                startFlag = 1;
            }

            tmpMinLen = (tmpVal & 0xfff0) >> 4;
            tmpMaxLen = (tmpVal & 0xfff0000) >> 16;

            if(tmpMinLen > tmpMaxLen)
            {
                printk("Error!! tmpMinLen = %d is greater than tmpMaxLen = %d\n",tmpMinLen,tmpMaxLen);
                return count;
            }

            if(tmpMinLen >=60 && tmpMinLen <=1514)
            {
                minPkt_len = tmpMinLen;
            }
            else
            {
                printk("tmpMinLen = %d is not 60~1514 so keep orginal\n",tmpMinLen);
            }

            if(tmpMaxLen >=60 && tmpMaxLen <=1514)
            {
                maxPkt_len = tmpMaxLen;
            }
            else
            {
                printk("tmpMaxLen = %d is not 60~1514 so keep orginal\n",tmpMaxLen);
            }
            ...
            if(toLdpid == 0xf)
            {
                for(i=0;i<SEND_MAX_THREAD;i++)
                {
                    sprintf(tmpStr,"bcToLan%d_thread",i);
                    if(pSendBCToLanThread[i]==NULL)
                    {
                        pSendBCToLanThread[i]=kthread_create(send_bc_to_lan_thread, i, tmpStr);
                        wake_up_process(pSendBCToLanThread[i]);
                        printk("create %s ,glbLspid = %d,maxPkt_len = %d ,minPkt_len = %d\n",tmpStr,glbLspid,maxPkt_len,minPkt_len);
                    }
                    else
                    {
                        printk("already exist %s\n",tmpStr);
                    }
                }
            }
            else if (toLdpid > 7)
            {
                printk("0x%02x is not correct, ldpid only set 0~7 or 0xf for all\n", toLdpid);
                return count;
            }
            else
            {
                sprintf(tmpStr,"bcToLan%d_thread",toLdpid);
                if(pSendBCToLanThread[toLdpid]==NULL)
                {
                    pSendBCToLanThread[toLdpid]=kthread_create(send_bc_to_lan_thread, toLdpid, tmpStr);
                    wake_up_process(pSendBCToLanThread[toLdpid]);
                    printk("create %s ,glbLspid = %d,maxPkt_len = %d ,minPkt_len = %d\n",tmpStr,glbLspid,maxPkt_len,minPkt_len);
                }
                else
                {
        ...
        else if (0x20000000 & tmpVal )
        {
            ...
            if(toLdpid == 0xf)
            {
                for(i=0;i<SEND_MAX_THREAD;i++)
                {
                    if(pSendBCToLanThread[i]!=NULL)
                    {
                        kthread_stop(pSendBCToLanThread[i]);
                        pSendBCToLanThread[i]=NULL;
                    }
                }
            }
            ...
            else
            {
                if(pSendBCToLanThread[toLdpid]!=NULL)
                {
                    kthread_stop(pSendBCToLanThread[toLdpid]);
                    pSendBCToLanThread[toLdpid]=NULL;
                }
                else
                {
                    sprintf(tmpStr,"bcToLan%d_thread",toLdpid);
        ...
        else if (0x40000000 & tmpVal )
        {
            glbLspid = tmpVal & 0xff;

            printk("setting lspid = %d\n",glbLspid);
        }
        else
        {
            ca_rtk_debug = tmpVal;
            ...
            {
                _dal_rtl8277c_rate_glb_db_dump();
            }
        }
...
static ssize_t ponmisc_cfg_write(struct file *file, const char __user *buffer, size_t count, loff_t *ppos)
{
    ...
    if (buffer && !copy_from_user(tmp, buffer, len)) {
        ...
        {
            ret = dal_rt_rtl8277c_ponmisc_init();
            if(ret != RT_ERR_OK)
                printk("dal_rt_rtl8277c_ponmisc_init fail, ret=0x%x\n", ret);
            else
                printk("dal_rt_rtl8277c_ponmisc_init OK\n");
        }
        else if (strncmp(para[0], "bstPolRvs", 9) == 0)
        {
            if (strncmp(para[1], "enable", 6) == 0)
                ret = dal_rt_rtl8277c_ponmisc_burstPolarityReverse_set(RT_PONMISC_POLARITY_REVERSE_ON);
            else
                ret = dal_rt_rtl8277c_ponmisc_burstPolarityReverse_set(RT_PONMISC_POLARITY_REVERSE_OFF);
            if(ret != RT_ERR_OK)
                printk("dal_rt_rtl8277c_ponmisc_burstPolarityReverse_set fail, ret=0x%x\n", ret);
            else
                printk("dal_rt_rtl8277c_ponmisc_burstPolarityReverse_set OK\n");
        }
        else if (strncmp(para[0], "modSpd", 6) == 0)
        {
            mode=simple_strtoul(para[1], NULL, 10);
            speed=simple_strtoul(para[2], NULL, 10);
            ret = dal_rt_rtl8277c_ponmisc_mode_set(mode, speed);
            if(ret != RT_ERR_OK)
                printk("dal_rt_rtl8277c_ponmisc_mode_set fail, ret=0x%x\n", ret);
            else
                printk("dal_rt_rtl8277c_ponmisc_mode_set %d %d OK\n", mode, speed);
        }
        else if (strncmp(para[0], "rxLosRvsPol", 11) == 0)
        {
            if (strncmp(para[1], "enable", 6) == 0)
                ret = dal_rt_rtl8277c_ponmisc_rxlosPolarityReverse_set(RT_PONMISC_POLARITY_REVERSE_ON);
            else
                ret = dal_rt_rtl8277c_ponmisc_rxlosPolarityReverse_set(RT_PONMISC_POLARITY_REVERSE_OFF);
            if(ret != RT_ERR_OK)
...
{
    dal_rtl8277c_mapper_register(&dal_rtl8277c_mapper);
...
static void __exit exit_ca_rtk(void)
{
    ...
    dal_rtl8277c_mapper_unregister();
}

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("RealTek RTL8277C DAL module");
