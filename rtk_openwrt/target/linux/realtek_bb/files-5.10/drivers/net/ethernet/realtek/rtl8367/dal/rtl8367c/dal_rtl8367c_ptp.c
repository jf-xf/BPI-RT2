 ...
 */
rtksw_api_ret_t dal_rtl8367c_ptp_init(void)
{
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_mac_set(rtksw_mac_t mac)
{
 ...
 *      None
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_mac_get(rtksw_mac_t *pMac)
{
    rtksw_api_ret_t retVal;
    ether_addr_t sw_mac;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_tpid_set(rtksw_ptp_tpid_t outerId, rtksw_ptp_tpid_t innerId)
{
    rtksw_api_ret_t retVal;
    ...
    if ((outerId>DAL_RTL8367C_MAX_NUM_OF_TPID) ||(innerId>DAL_RTL8367C_MAX_NUM_OF_TPID))
        return RT_ERR_INPUT;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_tpid_get(rtksw_ptp_tpid_t *pOuterId, rtksw_ptp_tpid_t *pInnerId)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_refTime_set(rtksw_ptp_timeStamp_t timeStamp)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_refTime_get(rtksw_ptp_timeStamp_t *pTimeStamp)
{
    rtksw_api_ret_t retVal;
 ...
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_refTimeAdjust_set(rtksw_ptp_sys_adjust_t sign, rtksw_ptp_timeStamp_t timeStamp)
{
    rtksw_api_ret_t retVal;
    ...
    if (timeStamp.nsec > DAL_RTL8367C_MAX_NUM_OF_NANO_SECOND)
        return RT_ERR_INPUT;
 ...
 *      None
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_refTimeEnable_set(rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_refTimeEnable_get(rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_portEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t   retVal;
    ...
    RTKSW_CHK_PORT_IS_PTP(port);

    if (enable>=RTKSW_ENABLE_END)
        return RT_ERR_INPUT;

    if ((retVal = rtl8367c_setAsicEavPortEnable(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_portEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicEavPortEnable(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_ptp_portTimestamp_get( rtksw_port_t port, rtksw_ptp_msgType_t type, rtksw_ptp_info_t *pInfo)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicEavPortTimeStamp(rtksw_switch_port_L2P_get(port), type, &time)) != RT_ERR_OK)
        return retVal;
 ...
 *          PTP_INT_TYPE_ALL,
 */
rtksw_api_ret_t dal_rtl8367c_ptp_intControl_set(rtksw_ptp_intType_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 mask;
    ...
    {
        if (RTKSW_ENABLED == enable)
            mask = DAL_RTL8367C_PTP_INTR_MASK;
        else if (RTKSW_DISABLED == enable)
            mask = 0;
        else
            return RT_ERR_INPUT;
 ...
 *          PTP_INT_TYPE_RX_PDELAY_RESP,
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_intControl_get(rtksw_ptp_intType_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 mask;
 ...
 *
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_intStatus_get(rtksw_ptp_intStatus_t *pStatusMask)
{
    rtksw_api_ret_t   retVal;
 ...
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_portIntStatus_set(rtksw_port_t port, rtksw_ptp_intStatus_t statusMask)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicEavPortInterruptStatus(rtksw_switch_port_L2P_get(port), statusMask))!=RT_ERR_OK)
        return retVal;
 ...
 *
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_portIntStatus_get(rtksw_port_t port, rtksw_ptp_intStatus_t *pStatusMask)
{
    rtksw_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_getAsicEavPortInterruptStatus(rtksw_switch_port_L2P_get(port), pStatusMask)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_portTrap_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_setAsicEavTrap(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
 rtksw_api_ret_t dal_rtl8367c_ptp_portTrap_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicEavTrap(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
        return retVal;
