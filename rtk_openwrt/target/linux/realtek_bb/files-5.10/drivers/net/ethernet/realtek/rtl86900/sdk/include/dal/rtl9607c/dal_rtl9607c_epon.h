 ...
 *
 */
#ifndef _DAL_RTL9607C_EPON_H_
#define _DAL_RTL9607C_EPON_H_
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_init(void);  
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_intrMask_get(rtk_epon_intrType_t intrType, rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_intrMask_set(rtk_epon_intrType_t intrType, rtk_enable_t state);




/* Function Name:
 *      dal_rtl9607c_epon_topIntr_get
 * Description:
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_intr_get(rtk_epon_intrType_t intrType, rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_intr_disableAll(void);  
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_llid_entry_set(rtk_epon_llid_entry_t *pLlidEntry);  
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_llid_entry_get(rtk_epon_llid_entry_t *pLlidEntry);  
 ...
 * Note:
 */
extern int32  dal_rtl9607c_epon_forceLaserState_set(rtk_epon_laser_status_t laserStatus);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_forceLaserState_get(rtk_epon_laser_status_t *pLaserStatus);
 ...
 * Note:
 */
extern int32  dal_rtl9607c_epon_laserTime_set(uint8 lasetOnTime, uint8 lasetOffTime);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_laserTime_get(uint8 *pLasetOnTime, uint8 *pLasetOffTime);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_syncTime_get(uint8 *pSyncTime);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_registerReq_get(rtk_epon_regReq_t *pRegEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_registerReq_set(rtk_epon_regReq_t *pRegEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_churningKey_set(rtk_epon_churningKeyEntry_t *pEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_churningKey_get(rtk_epon_churningKeyEntry_t *pEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_usFecState_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_usFecState_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_dsFecState_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_dsFecState_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_mibCounter_get(rtk_epon_counter_t *pCounter);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_fecState_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_fecState_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_llidEntryNum_get(uint32 *num);
...
extern int32 rtl9607c_raw_epon_forceLaserOn_set(uint32 force);
extern int32 rtl9607c_raw_epon_forceLaserOn_get(uint32 *pForce);
 ...
 *      
 */
extern int32 dal_rtl9607c_epon_multiLlidMode_set(rtk_epon_multiLlidMode_t mode);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_multiLlidMode_get(rtk_epon_multiLlidMode_t *pMode);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_forcePRBS_set ( rtk_epon_prbs_t prbsCfg );
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_forcePRBS_get ( rtk_epon_prbs_t* pPrbsCfg );
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_autoPowerSavingState_get(rtk_enable_t *pEnable);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_autoPowerSavingState_set(rtk_enable_t enable);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_autoPowerSavingOeRecoverTime_get(int *pRecoverTime);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_autoPowerSavingOeRecoverTime_set(int recoverTime);



/* Function Name:
 *      dal_rtl9607c_epon_info_notify_callback_register
 * Description:
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_info_notify_callback_register(epon_info_notify_callback info);


/* Function Name:
 *      dal_rtl9607c_epon_mpcpTimeout_set
 * Description:
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_mpcpTimeout_set(uint32 gateTimeout);




/* Function Name:
 *      dal_rtl9607c_epon_mpcpTimeout_get
 * Description:
 *      set mpcp/gate timeout value
 * Input:
 *	    gateTimeout - get timeout value unit 10ms
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_mpcpTimeout_get(uint32 *pGateTimeout);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_forcePRBS_rx_set(rtk_epon_prbs_t prbsCfg);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_forcePRBS_rx_get(rtk_epon_prbs_t *pPrbsCfg);
 ...
 * Note:
 */
extern int32 dal_rtl9607c_epon_prbsRxStatus_get(rtk_epon_prbsRxStatus_t *pPrbsRxStatus);



#endif /*#ifndef _DAL_RTL9607C_EPON_H_*/
