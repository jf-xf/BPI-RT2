...
typedef struct  USER_VLANTABLE{
    ...
    rtksw_uint16  svlan_chk_ivl_svl;
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_init(void);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_set(rtksw_vlan_t vid, rtksw_vlan_cfg_t *pVlanCfg);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_get(rtksw_vlan_t vid, rtksw_vlan_cfg_t *pVlanCfg);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_egrFilterEnable_set(rtksw_enable_t egrFilter);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_egrFilterEnable_get(rtksw_enable_t *pEgrFilter);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portPvid_set(rtksw_port_t port, rtksw_vlan_t pvid, rtksw_pri_t priority);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portPvid_get(rtksw_port_t port, rtksw_vlan_t *pPvid, rtksw_pri_t *pPriority);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portIgrFilterEnable_set(rtksw_port_t port, rtksw_enable_t igr_filter);
 ...
 *     - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portIgrFilterEnable_get(rtksw_port_t port, rtksw_enable_t *pIgr_filter);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portAcceptFrameType_set(rtksw_port_t port, rtksw_vlan_acceptFrameType_t accept_frame_type);
 ...
 *     - RTKSW_ACCEPT_FRAME_TYPE_UNTAG_ONLY
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portAcceptFrameType_get(rtksw_port_t port, rtksw_vlan_acceptFrameType_t *pAccept_frame_type);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_tagMode_set(rtksw_port_t port, rtksw_vlan_tagMode_t tag_mode);
 ...
 *      - RTKSW_VLAN_TAG_MODE_REAL_KEEP_FORMAT,
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_tagMode_get(rtksw_port_t port, rtksw_vlan_tagMode_t *pTag_mode);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_transparent_set(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_transparent_get(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_keep_set(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_keep_get(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_stg_set(rtksw_vlan_t vid, rtksw_stp_msti_id_t stg);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_stg_get(rtksw_vlan_t vid, rtksw_stp_msti_id_t *pStg);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portFid_set(rtksw_port_t port, rtksw_enable_t enable, rtksw_fid_t fid);
 ...
 *      packets will be assigned to the port-based fid regardless vlan tag.
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_portFid_get(rtksw_port_t port, rtksw_enable_t *pEnable, rtksw_fid_t *pFid);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_stp_mstpState_set(rtksw_stp_msti_id_t msti, rtksw_port_t port, rtksw_stp_state_t stp_state);
 ...
 *      - STP_STATE_FORWARDING
 */
extern rtksw_api_ret_t dal_rtl8367d_stp_mstpState_get(rtksw_stp_msti_id_t msti, rtksw_port_t port, rtksw_stp_state_t *pStp_state);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_reservedVidAction_set(rtksw_vlan_resVidAction_t action_vid0, rtksw_vlan_resVidAction_t action_vid4095);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_reservedVidAction_get(rtksw_vlan_resVidAction_t *pAction_vid0, rtksw_vlan_resVidAction_t *pAction_vid4095);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_realKeepRemarkEnable_set(rtksw_enable_t enabled);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_realKeepRemarkEnable_get(rtksw_enable_t *pEnabled);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_vlan_reset(void);
