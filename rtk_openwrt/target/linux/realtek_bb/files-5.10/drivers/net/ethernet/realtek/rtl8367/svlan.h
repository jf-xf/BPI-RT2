 ...
 */
extern rtksw_api_ret_t rtksw_svlan_init(void);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_servicePort_add(rtksw_port_t port);
 ...
 *      contain accept SVID in S-tag field.
 */
extern rtksw_api_ret_t rtksw_svlan_servicePort_get(rtksw_portmask_t *pSvlan_portmask);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_servicePort_del(rtksw_port_t port);
 ...
 *      User can set mathced ether type as service provider supported protocol.
 */
extern rtksw_api_ret_t rtksw_svlan_tpidEntry_set(rtksw_uint32 svlan_tag_id);
 ...
 *      contain accept SVID in S-tag field.
 */
extern rtksw_api_ret_t rtksw_svlan_tpidEntry_get(rtksw_uint32 *pSvlan_tag_id);
 ...
 *      - REF_PB_PRI.
 */
extern rtksw_api_ret_t rtksw_svlan_priorityRef_set(rtksw_svlan_pri_ref_t ref);
 ...
 *      - REF_PB_PRI
 */
extern rtksw_api_ret_t rtksw_svlan_priorityRef_get(rtksw_svlan_pri_ref_t *pRef);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_memberPortEntry_set(rtksw_uint32 svid_idx, rtksw_svlan_memberCfg_t *psvlan_cfg);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_memberPortEntry_get(rtksw_uint32 svid_idx, rtksw_svlan_memberCfg_t *pSvlan_cfg);
 ...
 *      - rtksw_svlan_memberCfg_t->priority is priority of SVLAN member configuration.
 */
extern rtksw_api_ret_t rtksw_svlan_memberPortEntry_adv_set(rtksw_uint32 idx, rtksw_svlan_memberCfg_t *pSvlan_cfg);
 ...
 *      to receiving from uplink ports. Other SVID S-tag frame or S-untagged frame will be droped.
 */
extern rtksw_api_ret_t rtksw_svlan_memberPortEntry_adv_get(rtksw_uint32 idx, rtksw_svlan_memberCfg_t *pSvlan_cfg);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_defaultSvlan_set(rtksw_port_t port, rtksw_vlan_t svid);
 ...
 *      is transmit through uplink port with s-tag field
 */
extern rtksw_api_ret_t rtksw_svlan_defaultSvlan_get(rtksw_port_t port, rtksw_vlan_t *pSvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_c2s_add(rtksw_vlan_t vid, rtksw_port_t src_port, rtksw_vlan_t svid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_c2s_del(rtksw_vlan_t vid, rtksw_port_t src_port);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_c2s_get(rtksw_vlan_t vid, rtksw_port_t src_port, rtksw_vlan_t *pSvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_untag_action_set(rtksw_svlan_untag_action_t action, rtksw_vlan_t svid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_untag_action_get(rtksw_svlan_untag_action_t *pAction, rtksw_vlan_t *pSvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_unmatch_action_set(rtksw_svlan_unmatch_action_t action, rtksw_vlan_t svid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_unmatch_action_get(rtksw_svlan_unmatch_action_t *pAction, rtksw_vlan_t *pSvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_dmac_vidsel_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_dmac_vidsel_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_ipmc2s_add(ipaddr_t ipmc, ipaddr_t ipmcMsk, rtksw_vlan_t svid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_ipmc2s_del(ipaddr_t ipmc, ipaddr_t ipmcMsk);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_ipmc2s_get(ipaddr_t ipmc, ipaddr_t ipmcMsk, rtksw_vlan_t *pSvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_l2mc2s_add(rtksw_mac_t mac, rtksw_mac_t macMsk, rtksw_vlan_t svid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_l2mc2s_del(rtksw_mac_t mac, rtksw_mac_t macMsk);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_l2mc2s_get(rtksw_mac_t mac, rtksw_mac_t macMsk, rtksw_vlan_t *pSvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_sp2c_add(rtksw_vlan_t svid, rtksw_port_t dst_port, rtksw_vlan_t cvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_sp2c_get(rtksw_vlan_t svid, rtksw_port_t dst_port, rtksw_vlan_t *pCvid);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_sp2c_del(rtksw_vlan_t svid, rtksw_port_t dst_port);
 ...
 *      none
 */
extern rtksw_api_ret_t rtksw_svlan_lookupType_set(rtksw_svlan_lookupType_t type);
 ...
 *      none
 */
extern rtksw_api_ret_t rtksw_svlan_lookupType_get(rtksw_svlan_lookupType_t *pType);
 ...
 *      None
 */
extern rtksw_api_ret_t rtksw_svlan_trapPri_set(rtksw_pri_t priority);
 ...
 *      None
 */
extern rtksw_api_ret_t rtksw_svlan_trapPri_get(rtksw_pri_t *pPriority);
 ...
 */
extern rtksw_api_ret_t rtksw_svlan_unassign_action_set(rtksw_svlan_unassign_action_t action);
 ...
 *      None
 */
extern rtksw_api_ret_t rtksw_svlan_unassign_action_get(rtksw_svlan_unassign_action_t *pAction);
