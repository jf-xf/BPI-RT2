 ...
 */
ret_t rtl8367c_setAsicLedIndicateInfoConfig(rtksw_uint32 ledno, rtksw_uint32 config)
{
    ret_t   retVal;
    CONST rtksw_uint16 bits[RTL8367C_LEDGROUPNO] = {RTL8367C_LED0_CFG_MASK, RTL8367C_LED1_CFG_MASK, RTL8367C_LED2_CFG_MASK};
 ...
 *      None
 */
ret_t rtl8367c_getAsicLedIndicateInfoConfig(rtksw_uint32 ledno, rtksw_uint32* pConfig)
{
    CONST rtksw_uint16 bits[RTL8367C_LEDGROUPNO]= {RTL8367C_LED0_CFG_MASK, RTL8367C_LED1_CFG_MASK, RTL8367C_LED2_CFG_MASK};
 ...
 *      None
 */
ret_t rtl8367c_setAsicLedGroupMode(rtksw_uint32 mode)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLedGroupMode(rtksw_uint32* pMode)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicForceLed(rtksw_uint32 port, rtksw_uint32 group, rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicForceLed(rtksw_uint32 port, rtksw_uint32 group, rtksw_uint32* pMode)
{
    rtksw_uint16 regAddr;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicForceGroupLed(rtksw_uint32 groupmask, rtksw_uint32 mode)
{
    ret_t retVal;
    rtksw_uint32 i,bitmask;
    CONST rtksw_uint16 bits[3]= {0x0004,0x0010,0x0040};
 ...
 *      None
 */
ret_t rtl8367c_getAsicForceGroupLed(rtksw_uint32* groupmask, rtksw_uint32* pMode)
{
    ret_t retVal;
    rtksw_uint32 i,regData;
    CONST rtksw_uint16 bits[3] = {0x0004,0x0010,0x0040};
 ...
 */
ret_t rtl8367c_setAsicLedBlinkRate(rtksw_uint32 blinkRate)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLedBlinkRate(rtksw_uint32* pBlinkRate)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLedForceBlinkRate(rtksw_uint32 blinkRate)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLedForceBlinkRate(rtksw_uint32* pBlinkRate)
{
...
@parm rtksw_uint32 | group | LED group id.
@parm rtksw_uint32 | portmask | LED port mask.
 ...
 */
ret_t rtl8367c_setAsicLedGroupEnable(rtksw_uint32 group, rtksw_uint32 portmask)
{
    ret_t retVal;
    rtksw_uint32 regAddr;
    rtksw_uint32 regDataMask;
    rtksw_uint32 data, regValue,tmp;
...
@comm
    The API can turn on/off leds of dedicated port while indicated information configuration of LED group is set to force mode.
 */
ret_t rtl8367c_getAsicLedGroupEnable(rtksw_uint32 group, rtksw_uint32 *portmask)
{
    ret_t retVal;
    rtksw_uint32 regAddr;
    rtksw_uint32 regDataMask,regData;
    rtksw_uint32 data, regValue,tmp;
...
@parm rtksw_uint32 | mode | LED mode. 1:scan mode 1, 2:parallel mode, 3:mdx mode (serial mode)
@rvalue RT_ERR_OK | Success.
@rvalue RT_ERR_SMI | SMI access error.
@rvalue RT_ERR_INPUT | Invalid input value.
@comm
 ...
 */
ret_t rtl8367c_setAsicLedOperationMode(rtksw_uint32 mode)
{
    ret_t retVal;
 ...
 */
ret_t rtl8367c_getAsicLedOperationMode(rtksw_uint32 *mode)
{
    ret_t retVal;
    rtksw_uint32 regData;
...
@parm rtksw_uint32 | active | Active High or Low.
@rvalue RT_ERR_OK | Success.
@rvalue RT_ERR_SMI | SMI access error.
@rvalue RT_ERR_INPUT | Invalid input value.
@comm
    The API can turn on/off led serial mode and set signal to active high/low.
 */
ret_t rtl8367c_setAsicLedSerialModeConfig(rtksw_uint32 active, rtksw_uint32 serimode)
{
    ret_t retVal;
...
@comm
    The API can get LED serial mode setup and get signal active high/low.
 */
ret_t rtl8367c_getAsicLedSerialModeConfig(rtksw_uint32 *active, rtksw_uint32 *serimode)
{
    ret_t retVal;
...
@parm rtksw_uint32 | enabled | enable or disalbe.
@rvalue RT_ERR_OK | Success.
@rvalue RT_ERR_SMI | SMI access error.
@rvalue RT_ERR_INPUT | Invalid input value.
@comm
 ...
 */
ret_t rtl8367c_setAsicLedOutputEnable(rtksw_uint32 enabled)
{
    ret_t retVal;
    rtksw_uint32 regdata;
...
@comm
    The API can get LED serial mode setup and get signal active high/low.
 */
ret_t rtl8367c_getAsicLedOutputEnable(rtksw_uint32 *ptr_enabled)
{
    ret_t retVal;
    rtksw_uint32 regdata;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLedSerialOutput(rtksw_uint32 output, rtksw_uint32 pmask)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLedSerialOutput(rtksw_uint32 *pOutput, rtksw_uint32 *pPmask)
{
    ret_t retVal;
