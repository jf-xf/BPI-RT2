...
dal_rtl8277c_time_init(void)
{
    ...
    if((ret = aal_ptp_timer_enable_set(0,0)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }

    if((ret = aal_ptp_init(0)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }
...
dal_rtl8277c_rt_time_curTime_get(rt_time_timeStamp_t *pTimeStamp)
{
    ...
    if((ret = aal_ptp_timer_get(0,&sec,&nsec)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }
...
dal_rtl8277c_rt_time_ponTodTime_set(rt_pon_tod_t ponTod)
{
    ...
    switch(pon_mode)
    {
        ...
        case ONU_PON_MAC_EPON_BI10G:
            ...
            if((ret = aal_epon_onu_mpcp_timer_match_cfg_set(0,0,ponTod.startPoint.localTime)) != CA_E_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }
        ...
        case ONU_PON_MAC_GPON:
            ...
            if((ret = aal_gpon_sup_frame_value_set(0,ponTod.startPoint.superFrame)) != CA_E_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }
        ...
        case ONU_PON_MAC_XGSPON:
            ...
            if((ret = aal_xgpon_xgpn_glb_super_frame_match_val_set(0,val)) != CA_E_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }
    ...
    if((ret = aal_ptp_load_timer_set(0,sec,nsec)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }
...
dal_rtl8277c_rt_time_ponTodTime_get(rt_pon_tod_t *pPonTod)
{
    ...
    switch(pon_mode)
    {
        ...
        case ONU_PON_MAC_EPON_BI10G:
            ...
            if((ret = aal_epon_onu_mpcp_timer_match_cfg_get(0,0,&pPonTod->startPoint.localTime)) != CA_E_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }
        ...
        case ONU_PON_MAC_GPON:
            ...
            if((ret = aal_gpon_sup_frame_value_get(0,&pPonTod->startPoint.superFrame)) != CA_E_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }
        ...
        case ONU_PON_MAC_XGSPON:
            ...
            if((ret = aal_xgpon_xgpn_glb_super_frame_match_val_get(0,&val)) != CA_E_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }
    ...
    if((ret = aal_ptp_load_timer_get(0,&sec,&nsec)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }
...
dal_rtl8277c_rt_time_ponTodTimeEnable_set(rt_enable_t enable)
{
    ...
    if((ret = aal_ptp_match_load_set(0,mask,load)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }
...
dal_rtl8277c_rt_time_ponTodTimeEnable_get(rt_enable_t *pEnable)
{
    ...
    if((ret = aal_ptp_match_load_get(0,&load)) != CA_E_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return RT_ERR_FAILED;
    }
