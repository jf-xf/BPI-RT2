...
rtksw_uint8 Fiber2_Auto[FIBER2_AUTO_INIT_SIZE] = {
...
rtksw_uint8 Fiber2_1G[FIBER2_1G_INIT_SIZE] = {
...
rtksw_uint8 Fiber2_100M[FIBER2_100M_INIT_SIZE] = {
0x02,0x05,0x97,0xE4,0xF5,0xA8,
0xD2,0xAF,0x22,0x00,0x00,0x02,0x06,0x89,
0xC5,0xF0,0xF8,0xA3,0xE0,0x28,0xF0,0xC5,
0xF0,0xF8,0xE5,0x82,0x15,0x82,0x70,0x02,
...
rtksw_uint8 Sgmii_Init[SGMII_INIT_SIZE] = {
...
rtksw_uint8 Fiber1_2_Init[FIBER1_2_INIT_SIZE] = {
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownDaBehavior(rtksw_uint32 port, rtksw_uint32 behavior)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownDaBehavior(rtksw_uint32 port, rtksw_uint32 *pBehavior)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownSaBehavior(rtksw_uint32 behavior)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownSaBehavior(rtksw_uint32 *pBehavior)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnmatchedSaBehavior(rtksw_uint32 behavior)
{
    if(behavior >= L2_BEHAVE_SA_END)
        return RT_ERR_NOT_ALLOWED;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnmatchedSaBehavior(rtksw_uint32 *pBehavior)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnmatchedSaMoving(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnmatchedSaMoving(rtksw_uint32 port, rtksw_uint32 *pEnabled)
{
    rtksw_uint32 data;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownDaFloodingPortmask(rtksw_uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownDaFloodingPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownMulticastFloodingPortmask(rtksw_uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownMulticastFloodingPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBcastFloodingPortmask(rtksw_uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBcastFloodingPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBlockSpa(rtksw_uint32 port, rtksw_uint32 permit)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBlockSpa(rtksw_uint32 port, rtksw_uint32* pPermit)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortForceLink(rtksw_uint32 port, rtl8367c_port_ability_t *pPortAbility)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortForceLink(rtksw_uint32 port, rtl8367c_port_ability_t *pPortAbility)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortStatus(rtksw_uint32 port, rtl8367c_port_status_t *pPortStatus)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortForceLinkExt(rtksw_uint32 id, rtl8367c_port_ability_t *pPortAbility)
{
    rtksw_uint32 retVal, regValue, regValue2, type, sgmiibit, hisgmiibit;
    rtksw_uint32 reg_data = 0;
    rtksw_uint32 i = 0;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortForceLinkExt(rtksw_uint32 id, rtl8367c_port_ability_t *pPortAbility)
{
    rtksw_uint32  reg_data, regValue, type;
    rtksw_uint32  sgmiiSel;
    rtksw_uint32  hsgmiiSel;
    rtksw_uint32  Mode;
    ret_t       retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortExtMode(rtksw_uint32 id, rtksw_uint32 mode)
{
    ret_t   retVal;
    rtksw_uint32 i, regValue, type, option,reg_data;
    rtksw_uint32 idx;
    rtksw_uint32 redData[][2] =   { {0x04D7, 0x0480}, {0xF994, 0x0481}, {0x21A2, 0x0482}, {0x6960, 0x0483}, {0x9728, 0x0484}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x83F2, 0x002E} };
    rtksw_uint32 redDataSB[][2] = { {0x04D7, 0x0480}, {0xF994, 0x0481}, {0x2420, 0x0482}, {0x6960, 0x0483}, {0x9728, 0x0484}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x83F2, 0x002E} };
    rtksw_uint32 redData1[][2] =  { {0x82F1, 0x0500}, {0xF195, 0x0501}, {0x31A2, 0x0502}, {0x796C, 0x0503}, {0x9728, 0x0504}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x0F80, 0x0001}, {0x83F2, 0x002E} };
    rtksw_uint32 redData5[][2] =  { {0x82F1, 0x0500}, {0xF195, 0x0501}, {0x31A2, 0x0502}, {0x796C, 0x0503}, {0x9728, 0x0504}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x0F80, 0x0001}, {0x83F2, 0x002E} };
    rtksw_uint32 redData6[][2] =  { {0x82F1, 0x0500}, {0xF195, 0x0501}, {0x31A2, 0x0502}, {0x796C, 0x0503}, {0x9728, 0x0504}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x0F80, 0x0001}, {0x83F2, 0x002E} };
    rtksw_uint32 redData8[][2] =  { {0x82F1, 0x0500}, {0xF995, 0x0501}, {0x31A2, 0x0502}, {0x796C, 0x0503}, {0x9728, 0x0504}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x0F80, 0x0001}, {0x83F2, 0x002E} };
    rtksw_uint32 redData9[][2] =  { {0x82F1, 0x0500}, {0xF995, 0x0501}, {0x31A2, 0x0502}, {0x796C, 0x0503}, {0x9728, 0x0504}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x0F80, 0x0001}, {0x83F2, 0x002E} };
    rtksw_uint32 redDataHB[][2] = { {0x82F0, 0x0500}, {0xF195, 0x0501}, {0x31A2, 0x0502}, {0x7960, 0x0503}, {0x9728, 0x0504}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x0F80, 0x0001}, {0x83F2, 0x002E} };
    ...
    if (1==type)
    {
        if((mode == EXT_1000X_100FX) || (mode == EXT_1000X) || (mode == EXT_100FX))
        {
            ...
            if(mode == EXT_1000X_100FX)
            {
                ...
                {
                    if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Fiber2_Auto[idx])) != RT_ERR_OK)
                        return retVal;
                }
            }
            ...
            if(mode == EXT_1000X)
            {
                ...
                {
                    if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Fiber2_1G[idx])) != RT_ERR_OK)
                        return retVal;
                }
            }
            ...
            if(mode == EXT_100FX)
            {
                ...
                {
                    if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Fiber2_100M[idx])) != RT_ERR_OK)
                        return retVal;
                }
            }
        ...
        if( (mode == EXT_SGMII) || (mode == EXT_HSGMII) )
        {
            ...
            {
                if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Sgmii_Init[idx])) != RT_ERR_OK)
                    return retVal;
            }
    ...
    else if (2 == type)
    {
        ...
        {
            if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Fiber1_2_Init[idx])) != RT_ERR_OK)
                return retVal;
        }
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortExtMode(rtksw_uint32 id, rtksw_uint32 *pMode)
{
    ret_t   retVal;
    rtksw_uint32 regData, regValue, type;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEnableAll(rtksw_uint32 enable)
{
    if(enable >= 2)
        return RT_ERR_INPUT;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEnableAll(rtksw_uint32 *pEnable)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortSmallIpg(rtksw_uint32 port, rtksw_uint32 enable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortSmallIpg(rtksw_uint32 port, rtksw_uint32* pEnable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortLoopback(rtksw_uint32 port, rtksw_uint32 enable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortLoopback(rtksw_uint32 port, rtksw_uint32 *pEnable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 */
ret_t rtl8367c_setAsicPortRTCTEnable(rtksw_uint32 portmask)
{
    ret_t       retVal;
    rtksw_uint32  regData;
    rtksw_uint32  port;
 ...
 *      RTCT test takes 4.8 seconds at most.
 */
ret_t rtl8367c_setAsicPortRTCTDisable(rtksw_uint32 portmask)
{
    ret_t       retVal;
    rtksw_uint32  regData;
    rtksw_uint32  port;
 ...
 */
ret_t rtl8367c_getAsicPortRTCTResult(rtksw_uint32 port, rtl8367c_port_rtct_result_t *pResult)
{
    ret_t       retVal;
    rtksw_uint32  regData, finish = 1;
 ...
 *      None.
 */
ret_t rtl8367c_sdsReset(rtksw_uint32 id)
{
    rtksw_uint32 retVal, regValue, state, i, option, running = 0, retVal2;
 ...
 *      None.
 */
ret_t rtl8367c_getSdsLinkStatus(rtksw_uint32 ext_id, rtksw_uint32 *pSignalDetect, rtksw_uint32 *pSync, rtksw_uint32 *pLink)
{
    rtksw_uint32 retVal, regValue, type, running = 0, retVal2;
 ...
 *      None.
 */
ret_t rtl8367c_setSgmiiNway(rtksw_uint32 ext_id, rtksw_uint32 state)
{
    rtksw_uint32 retVal, regValue, type, running = 0, retVal2;
 ...
 *      None.
 */
ret_t rtl8367c_getSgmiiNway(rtksw_uint32 ext_id, rtksw_uint32 *pState)
{
    rtksw_uint32 retVal, regValue, type, running = 0, retVal2;
 ...
 *      None
 */
ret_t rtl8367c_setFiberAbilityExt(rtksw_uint32 ext_id, rtksw_uint32 pause, rtksw_uint32 asypause)
{
    rtksw_uint32 retVal, regValue, type;
 ...
 *      None
 */
ret_t rtl8367c_getFiberAbilityExt(rtksw_uint32 ext_id, rtksw_uint32* pPause, rtksw_uint32* pAsypause)
{
    rtksw_uint32 retVal, regValue, type;
