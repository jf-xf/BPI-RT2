...
static void _rtl8367c_svlanConfStUser2Smi( rtl8367c_svlan_memconf_t *pUserSt, rtksw_uint16 *pSmiSt)
{
    ...
    pSmiSt[3] |= ((pUserSt->vs_untag & 0x0700) >> 8) << 8;
}

static void _rtl8367c_svlanConfStSmi2User( rtl8367c_svlan_memconf_t *pUserSt, rtksw_uint16 *pSmiSt)
{

    pUserSt->vs_member = (pSmiSt[0] & 0x00FF) | ((pSmiSt[3] & 0x0007) << 8);
    pUserSt->vs_untag = ((pSmiSt[0] & 0xFF00) >> 8) | (((pSmiSt[3] & 0x0700) >> 8) << 8);
...
static void _rtl8367c_svlanMc2sStUser2Smi(rtl8367c_svlan_mc2s_t *pUserSt, rtksw_uint16 *pSmiSt)
{
    pSmiSt[0] |= (pUserSt->svidx & 0x003F);
    pSmiSt[0] |= (pUserSt->format & 0x0001) << 6;
    pSmiSt[0] |= (pUserSt->valid & 0x0001) << 7;

    pSmiSt[1] = (rtksw_uint16)(pUserSt->smask & 0x0000FFFF);
    pSmiSt[2] = (rtksw_uint16)((pUserSt->smask & 0xFFFF0000) >> 16);

    pSmiSt[3] = (rtksw_uint16)(pUserSt->sdata & 0x0000FFFF);
    pSmiSt[4] = (rtksw_uint16)((pUserSt->sdata & 0xFFFF0000) >> 16);
}

static void _rtl8367c_svlanMc2sStSmi2User(rtl8367c_svlan_mc2s_t *pUserSt, rtksw_uint16 *pSmiSt)
{
...
static void _rtl8367c_svlanSp2cStUser2Smi(rtl8367c_svlan_s2c_t *pUserSt, rtksw_uint16 *pSmiSt)
{
...
static void _rtl8367c_svlanSp2cStSmi2User(rtl8367c_svlan_s2c_t *pUserSt, rtksw_uint16 *pSmiSt)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanUplinkPortMask(rtksw_uint32 portMask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanUplinkPortMask(rtksw_uint32* pPortmask)
{
 ...
 */
ret_t rtl8367c_setAsicSvlanTpid(rtksw_uint32 protocolType)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanTpid(rtksw_uint32* pProtocolType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanPrioritySel(rtksw_uint32 priSel)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanPrioritySel(rtksw_uint32* pPriSel)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanTrapPriority(rtksw_uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanTrapPriority(rtksw_uint32* pPriority)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanDefaultVlan(rtksw_uint32 port, rtksw_uint32 index)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanDefaultVlan(rtksw_uint32 port, rtksw_uint32* pIndex)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanIngressUntag(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanIngressUntag(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanIngressUnmatch(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanIngressUnmatch(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanEgressUnassign(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanEgressUnassign(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanMemberConfiguration(rtksw_uint32 index, rtl8367c_svlan_memconf_t* pSvlanMemCfg)
{
    ret_t retVal;
    rtksw_uint32 regAddr, regData;
    rtksw_uint16 *accessPtr;
    rtksw_uint32 i;
    rtksw_uint16 smiSvlanMemConf[RTL8367C_SVLAN_MEMCONF_LEN];

    if(index > RTL8367C_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;

    memset(smiSvlanMemConf, 0x00, sizeof(rtksw_uint16) * RTL8367C_SVLAN_MEMCONF_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanMemberConfiguration(rtksw_uint32 index,rtl8367c_svlan_memconf_t* pSvlanMemCfg)
{
    ret_t retVal;
    rtksw_uint32 regAddr,regData;
    rtksw_uint16 *accessPtr;
 ...
 */
ret_t rtl8367c_setAsicSvlanC2SConf(rtksw_uint32 index, rtksw_uint32 evid, rtksw_uint32 portmask, rtksw_uint32 svidx)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanC2SConf(rtksw_uint32 index, rtksw_uint32* pEvid, rtksw_uint32* pPortmask, rtksw_uint32* pSvidx)
{
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicSvlanMC2SConf(rtksw_uint32 index,rtl8367c_svlan_mc2s_t* pSvlanMc2sCfg)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint16 *accessPtr;
    rtksw_uint32 i;
    rtksw_uint16 smiSvlanMC2S[RTL8367C_SVLAN_MC2S_LEN];

    if(index > RTL8367C_MC2SIDXMAX)
        return RT_ERR_ENTRY_INDEX;

    memset(smiSvlanMC2S, 0x00, sizeof(rtksw_uint16) * RTL8367C_SVLAN_MC2S_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanMC2SConf(rtksw_uint32 index, rtl8367c_svlan_mc2s_t* pSvlanMc2sCfg)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint16 *accessPtr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanSP2CConf(rtksw_uint32 index, rtl8367c_svlan_s2c_t* pSvlanSp2cCfg)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint16 *accessPtr;
    rtksw_uint32 i;
    rtksw_uint16 smiSvlanSP2C[RTL8367C_SVLAN_SP2C_LEN];

    if(index > RTL8367C_SP2CMAX)
        return RT_ERR_ENTRY_INDEX;

    memset(smiSvlanSP2C, 0x00, sizeof(rtksw_uint16) * RTL8367C_SVLAN_SP2C_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanSP2CConf(rtksw_uint32 index,rtl8367c_svlan_s2c_t* pSvlanSp2cCfg)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint16 *accessPtr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanDmacCvidSel(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanDmacCvidSel(rtksw_uint32 port, rtksw_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanUntagVlan(rtksw_uint32 index)
{
    if(index > RTL8367C_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanUntagVlan(rtksw_uint32* pIndex)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanUnmatchVlan(rtksw_uint32 index)
{
    if(index > RTL8367C_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanUnmatchVlan(rtksw_uint32* pIndex)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanLookupType(rtksw_uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanLookupType(rtksw_uint32* pType)
{
