...
typedef struct omci_voice_wrapper_s
{
	...
	GOS_ERROR_CODE   (*omci_voice_config_update)(void);
    ...
    GOS_ERROR_CODE   (*omci_voice_CID_feature_set)(UINT16, UINT8);
    ...
    GOS_ERROR_CODE   (*omci_voice_SIPRegistrar_set)(UINT16, UINT32, CHAR *, UINT8, UINT32);
    ...
    GOS_ERROR_CODE   (*omci_voice_dial_plan_set)(UINT16, UINT8 *, UINT32, UINT8 , UINT16);
