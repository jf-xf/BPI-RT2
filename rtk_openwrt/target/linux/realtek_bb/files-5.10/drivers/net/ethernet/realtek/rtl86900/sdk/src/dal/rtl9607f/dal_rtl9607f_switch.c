...
dal_rtl9607f_switch_init(void)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_switch_init */

/* Function Name:
 *      dal_rtl9607f_switch_phyPortId_get
 * Description:
 ...
 */
int32
dal_rtl9607f_switch_phyPortId_get(rtk_switch_port_name_t portName, int32 *pPortId)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_SWITCH),"%s",__FUNCTION__);
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_switch_phyPortId_get */

/* Function Name:
 *      dal_rtl9607f_switch_version_get
 * Description:
 *      Get chip version
 * Input:
 *      pChipId    - chip id
...
int32
dal_rtl9607f_switch_version_get(uint32 *pChipId, uint32 *pRev, uint32 *pSubtype)
{
    int32  ret;
    ...
    *pSubtype = chipSubtype;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_switch_version_get */

/* Function Name:
  *      dal_rtl9607f_switch_maxPktLenByPort_get
  * Description:
  ...
  */
int32
dal_rtl9607f_switch_maxPktLenByPort_get(rtk_port_t port, uint32 *pLen)
{
    ca_status_t ret=CA_E_OK;
    ca_uint32_t ppid = 0;
    ...
    *pLen = size;
    ...
    return RT_ERR_OK;
} /*end of dal_rtl9607f_switch_maxPktLenByPort_get*/

/* Function Name:
  *      dal_rtl9607f_switch_maxPktLenByPort_set
  * Description:
  ...
  */
int32
dal_rtl9607f_switch_maxPktLenByPort_set(rtk_port_t port, uint32 len)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_uint32_t ppid = 0;
    ...
    return ret;
}/*end of dal_rtl9607f_switch_maxPktLenByPort_set*/

/* Function Name:
 *      dal_rtl9607f_switch_chip_reset
 * Description:
 *      Reset switch chip
 * Input:
 *      None
 ...
 */
int32
dal_rtl9607f_switch_chip_reset(void)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_switch_chip_reset */

/* Function Name:
  *      dal_rtl9607f_switch_thermal_get
  * Description:
  ...
  */
int32
dal_rtl9607f_switch_thermal_get(int32 *thermalIntger, int32 *thermalDecimal)
{
    int32   ret;
    uint32 value,tmp;
    ...
    *thermalDecimal = ((1000 *(*thermalDecimal))/1024)*1000;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_switch_thermal_get */
