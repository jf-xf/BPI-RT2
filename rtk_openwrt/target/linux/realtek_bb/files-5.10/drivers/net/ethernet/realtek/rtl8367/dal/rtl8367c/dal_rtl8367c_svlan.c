...
rtksw_uint8               svlan_mbrCfgUsage[RTL8367C_SVIDXNO];
rtksw_uint16              svlan_mbrCfgVid[RTL8367C_SVIDXNO];
rtksw_svlan_lookupType_t  svlan_lookupType;

rtksw_api_ret_t dal_rtl8367c_svlan_lookupType_set(rtksw_svlan_lookupType_t type);


/* Function Name:
 *      dal_rtl8367c_svlan_init
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_init(void)
{
    rtksw_uint32 i;
    ...
    if ((retVal = dal_rtl8367c_svlan_lookupType_set(SVLAN_LOOKUP_S64MBRCGF)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_servicePort_add(rtksw_port_t port)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmsk;
    ...
    pmsk = pmsk | (1<<rtksw_switch_port_L2P_get(port));
 ...
 *      contain accept SVID in S-tag field.
 */
rtksw_api_ret_t dal_rtl8367c_svlan_servicePort_get(rtksw_portmask_t *pSvlan_portmask)
{
    rtksw_api_ret_t retVal;
    ...
    if(rtksw_switch_portmask_P2L_get(phyMbrPmask, pSvlan_portmask) != RT_ERR_OK)
...
/* Function Name:
 *      dal_rtl8367c_svlan_servicePort_del
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_servicePort_del(rtksw_port_t port)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmsk;
...
/* Function Name:
 *      dal_rtl8367c_svlan_tpidEntry_set
 * Description:
 ...
 *      User can set mathced ether type as service provider supported protocol.
 */
rtksw_api_ret_t dal_rtl8367c_svlan_tpidEntry_set(rtksw_uint32 svlan_tag_id)
{
    rtksw_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_tpidEntry_get
 * Description:
 ...
 *      contain accept SVID in S-tag field.
 */
rtksw_api_ret_t dal_rtl8367c_svlan_tpidEntry_get(rtksw_uint32 *pSvlan_tag_id)
{
    rtksw_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_priorityRef_set
 * Description:
 ...
 *      - REF_PB_PRI.
 */
rtksw_api_ret_t dal_rtl8367c_svlan_priorityRef_set(rtksw_svlan_pri_ref_t ref)
{
    rtksw_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_priorityRef_get
 * Description:
 ...
 *      - REF_PB_PRI
 */
rtksw_api_ret_t dal_rtl8367c_svlan_priorityRef_get(rtksw_svlan_pri_ref_t *pRef)
{
    rtksw_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_memberPortEntry_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_memberPortEntry_set(rtksw_vlan_t svid, rtksw_svlan_memberCfg_t *pSvlan_cfg)
{
    rtksw_api_ret_t retVal;
    rtksw_int32 i;
    ...
    RTKSW_CHK_PORTMASK_VALID(&(pSvlan_cfg->memberport));

    RTKSW_CHK_PORTMASK_VALID(&(pSvlan_cfg->untagport));

    if (pSvlan_cfg->fiden > RTKSW_ENABLED)
    ...
    if (pSvlan_cfg->efiden > RTKSW_ENABLED)
        return RT_ERR_ENABLE;
    ...
    {
        if ((retVal = rtksw_vlan_get(svid, &vlanCfg)) != RT_ERR_OK)
            return retVal;

        vlanCfg.mbr = pSvlan_cfg->memberport;
        vlanCfg.untag = pSvlan_cfg->untagport;

        if ((retVal = rtksw_vlan_set(svid, &vlanCfg)) != RT_ERR_OK)
            return retVal;
    ...
    for (i = 0; i<= RTL8367C_SVIDXMAX; i++)
    {
        ...
        */
        if (svid == svlan_mbrCfgVid[i] && TRUE == svlan_mbrCfgUsage[i])
        {
            ...
            if(rtksw_switch_portmask_L2P_get(&(pSvlan_cfg->memberport), &phyMbrPmask) != RT_ERR_OK)
                return RT_ERR_FAILED;

            svlanMemConf.vs_member = phyMbrPmask;

            if(rtksw_switch_portmask_L2P_get(&(pSvlan_cfg->untagport), &phyMbrPmask) != RT_ERR_OK)
                return RT_ERR_FAILED;
...
/* Function Name:
 *      dal_rtl8367c_svlan_memberPortEntry_get
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_memberPortEntry_get(rtksw_vlan_t svid, rtksw_svlan_memberCfg_t *pSvlan_cfg)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtl8367c_svlan_memconf_t svlanMemConf;
    ...
    for (i = 0; i<= RTL8367C_SVIDXMAX; i++)
    {
        ...
        if (svid == svlanMemConf.vs_svid)
        {
            ...
            if(rtksw_switch_portmask_P2L_get(svlanMemConf.vs_member,&(pSvlan_cfg->memberport)) != RT_ERR_OK)
                return RT_ERR_FAILED;

            if(rtksw_switch_portmask_P2L_get(svlanMemConf.vs_untag,&(pSvlan_cfg->untagport)) != RT_ERR_OK)
                return RT_ERR_FAILED;
...
/* Function Name:
 *      dal_rtl8367c_svlan_memberPortEntry_adv_set
 * Description:
 ...
 *      - rtksw_svlan_memberCfg_t->priority is priority of SVLAN member configuration.
 */
rtksw_api_ret_t dal_rtl8367c_svlan_memberPortEntry_adv_set(rtksw_uint32 idx, rtksw_svlan_memberCfg_t *pSvlan_cfg)
{
    rtksw_api_ret_t retVal;
    rtl8367c_svlan_memconf_t svlanMemConf;
    rtksw_uint32 phyMbrPmask;
...
/* Function Name:
 *      dal_rtl8367c_svlan_memberPortEntry_adv_get
 * Description:
 ...
 *      to receiving from uplink ports. Other SVID S-tag frame or S-untagged frame will be droped.
 */
rtksw_api_ret_t dal_rtl8367c_svlan_memberPortEntry_adv_get(rtksw_uint32 idx, rtksw_svlan_memberCfg_t *pSvlan_cfg)
{
    rtksw_api_ret_t retVal;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_defaultSvlan_set(rtksw_port_t port, rtksw_vlan_t svid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtl8367c_svlan_memconf_t svlanMemConf;
    ...
    for (i = 0; i < RTL8367C_SVIDXNO; i++)
    {
        ...
        if (svid == svlanMemConf.vs_svid)
        {
            if ((retVal = rtl8367c_setAsicSvlanDefaultVlan(rtksw_switch_port_L2P_get(port), i)) != RT_ERR_OK)
                return retVal;
 ...
 *      is transmit through uplink port with s-tag field
 */
rtksw_api_ret_t dal_rtl8367c_svlan_defaultSvlan_get(rtksw_port_t port, rtksw_vlan_t *pSvid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 idx;
    rtl8367c_svlan_memconf_t svlanMemConf;
    ...
    if ((retVal = rtl8367c_getAsicSvlanDefaultVlan(rtksw_switch_port_L2P_get(port), &idx)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_c2s_add(rtksw_vlan_t vid, rtksw_port_t src_port, rtksw_vlan_t svid)
{
    rtksw_api_ret_t retVal, i;
    rtksw_uint32 empty_idx;
    rtksw_uint32 evid, pmsk, svidx, c2s_svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
    ...
    /* Check port Valid */
    RTKSW_CHK_PORT_VALID(src_port);

    phyPort = rtksw_switch_port_L2P_get(src_port);
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_c2s_del(rtksw_vlan_t vid, rtksw_port_t src_port)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 evid, pmsk, svidx;
    rtksw_port_t phyPort;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_c2s_get(rtksw_vlan_t vid, rtksw_port_t src_port, rtksw_vlan_t *pSvid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 evid, pmsk, svidx;
...
/* Function Name:
 *      dal_rtl8367c_svlan_untag_action_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_untag_action_set(rtksw_svlan_untag_action_t action, rtksw_vlan_t svid)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      i;
    rtl8367c_svlan_memconf_t svlanMemConf;
    ...
    if ((retVal = rtl8367c_setAsicSvlanIngressUntag((rtksw_uint32)action)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_untag_action_get
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_untag_action_get(rtksw_svlan_untag_action_t *pAction, rtksw_vlan_t *pSvid)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
...
/* Function Name:
 *      dal_rtl8367c_svlan_unmatch_action_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_unmatch_action_set(rtksw_svlan_unmatch_action_t action, rtksw_vlan_t svid)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      i;
    rtl8367c_svlan_memconf_t svlanMemConf;
    ...
    if ((retVal = rtl8367c_setAsicSvlanIngressUnmatch((rtksw_uint32)action)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_unmatch_action_get(rtksw_svlan_unmatch_action_t *pAction, rtksw_vlan_t *pSvid)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
...
/* Function Name:
 *      dal_rtl8367c_svlan_unassign_action_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_unassign_action_set(rtksw_svlan_unassign_action_t action)
{
    rtksw_api_ret_t   retVal;
    ...
    retVal = rtl8367c_setAsicSvlanEgressUnassign((rtksw_uint32)action);

    return retVal;
}

/* Function Name:
 *      dal_rtl8367c_svlan_unassign_action_get
 * Description:
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_svlan_unassign_action_get(rtksw_svlan_unassign_action_t *pAction)
{
    rtksw_api_ret_t   retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_dmac_vidsel_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_dmac_vidsel_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_setAsicSvlanDmacCvidSel(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
            return retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_dmac_vidsel_get
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_dmac_vidsel_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_getAsicSvlanDmacCvidSel(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
            return retVal;

    return RT_ERR_OK;
}
/* Function Name:
 *      dal_rtl8367c_svlan_ipmc2s_add
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_ipmc2s_add(ipaddr_t ipmc, ipaddr_t ipmcMsk, rtksw_vlan_t svid)
{
    rtksw_api_ret_t retVal, i;
    rtksw_uint32 empty_idx;
    rtksw_uint32 svidx;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_ipmc2s_del(ipaddr_t ipmc, ipaddr_t ipmcMsk)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtl8367c_svlan_mc2s_t svlanMC2SConf;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_ipmc2s_get(ipaddr_t ipmc, ipaddr_t ipmcMsk, rtksw_vlan_t *pSvid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_l2mc2s_add(rtksw_mac_t mac, rtksw_mac_t macMsk, rtksw_vlan_t svid)
{
    rtksw_api_ret_t retVal, i;
    rtksw_uint32 empty_idx;
    rtksw_uint32 svidx, l2add, l2Mask;
    rtl8367c_svlan_memconf_t svlanMemConf;
    rtl8367c_svlan_mc2s_t svlanMC2SConf;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_l2mc2s_del(rtksw_mac_t mac, rtksw_mac_t macMsk)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 l2add, l2Mask;
    rtl8367c_svlan_mc2s_t svlanMC2SConf;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_l2mc2s_get(rtksw_mac_t mac, rtksw_mac_t macMsk, rtksw_vlan_t *pSvid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 l2add,l2Mask;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_sp2c_add(rtksw_vlan_t svid, rtksw_port_t dst_port, rtksw_vlan_t cvid)
{
    rtksw_api_ret_t retVal, i;
    rtksw_uint32 empty_idx, svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
    rtl8367c_svlan_s2c_t svlanSP2CConf;
    rtksw_port_t port;
    ...
    /* Check port Valid */
    RTKSW_CHK_PORT_VALID(dst_port);
    port = rtksw_switch_port_L2P_get(dst_port);
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_sp2c_get(rtksw_vlan_t svid, rtksw_port_t dst_port, rtksw_vlan_t *pCvid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i, svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
    rtl8367c_svlan_s2c_t svlanSP2CConf;
    ...
    /* Check port Valid */
    RTKSW_CHK_PORT_VALID(dst_port);
    dst_port = rtksw_switch_port_L2P_get(dst_port);
 ...
 */
rtksw_api_ret_t dal_rtl8367c_svlan_sp2c_del(rtksw_vlan_t svid, rtksw_port_t dst_port)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i, svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
...
/* Function Name:
 *      dal_rtl8367c_svlan_lookupType_set
 * Description:
...
rtksw_api_ret_t dal_rtl8367c_svlan_lookupType_set(rtksw_svlan_lookupType_t type)
{
    ...
    retVal = rtl8367c_setAsicSvlanLookupType((rtksw_uint32)type);

    return retVal;
}

/* Function Name:
 *      dal_rtl8367c_svlan_lookupType_get
 * Description:
 ...
 *      none
 */
rtksw_api_ret_t dal_rtl8367c_svlan_lookupType_get(rtksw_svlan_lookupType_t *pType)
{
    rtksw_api_ret_t   retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_trapPri_set
 * Description:
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_svlan_trapPri_set(rtksw_pri_t priority)
{
    rtksw_api_ret_t   retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_trapPri_get
 * Description:
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_svlan_trapPri_get(rtksw_pri_t *pPriority)
{
    rtksw_api_ret_t   retVal;
...
/* Function Name:
 *      dal_rtl8367c_svlan_checkAndCreateMbr
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_svlan_checkAndCreateMbr(rtksw_vlan_t vid, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 svidx;
