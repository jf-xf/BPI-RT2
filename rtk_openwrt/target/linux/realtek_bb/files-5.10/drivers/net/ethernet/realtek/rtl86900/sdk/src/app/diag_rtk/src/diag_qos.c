    ...
    char * *ports_ptr)
{
    ...
    diag_portlist_t portlist;
    rtk_port_t port;
    rtk_qos_dscpRmkSrc_t source=DSCP_RMK_SRC_INT_PRI;
...
cparser_cmd_qos_get_scheduling_type(
    cparser_context_t *context)
{
    rtk_qos_scheduling_type_t type=RTK_QOS_WRR;
    int32 ret = RT_ERR_FAILED;
    ...
    char * *ports_ptr)
{
    ...
    rtk_port_t port;
    int32 ret = RT_ERR_FAILED;
    rtk_qos_do1pRmkSrc_t source=DOT1P_RMK_SRC_USER_PRI;
