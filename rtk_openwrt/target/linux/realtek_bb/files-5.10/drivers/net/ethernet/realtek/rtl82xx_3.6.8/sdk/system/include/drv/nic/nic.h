...
#define NML_FRAME_SIZE_MAX              1600

#if !defined(CONFIG_SDK_DRIVER_EXTC_NIC)
#define JUMBO_FRAME_SIZE_MAX            12288
#define QUEUE_RX_POOL_SIZE              1200
#define QUEUE_TX_POOL_SIZE              200
#define QUEUE_POOL_MAX_SIZE             (QUEUE_RX_POOL_SIZE + QUEUE_TX_POOL_SIZE)
#define JUMBO_QUEUE_RX_POOL_SIZE        100
#define JUMBO_QUEUE_TX_POOL_SIZE        40
#define JUMBO_QUEUE_POOL_MAX_SIZE       (JUMBO_QUEUE_RX_POOL_SIZE + JUMBO_QUEUE_TX_POOL_SIZE)
#else
#define JUMBO_FRAME_SIZE_MAX            9216
#define QUEUE_RX_POOL_SIZE              1300
#define QUEUE_TX_POOL_SIZE              100
#define QUEUE_POOL_MAX_SIZE             (QUEUE_RX_POOL_SIZE + QUEUE_TX_POOL_SIZE)
#define JUMBO_QUEUE_RX_POOL_SIZE        100
#define JUMBO_QUEUE_TX_POOL_SIZE        40
#define JUMBO_QUEUE_POOL_MAX_SIZE       (JUMBO_QUEUE_RX_POOL_SIZE + JUMBO_QUEUE_TX_POOL_SIZE)
