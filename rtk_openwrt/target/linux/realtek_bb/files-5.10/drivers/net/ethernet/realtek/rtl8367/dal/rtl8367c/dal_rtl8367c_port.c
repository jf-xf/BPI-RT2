...
static rtksw_api_ret_t _dal_rtl8367c_port_FiberModeAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      regData;

    /* Check Combo port or not */
    RTKSW_CHK_PORT_IS_COMBO(port);
...
static rtksw_api_ret_t _dal_rtl8367c_port_FiberModeAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t   retVal;
    ...
    memset(pAbility, 0x00, sizeof(rtksw_port_phy_ability_t));
...
static rtksw_api_ret_t _dal_rtl8367c_port_phyComboPortMedia_get(rtksw_port_t port, rtksw_port_media_t *pMedia)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      regData;
    rtksw_uint32      data;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyAutoNegoAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t       retVal;
    ...
    if (rtksw_switch_isComboPort(port) == RT_ERR_OK)
    {
    ...
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_1000_BASET_CONTROL_REG, &phyData)) != RT_ERR_OK)
        return retVal;

    phyData = (phyData & (~0x0200)) | phyEnMsk9 ;

    if ((retVal = rtl8367c_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_1000_BASET_CONTROL_REG, phyData)) != RT_ERR_OK)
        return retVal;

    /*Auto-Negotiation control register setting*/
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_AN_ADVERTISEMENT_REG, &phyData)) != RT_ERR_OK)
        return retVal;

    phyData = (phyData & (~0x0DE0)) | phyEnMsk4;
    if ((retVal = rtl8367c_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_AN_ADVERTISEMENT_REG, phyData)) != RT_ERR_OK)
        return retVal;

    /*Control register setting and restart auto*/
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, &phyData)) != RT_ERR_OK)
        return retVal;
    ...
    if ((retVal = rtl8367c_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, phyData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyAutoNegoAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t       retVal;
    ...
    /*Control register setting and restart auto*/
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, &phyData0)) != RT_ERR_OK)
        return retVal;

    /*Auto-Negotiation control register setting*/
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_AN_ADVERTISEMENT_REG, &phyData4)) != RT_ERR_OK)
        return retVal;

    /*1000 BASE-T control register setting*/
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_1000_BASET_CONTROL_REG, &phyData9)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyForceModeAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
     rtksw_api_ret_t      retVal;
     rtksw_uint32         phyData;
     rtksw_uint32         phyEnMsk0;
 ...
 *      Get the capablity of specified PHY.
 */
rtksw_api_ret_t dal_rtl8367c_port_phyForceModeAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t       retVal;
    rtksw_uint32          phyData0;
    rtksw_uint32          phyData4;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyStatus_get(rtksw_port_t port, rtksw_port_linkStatus_t *pLinkStatus, rtksw_port_speed_t *pSpeed, rtksw_port_duplex_t *pDuplex)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyData;
    ...
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_RESOLVED_REG, &phyData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_macForceLink_set(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortForceLink(rtksw_switch_port_L2P_get(port), &ability)) != RT_ERR_OK)
        return retVal;
    ...
    if ((retVal = rtl8367c_setAsicPortForceLink(rtksw_switch_port_L2P_get(port), &ability)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_macForceLink_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    rtl8367c_port_ability_t ability;
 ...
 *      - MODE_EXT_100FX,
 */
rtksw_api_ret_t dal_rtl8367c_port_macForceLinkExt_set(rtksw_port_t port, rtksw_mode_ext_t mode, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    rtl8367c_port_ability_t ability;
    rtksw_uint32 ext_id;
    ...
    if(mode == MODE_EXT_HSGMII)
    {
        ...
        if(rtksw_switch_isHsgPort(port) != RT_ERR_OK)
    ...
    else
    {
        ...
        ability.forcemode = pPortability->forcemode;
        ability.speed     = (mode == MODE_EXT_HSGMII) ? RTKSW_PORT_SPEED_1000M : pPortability->speed;
        ability.duplex    = pPortability->duplex;
        ability.link      = pPortability->link;
        ability.nway      = pPortability->nway;
        ability.txpause   = pPortability->txpause;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_macForceLinkExt_get(rtksw_port_t port, rtksw_mode_ext_t *pMode, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    rtl8367c_port_ability_t ability;
    rtksw_uint32 ext_id;
    ...
    if ((retVal = rtl8367c_getAsicPortExtMode(ext_id, (rtksw_uint32 *)pMode)) != RT_ERR_OK)
        return retVal;
    ...
    pPortability->forcemode = ability.forcemode;
    pPortability->speed     = (*pMode == MODE_EXT_HSGMII) ? RTKSW_PORT_SPEED_2500M : ability.speed;
    pPortability->duplex    = ability.duplex;
    pPortability->link      = ability.link;
    pPortability->nway      = ability.nway;
    pPortability->txpause   = ability.txpause;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_macStatus_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortstatus)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortStatus(rtksw_switch_port_L2P_get(port), &status)) != RT_ERR_OK)
        return retVal;
    ...
    if( (rtksw_switch_isHsgPort(port) == RT_ERR_OK) && (hsgsel == 1) )
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_macLocalLoopbackEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      data;
    ...
    if ((retVal = rtl8367c_setAsicPortLoopback(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
        return retVal;

    if(rtksw_switch_isUtpPort(port) == RT_ERR_OK)
    {
        if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, &data)) != RT_ERR_OK)
            return retVal;
        ...
        if ((retVal = rtl8367c_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, data)) != RT_ERR_OK)
            return retVal;
    }
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367c_port_macLocalLoopbackEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortLoopback(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyReg_set(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t regData)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicPHYReg(rtksw_switch_port_L2P_get(port), reg, regData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyReg_get(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t *pData)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPHYReg(rtksw_switch_port_L2P_get(port), reg, pData)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLE (Backpressure)
 */
rtksw_api_ret_t dal_rtl8367c_port_backpressureEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - ENABLE (Backpressure)
 */
rtksw_api_ret_t dal_rtl8367c_port_backpressureEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367c_port_adminEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32      data;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367c_port_adminEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32      data;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_isolation_set(rtksw_port_t port, rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
    ...
    if ((retVal = rtl8367c_setAsicPortIsolationPermittedPortmask(rtksw_switch_port_L2P_get(port), pmask)) != RT_ERR_OK)
        return retVal;
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
rtksw_api_ret_t dal_rtl8367c_port_isolation_get(rtksw_port_t port, rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
    ...
    if ((retVal = rtl8367c_getAsicPortIsolationPermittedPortmask(rtksw_switch_port_L2P_get(port), &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_rgmiiDelayExt_set(rtksw_port_t port, rtksw_data_t txDelay, rtksw_data_t rxDelay)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_rgmiiDelayExt_get(rtksw_port_t port, rtksw_data_t *pTxDelay, rtksw_data_t *pRxDelay)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regAddr, regData;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367c_port_phyEnableAll_set(rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 data;
    rtksw_uint32 port;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367c_port_phyEnableAll_get(rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_efid_set(rtksw_port_t port, rtksw_data_t efid)
{
    rtksw_api_ret_t retVal;
    ...
    /* efid must be 0~7 */
    if (efid > RTKSW_EFID_MAX)
        return RT_ERR_INPUT;

    if ((retVal = rtl8367c_setAsicPortIsolationEfid(rtksw_switch_port_L2P_get(port), efid))!=RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_efid_get(rtksw_port_t port, rtksw_data_t *pEfid)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortIsolationEfid(rtksw_switch_port_L2P_get(port), pEfid))!=RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_phyComboPortMedia_set(rtksw_port_t port, rtksw_port_media_t media)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 idx;
    ...
    if(media == RTKSW_PORT_MEDIA_FIBER)
    {
        ...
        {
            if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Fiber[idx])) != RT_ERR_OK)
                return retVal;
        }
    ...
    else if(media == RTKSW_PORT_MEDIA_AUTO)
    {
        ...
        {
            if ((retVal = rtl8367c_setAsicReg(0xE000 + idx, (rtksw_uint32)Fiber_auto[idx])) != RT_ERR_OK)
                return retVal;
        }
 ...
 *      The API can Set Combo port media type.
 */
rtksw_api_ret_t dal_rtl8367c_port_phyComboPortMedia_get(rtksw_port_t port, rtksw_port_media_t *pMedia)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      regData;
    rtksw_uint32      data;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_rtctEnable_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t   retVal;
    ...
    RTKSW_CHK_PORTMASK_VALID_ONLY_UTP(pPortmask);
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_rtctDisable_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t   retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_rtctResult_get(rtksw_port_t port, rtksw_rtctResult_t *pRtctResult)
{
    rtksw_api_ret_t               retVal;
    ...
    memset(pRtctResult, 0x00, sizeof(rtksw_rtctResult_t));
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_sds_reset(rtksw_port_t port)
{
    rtksw_uint32 ext_id;
    ...
    /* Check Port Valid */
    if(rtksw_switch_isSgmiiPort(port) != RT_ERR_OK)
        return RT_ERR_PORT_ID;
 ...
 *      The API can reset Serdes
 */
rtksw_api_ret_t dal_rtl8367c_port_sgmiiLinkStatus_get(rtksw_port_t port, rtksw_data_t *pSignalDetect, rtksw_data_t *pSync, rtksw_port_linkStatus_t *pLink)
{
    rtksw_uint32 ext_id;
    ...
    ext_id = port - 15;
    return rtl8367c_getSdsLinkStatus(ext_id, (rtksw_uint32 *)pSignalDetect, (rtksw_uint32 *)pSync, (rtksw_uint32 *)pLink);
}
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_sgmiiNway_set(rtksw_port_t port, rtksw_enable_t state)
{
    rtksw_uint32 ext_id;
    ...
    ext_id = port - 15;
    return rtl8367c_setSgmiiNway(ext_id, (rtksw_uint32)state);
}
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_sgmiiNway_get(rtksw_port_t port, rtksw_enable_t *pState)
{
    rtksw_uint32 ext_id;
    ...
    ext_id = port - 15;
    return rtl8367c_getSgmiiNway(ext_id, (rtksw_uint32 *)pState);
}
 ...
 *      The API can get SGMII/HSGMII port Nway state
 */
rtksw_api_ret_t dal_rtl8367c_port_fiberAbilityExt_set(rtksw_port_t port, rtksw_uint32 pause, rtksw_uint32 asypause)
{
    rtksw_uint32 ext_id;
 ...
 *      The API can get SGMII/HSGMII port Nway state
 */
rtksw_api_ret_t dal_rtl8367c_port_fiberAbilityExt_get(rtksw_port_t port, rtksw_uint32* pPause, rtksw_uint32* pAsypause)
{
    rtksw_uint32 ext_id;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_autoDos_set(rtksw_port_autoDosType_t type, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicRegBit(RTL8367C_REG_DOS_CFG, RTL8367C_DROP_DAEQSA_OFFSET + type, (state == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_port_autoDos_get(rtksw_port_autoDosType_t type, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
