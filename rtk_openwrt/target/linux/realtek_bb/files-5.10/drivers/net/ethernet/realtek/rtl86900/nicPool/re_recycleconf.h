...
#define RTL_POOL_NUM_SHIFT_BITS 4		//support (0x1<<RTL_POOL_NUM_SHIFT_BITS) - 1 pools, since zero means invalid

#ifdef RTL_LL_LINK_LIST_RECYCLE_SKB
#include <linux/llist.h>		//Lock-less NULL terminated single linked list
#endif
