...
/*
 * rt_epon dump mib-counter
 */
cparser_result_t
cparser_cmd_rt_epon_dump_mib_counter(
    cparser_context_t *context)
{
    ...
    diag_util_mprintf("mpcpTxRegAck        : %8d\n",counter.mpcpTxRegAck);
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_rt_epon_dump_mib_counter */




/*
 * rt_epon reset mib-counter
 */
cparser_result_t
cparser_cmd_rt_epon_reset_mib_counter(
    cparser_context_t *context)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rt_epon_mibCounter_reset(), ret); 


    return CPARSER_OK;
}    /* end of cparser_cmd_rt_epon_reset_mib_counter */
