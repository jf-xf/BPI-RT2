...
#define RTL8221B_MSG(fmt,args...)	printk(KERN_INFO "rtl8221b: "fmt"\n", ##args)
#define RTL8221B_INFO(fmt,args...)	printk(KERN_INFO "\033[1;33;46m""rtl8221b: "fmt"\033[m""\n", ##args)
#define RTL8221B_ERROR(fmt,args...)	printk(KERN_INFO "\033[1;33;41m""rtl8221b: "fmt"\033[m""\n", ##args)
#define phy_osal_printf			RTL8221B_INFO

//#define RTL8221B_PHY_DEBUG
#ifdef RTL8221B_PHY_DEBUG
#define RTL8221B_DEBUG			RTL8221B_INFO
#else
#define RTL8221B_DEBUG(fmt,args...)
#endif

#define CHIP_8226B                      0
#define CHIP_8221B_VB                   1
