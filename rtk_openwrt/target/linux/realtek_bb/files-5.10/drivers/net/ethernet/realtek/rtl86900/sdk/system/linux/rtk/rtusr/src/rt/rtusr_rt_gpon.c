...
rt_gpon_omci_mirror_get(rt_enable_t *pEnable, rt_port_t *pMirroringPort)
{
    ...
    /* function body */
    GETSOCKOPT(RTDRV_RT_GPON_OMCI_MIRROR_GET, &rt_gpon_cfg, rtdrv_rt_gponCfg_t, 1);
    osal_memcpy(pMirroringPort, &rt_gpon_cfg.mirroringPort, sizeof(rt_port_t));
    osal_memcpy(pEnable, &rt_gpon_cfg.mirrorEn, sizeof(rt_enable_t));
    return RT_ERR_OK;
