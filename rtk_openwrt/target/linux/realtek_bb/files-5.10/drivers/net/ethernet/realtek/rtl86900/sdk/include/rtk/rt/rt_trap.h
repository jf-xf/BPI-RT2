 ...
 *      RT_ERR_INPUT            - Invalid IGMP/MLD type
 ...
 *      rt_trap_pattern_get
 * Description:
 *      Get the configuration about detect setting
 * Input:
 *      type        - Pattern type.
 * Output:
 ...
 *      RT_ERR_FAILED       - Failed
 * Note:
 *      Pattern types include host MAC and ethertype,
 *      the host MAC and ethertype packet detection will base on this setting
 */
extern int32
 ...
 *      rt_trap_pattern_set
 * Description:
 *      Set the configuration about detect setting
 * Input:
 *      type        - Pattern type.
 *      pattern     - Trap pattern data
 * Output:
