...
gpon_loid=`flash get LOID | sed 's/LOID=//g' | grep -v entry | grep -v failed`
gpon_loid_old=`flash get LOID_OLD | sed 's/LOID_OLD=//g' | grep -v entry | grep -v failed`
gpon_loidPwd=`flash get LOID_PASSWD | sed 's/LOID_PASSWD=//g' | grep -v entry | grep -v failed`
gpon_loidPwd_old=`flash get LOID_PASSWD_OLD | sed 's/LOID_PASSWD_OLD=//g' | grep -v entry | grep -v failed`
