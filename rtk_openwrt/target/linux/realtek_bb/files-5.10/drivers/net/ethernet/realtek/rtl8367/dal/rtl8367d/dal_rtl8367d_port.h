 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyAutoNegoAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyAutoNegoAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 *      be set as following 100F > 100H > 10F > 10H priority sequence.
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyForceModeAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 *      Get the capablity of specified PHY.
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyForceModeAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyStatus_get(rtksw_port_t port, rtksw_port_linkStatus_t *pLinkStatus, rtksw_port_speed_t *pSpeed, rtksw_port_duplex_t *pDuplex);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macForceLink_set(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macForceLink_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability);
 ...
 *      - MODE_EXT_HSGMII,
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macForceLinkExt_set(rtksw_port_t port, rtksw_mode_ext_t mode, rtksw_port_mac_ability_t *pPortability);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macForceLinkExt_get(rtksw_port_t port, rtksw_mode_ext_t *pMode, rtksw_port_mac_ability_t *pPortability);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macStatus_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortstatus);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macLocalLoopbackEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367d_port_macLocalLoopbackEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyReg_set(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t value);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyReg_get(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t *pData);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_port_backpressureEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_port_backpressureEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_port_adminEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_port_adminEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_isolation_set(rtksw_port_t port, rtksw_portmask_t *pPortmask);
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
extern rtksw_api_ret_t dal_rtl8367d_port_isolation_get(rtksw_port_t port, rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_rgmiiDelayExt_set(rtksw_port_t port, rtksw_data_t txDelay, rtksw_data_t rxDelay);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_rgmiiDelayExt_get(rtksw_port_t port, rtksw_data_t *pTxDelay, rtksw_data_t *pRxDelay);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyEnableAll_set(rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyEnableAll_get(rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyComboPortMedia_set(rtksw_port_t port, rtksw_port_media_t media);
 ...
 *      The API can Set Combo port media type.
 */
extern rtksw_api_ret_t dal_rtl8367d_port_phyComboPortMedia_get(rtksw_port_t port, rtksw_port_media_t *pMedia);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_sgmiiLinkStatus_get(rtksw_port_t port, rtksw_data_t *pSignalDetect, rtksw_data_t *pSync, rtksw_port_linkStatus_t *pLink);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_sgmiiNway_set(rtksw_port_t port, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_sgmiiNway_get(rtksw_port_t port, rtksw_enable_t *pState);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_autoDos_set(rtksw_port_autoDosType_t type, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_port_autoDos_get(rtksw_port_autoDosType_t type, rtksw_enable_t *pState);
