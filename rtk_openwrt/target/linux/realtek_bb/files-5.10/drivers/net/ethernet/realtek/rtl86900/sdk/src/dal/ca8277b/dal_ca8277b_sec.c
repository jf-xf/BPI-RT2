...
dal_ca8277b_sec_init(void)
{
    ...
    {
        if ((ret = dal_ca8277b_sec_portAttackPreventState_set(port, DISABLED)) != RT_ERR_OK)
        {
...
dal_ca8277b_sec_portAttackPreventState_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    *pEnable = ((dos_fib.dos_port_mask & (1 << port)) != 0)? ENABLED : DISABLED;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_portAttackPreventState_get */
...
dal_ca8277b_sec_portAttackPreventState_set(rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_portAttackPreventState_set */
    ...
    rtk_action_t            *pAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_attackPrevent_get */
    ...
    rtk_action_t            action)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_attackPrevent_set */
...
dal_ca8277b_sec_attackFloodThresh_get(rtk_sec_attackFloodType_t type, uint32 *pFloodThresh)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_attackFloodThresh_get */
...
dal_ca8277b_sec_attackFloodThresh_set(rtk_sec_attackFloodType_t type, uint32 floodThresh)
{
    ...
    /* parameter check */
    RT_PARAM_CHK((SEC_FLOOD_END <= type), RT_ERR_INPUT);
    RT_PARAM_CHK((CA8277B_SEC_FLOOD_THRESHOLD_MAX < floodThresh), RT_ERR_INPUT);
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_attackFloodThresh_set */
...
dal_ca8277b_sec_attackFloodThreshUnit_get(rtk_sec_attackFloodType_t type, uint32 *pFloodThreshUnit)
{
    ...
    *pFloodThreshUnit = (flood_cnt.cnt / DOS_ATK_FLOOD_UNIT_1MS);
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_attackFloodThreshUnit_get */
...
dal_ca8277b_sec_attackFloodThreshUnit_set(rtk_sec_attackFloodType_t type, uint32 floodThreshUnit)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_sec_attackFloodThreshUnit_set */
