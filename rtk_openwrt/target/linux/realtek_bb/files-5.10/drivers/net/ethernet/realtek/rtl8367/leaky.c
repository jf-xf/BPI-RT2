 ...
 *      - LEAKY_LLDP.
 */
rtksw_api_ret_t rtksw_leaky_vlan_set(rtksw_leaky_type_t type, rtksw_enable_t enable)
{
 ...
 *      - LEAKY_LLDP.
 */
rtksw_api_ret_t rtksw_leaky_vlan_get(rtksw_leaky_type_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - LEAKY_LLDP.
 */
rtksw_api_ret_t rtksw_leaky_portIsolation_set(rtksw_leaky_type_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - LEAKY_LLDP.
 */
rtksw_api_ret_t rtksw_leaky_portIsolation_get(rtksw_leaky_type_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
