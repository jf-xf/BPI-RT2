 ...
 * Data Declaration
 */
static uint32 ca8277b_trap_init = INIT_NOT_COMPLETED;
...
{   
    ca8277b_trap_init = INIT_COMPLETED;

    return RT_ERR_OK;
} /* end of dal_ca8277b_trap_init */
...
dal_ca8277b_trap_portIgmpMldCtrlPktAction_get(rtk_port_t port, rtk_trap_igmpMld_type_t igmpMldType, rtk_action_t *pAction)
{
    ...
    *pAction = ((forward_to_cpu == 1) ? ACTION_TRAP2CPU : ACTION_FORWARD);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_trap_portIgmpMldCtrlPktAction_get */
...
dal_ca8277b_trap_portIgmpMldCtrlPktAction_set(rtk_port_t port, rtk_trap_igmpMld_type_t igmpMldType, rtk_action_t action)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_trap_portIgmpMldCtrlPktAction_set */
...
dal_ca8277b_trap_oamPduAction_get(rtk_action_t *pAction)
{
    ...
    *pAction = ((detect.udf0_detect_enable == 1) ? ACTION_TRAP2CPU : ACTION_FORWARD);
    return RT_ERR_OK;
} /* end of dal_ca8277b_trap_oamPduAction_get */
...
dal_ca8277b_trap_oamPduAction_set(rtk_action_t action)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_trap_oamPduAction_set */
...
dal_ca8277b_trap_omciAction_get(rtk_action_t *pAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_trap_omciAction_get */
...
dal_ca8277b_trap_omciAction_set(rtk_action_t action)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8277b_trap_omciAction_set */