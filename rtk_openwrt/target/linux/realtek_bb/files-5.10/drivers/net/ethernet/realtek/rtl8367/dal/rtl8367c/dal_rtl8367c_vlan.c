...
static rtksw_vlan_t           vlan_mbrCfgVid[RTL8367C_CVIDXNO];
static vlan_mbrCfgType_t    vlan_mbrCfgUsage[RTL8367C_CVIDXNO];


/* Function Name:
 *      dal_rtl8367c_vlan_init
 * Description:
 *      Initialize VLAN.
 * Input:
 *      None
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_init(void)
{
    ...
    /* Clean Database */
    memset(vlan_mbrCfgVid, 0x00, sizeof(rtksw_vlan_t) * RTL8367C_CVIDXNO);
    ...
    RTKSW_SCAN_ALL_PHY_PORTMASK(i)
    {
        if ((retVal = rtl8367c_setAsicVlanIngressFilter(i, RTKSW_ENABLED)) != RT_ERR_OK)
            return retVal;
    }

    /* enable VLAN */
    if ((retVal = rtl8367c_setAsicVlanFilter(RTKSW_ENABLED)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_set(rtksw_vlan_t vid, rtksw_vlan_cfg_t *pVlanCfg)
{
    rtksw_api_ret_t retVal;
    ...
    rtl8367c_vlanconfiguser vlanMC;
    rtksw_uint32 idx;
    rtksw_uint32 empty_index = 0xffff;
    rtksw_uint32 update_evid = 0;
    ...
    /* Policing */
    if(pVlanCfg->envlanpol >= RTKSW_ENABLE_END)
        return RT_ERR_ENABLE;

    /* Meter ID */
    if(pVlanCfg->meteridx > RTKSW_MAX_METER_ID)
        return RT_ERR_INPUT;

    /* VLAN based priority */
    if(pVlanCfg->vbpen >= RTKSW_ENABLE_END)
        return RT_ERR_ENABLE;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_get(rtksw_vlan_t vid, rtksw_vlan_cfg_t *pVlanCfg)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyMbrPmask;
    rtksw_uint32 phyUntagPmask;
...
/* Function Name:
 *      dal_rtl8367c_vlan_egrFilterEnable_set
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_egrFilterEnable_set(rtksw_enable_t egrFilter)
{
    rtksw_api_ret_t retVal;
    ...
    /* enable VLAN */
    if ((retVal = rtl8367c_setAsicVlanFilter((rtksw_uint32)egrFilter)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_egrFilterEnable_get
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_egrFilterEnable_get(rtksw_enable_t *pEgrFilter)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 state;
 ...
 *     Set a VLAN Member Configuration entry by index.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_mbrCfg_set(rtksw_uint32 idx, rtksw_vlan_mbrcfg_t *pMbrcfg)
{
    rtksw_api_ret_t           retVal;
    rtksw_uint32              phyMbrPmask;
    ...
    if(pMbrcfg->envlanpol >= RTKSW_ENABLE_END)
        return RT_ERR_ENABLE;

    if(pMbrcfg->meteridx > RTKSW_MAX_METER_ID)
        return RT_ERR_FILTER_METER_ID;

    if(pMbrcfg->vbpen >= RTKSW_ENABLE_END)
        return RT_ERR_ENABLE;
    ...
    /* Check port mask valid */
    RTKSW_CHK_PORTMASK_VALID(&(pMbrcfg->mbr));
    ...
    if(rtksw_switch_portmask_L2P_get(&(pMbrcfg->mbr), &phyMbrPmask) != RT_ERR_OK)
        return RT_ERR_FAILED;
 ...
 *     Get a VLAN Member Configuration entry by index.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_mbrCfg_get(rtksw_uint32 idx, rtksw_vlan_mbrcfg_t *pMbrcfg)
{
    rtksw_api_ret_t           retVal;
    rtksw_uint32              phyMbrPmask;
    rtl8367c_vlanconfiguser mbrCfg;
    ...
    if(rtksw_switch_portmask_P2L_get(phyMbrPmask, &(pMbrcfg->mbr)) != RT_ERR_OK)
        return RT_ERR_FAILED;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portPvid_set(rtksw_port_t port, rtksw_vlan_t pvid, rtksw_pri_t priority)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 index;
    ...
    if((retVal = dal_rtl8367c_vlan_checkAndCreateMbr(pvid, &index)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicVlanPortBasedVID(rtksw_switch_port_L2P_get(port), index, priority)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_portPvid_get
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portPvid_get(rtksw_port_t port, rtksw_vlan_t *pPvid, rtksw_pri_t *pPriority)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 index, pri;
    rtl8367c_vlanconfiguser mbrCfg;
    ...
    if ((retVal = rtl8367c_getAsicVlanPortBasedVID(rtksw_switch_port_L2P_get(port), &index, &pri)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_portIgrFilterEnable_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portIgrFilterEnable_set(rtksw_port_t port, rtksw_enable_t igr_filter)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicVlanIngressFilter(rtksw_switch_port_L2P_get(port), igr_filter)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_portIgrFilterEnable_get
 * Description:
 ...
 *     - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portIgrFilterEnable_get(rtksw_port_t port, rtksw_enable_t *pIgr_filter)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicVlanIngressFilter(rtksw_switch_port_L2P_get(port), pIgr_filter)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_portAcceptFrameType_set
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portAcceptFrameType_set(rtksw_port_t port, rtksw_vlan_acceptFrameType_t accept_frame_type)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicVlanAccpetFrameType(rtksw_switch_port_L2P_get(port), (rtl8367c_accframetype)accept_frame_type)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_portAcceptFrameType_get
 * Description:
 ...
 *     - RTKSW_ACCEPT_FRAME_TYPE_UNTAG_ONLY
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portAcceptFrameType_get(rtksw_port_t port, rtksw_vlan_acceptFrameType_t *pAccept_frame_type)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicVlanAccpetFrameType(rtksw_switch_port_L2P_get(port), &acc_frm_type)) != RT_ERR_OK)
        return retVal;

    *pAccept_frame_type = (rtksw_vlan_acceptFrameType_t)acc_frm_type;

    return RT_ERR_OK;
}

/* Function Name:
 *      dal_rtl8367c_vlan_protoAndPortBasedVlan_add
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_protoAndPortBasedVlan_add(rtksw_port_t port, rtksw_vlan_protoAndPortInfo_t *pInfo)
{
    rtksw_api_ret_t retVal, i;
    rtksw_uint32 exist, empty, used, index;
    ...
    if (pInfo->proto_type > RTKSW_MAX_NUM_OF_PROTO_TYPE)
        return RT_ERR_OUT_OF_RANGE;

    if (pInfo->frame_type >= RTKSW_FRAME_TYPE_END)
        return RT_ERR_OUT_OF_RANGE;
    ...
    if((retVal = dal_rtl8367c_vlan_checkAndCreateMbr(pInfo->cvid, &index)) != RT_ERR_OK)
        return retVal;

    ppb_vlan_cfg.vlan_idx = index;
    ppb_vlan_cfg.valid = TRUE;
    ppb_vlan_cfg.priority = pInfo->cpri;
    if ((retVal = rtl8367c_setAsicVlanPortAndProtocolBased(rtksw_switch_port_L2P_get(port), used, &ppb_vlan_cfg)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_protoAndPortBasedVlan_get
 * Description:
 ...
 *      - RTKSW_FRAME_TYPE_LLCOTHER
 */
rtksw_api_ret_t dal_rtl8367c_vlan_protoAndPortBasedVlan_get(rtksw_port_t port, rtksw_vlan_proto_type_t proto_type, rtksw_vlan_protoVlan_frameType_t frame_type, rtksw_vlan_protoAndPortInfo_t *pInfo)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 ppb_idx;
    rtl8367c_protocolgdatacfg ppb_data_cfg;
    rtl8367c_protocolvlancfg ppb_vlan_cfg;
    ...
    if (proto_type > RTKSW_MAX_NUM_OF_PROTO_TYPE)
        return RT_ERR_OUT_OF_RANGE;

    if (frame_type >= RTKSW_FRAME_TYPE_END)
        return RT_ERR_OUT_OF_RANGE;
   ...
   ppb_idx = 0;
    ...
    if ((retVal = rtl8367c_getAsicVlanPortAndProtocolBased(rtksw_switch_port_L2P_get(port), ppb_idx, &ppb_vlan_cfg)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_protoAndPortBasedVlan_del
 * Description:
 ...
 *      - RTKSW_FRAME_TYPE_LLCOTHER
 */
rtksw_api_ret_t dal_rtl8367c_vlan_protoAndPortBasedVlan_del(rtksw_port_t port, rtksw_vlan_proto_type_t proto_type, rtksw_vlan_protoVlan_frameType_t frame_type)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i, bUsed;
    rtksw_uint32 ppb_idx;
    rtl8367c_protocolgdatacfg ppb_data_cfg;
    rtl8367c_protocolvlancfg ppb_vlan_cfg;
   ...
   ppb_idx = 0;
    ...
    for (i = 0; i<= RTL8367C_PROTOVLAN_GIDX_MAX; i++)
    {
        ...
        if ( (ppb_data_cfg.frameType == (rtl8367c_provlan_frametype)frame_type) && (ppb_data_cfg.etherType == proto_type) )
        {
            ...
            if ((retVal = rtl8367c_setAsicVlanPortAndProtocolBased(rtksw_switch_port_L2P_get(port), ppb_idx, &ppb_vlan_cfg)) != RT_ERR_OK)
                return retVal;
        }
    }
...
/* Function Name:
 *      dal_rtl8367c_vlan_protoAndPortBasedVlan_delAll
 * Description:
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_protoAndPortBasedVlan_delAll(rtksw_port_t port)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i, j, bUsed[4];
    rtl8367c_protocolgdatacfg ppb_data_cfg;
    rtl8367c_protocolvlancfg ppb_vlan_cfg;
    ...
    for (i = 0; i<= RTL8367C_PROTOVLAN_GIDX_MAX; i++)
    {
        ...
        ppb_vlan_cfg.vlan_idx = 0;
        ppb_vlan_cfg.priority = 0;
        if ((retVal = rtl8367c_setAsicVlanPortAndProtocolBased(rtksw_switch_port_L2P_get(port), i, &ppb_vlan_cfg)) != RT_ERR_OK)
            return retVal;
    }
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_tagMode_set(rtksw_port_t port, rtksw_vlan_tagMode_t tag_mode)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicVlanEgressTagMode(rtksw_switch_port_L2P_get(port), tag_mode)) != RT_ERR_OK)
        return retVal;
 ...
 *      - RTKSW_VLAN_TAG_MODE_REAL_KEEP_FORMAT,
 */
rtksw_api_ret_t dal_rtl8367c_vlan_tagMode_get(rtksw_port_t port, rtksw_vlan_tagMode_t *pTag_mode)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicVlanEgressTagMode(rtksw_switch_port_L2P_get(port), &mode)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_transparent_set
 * Description:
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_transparent_set(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask)
{
     rtksw_api_ret_t retVal;
     rtksw_uint32    pmask;
     ...
     if ((retVal = rtl8367c_setAsicVlanTransparent(rtksw_switch_port_L2P_get(egr_port), pmask)) != RT_ERR_OK)
         return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_transparent_get
 * Description:
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_transparent_get(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask)
{
     rtksw_api_ret_t retVal;
     rtksw_uint32    pmask;
     ...
     if ((retVal = rtl8367c_getAsicVlanTransparent(rtksw_switch_port_L2P_get(egr_port), &pmask)) != RT_ERR_OK)
         return retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_keep_set(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask)
{
     rtksw_api_ret_t retVal;
     rtksw_uint32    pmask;
     ...
     if ((retVal = rtl8367c_setAsicVlanEgressKeep(rtksw_switch_port_L2P_get(egr_port), pmask)) != RT_ERR_OK)
         return retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_keep_get(rtksw_port_t egr_port, rtksw_portmask_t *pIgr_pmask)
{
     rtksw_api_ret_t retVal;
     rtksw_uint32    pmask;
     ...
     if ((retVal = rtl8367c_getAsicVlanEgressKeep(rtksw_switch_port_L2P_get(egr_port), &pmask)) != RT_ERR_OK)
         return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_stg_set(rtksw_vlan_t vid, rtksw_stp_msti_id_t stg)
{
    rtksw_api_ret_t retVal;
    rtl8367c_user_vlan4kentry vlan4K;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_stg_get(rtksw_vlan_t vid, rtksw_stp_msti_id_t *pStg)
{
    rtksw_api_ret_t retVal;
    rtl8367c_user_vlan4kentry vlan4K;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portFid_set(rtksw_port_t port, rtksw_enable_t enable, rtksw_fid_t fid)
{
    rtksw_api_ret_t retVal;
    ...
    /* fid must be 0~4095 */
    if (fid > RTKSW_FID_MAX)
        return RT_ERR_L2_FID;

    if ((retVal = rtl8367c_setAsicPortBasedFidEn(rtksw_switch_port_L2P_get(port), enable))!=RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicPortBasedFid(rtksw_switch_port_L2P_get(port), fid))!=RT_ERR_OK)
        return retVal;
 ...
 *      packets will be assigned to the port-based fid regardless vlan tag.
 */
rtksw_api_ret_t dal_rtl8367c_vlan_portFid_get(rtksw_port_t port, rtksw_enable_t *pEnable, rtksw_fid_t *pFid)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortBasedFidEn(rtksw_switch_port_L2P_get(port), pEnable))!=RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_getAsicPortBasedFid(rtksw_switch_port_L2P_get(port), pFid))!=RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_UntagDscpPriorityEnable_set
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_UntagDscpPriorityEnable_set(rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicVlanUntagDscpPriorityEn((rtksw_uint32)enable)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_UntagDscpPriorityEnable_get(rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32  value;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_stp_mstpState_set(rtksw_stp_msti_id_t msti, rtksw_port_t port, rtksw_stp_state_t stp_state)
{
    rtksw_api_ret_t retVal;
    ...
    if (msti > RTKSW_MAX_NUM_OF_MSTI)
        return RT_ERR_MSTI;

    if (stp_state >= STP_STATE_END)
        return RT_ERR_MSTP_STATE;

    if ((retVal = rtl8367c_setAsicSpanningTreeStatus(rtksw_switch_port_L2P_get(port), msti, stp_state)) != RT_ERR_OK)
        return retVal;
 ...
 *      - STP_STATE_FORWARDING
 */
rtksw_api_ret_t dal_rtl8367c_stp_mstpState_get(rtksw_stp_msti_id_t msti, rtksw_port_t port, rtksw_stp_state_t *pStp_state)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicSpanningTreeStatus(rtksw_switch_port_L2P_get(port), msti, pStp_state)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_reservedVidAction_set
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_reservedVidAction_set(rtksw_vlan_resVidAction_t action_vid0, rtksw_vlan_resVidAction_t action_vid4095)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setReservedVidAction((rtksw_uint32)action_vid0, (rtksw_uint32)action_vid4095)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_reservedVidAction_get
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_reservedVidAction_get(rtksw_vlan_resVidAction_t *pAction_vid0, rtksw_vlan_resVidAction_t *pAction_vid4095)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getReservedVidAction((rtksw_uint32 *)pAction_vid0, (rtksw_uint32 *)pAction_vid4095)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_realKeepRemarkEnable_set
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_realKeepRemarkEnable_set(rtksw_enable_t enabled)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setRealKeepRemarkEn((rtksw_uint32)enabled)) != RT_ERR_OK)
        return retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_realKeepRemarkEnable_get
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_realKeepRemarkEnable_get(rtksw_enable_t *pEnabled)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getRealKeepRemarkEn((rtksw_uint32 *)pEnabled)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_reset(void)
{
    rtksw_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_vlan_checkAndCreateMbr
 * Description:
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_vlan_checkAndCreateMbr(rtksw_vlan_t vid, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
    rtl8367c_user_vlan4kentry vlan4K;
    rtl8367c_vlanconfiguser vlanMC;
