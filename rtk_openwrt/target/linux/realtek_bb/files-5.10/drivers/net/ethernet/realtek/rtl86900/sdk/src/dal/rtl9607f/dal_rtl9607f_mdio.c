...
dal_rtl9607f_mdio_init(void)
{
    ...
    if((ret = dal_rtl9607f_mdio_cfg_set(SET,PORT,PHYID,FMT))!= RT_ERR_OK)
    {
...
dal_rtl9607f_mdio_cfg_set(uint8 set,uint8 port,uint8 phyid,rtk_mdio_format_t fmt)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_mdio_cfg_set */
...
dal_rtl9607f_mdio_cfg_get(uint8 *set,uint8 *port,uint8 *phyid,rtk_mdio_format_t *fmt)
{
    ...
    *fmt = FMT;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_mdio_cfg_get */
...
dal_rtl9607f_mdio_c22_write(uint8 c22_reg,uint16 data)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_mdio_c22_write */
...
dal_rtl9607f_mdio_c22_read(uint8 c22_reg,uint16 *data)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_mdio_c22_read */
...
dal_rtl9607f_mdio_c45_write(uint8 dev,uint16 c45_reg,uint16 data)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_mdio_c45_write */
...
dal_rtl9607f_mdio_c45_read(uint8 dev,uint16 c45_reg,uint16 *data)
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9607f_mdio_c45_read */
 ...
 *      RT_ERR_FAILED
 * Note:
 *      The APIs dal_rtlrtl9607f_mdio_read/dal_rtlrtl9607f_mdio_write replace the collective APIs
