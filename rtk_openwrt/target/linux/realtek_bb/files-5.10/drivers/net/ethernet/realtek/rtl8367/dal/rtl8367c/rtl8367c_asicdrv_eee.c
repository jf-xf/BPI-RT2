...
@parm rtksw_uint32 | port | The port number.
@parm rtksw_uint32 | enabled | 1: enabled, 0: disabled.
...
*/
ret_t rtl8367c_setAsicEee100M(rtksw_uint32 port, rtksw_uint32 enable)
{
...
*/
ret_t rtl8367c_getAsicEee100M(rtksw_uint32 port, rtksw_uint32 *enable)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      regData;
    ...
    *enable = (regData & (0x0001 << 1)) ? RTKSW_ENABLED : RTKSW_DISABLED;
    return RT_ERR_OK;
}
...
*/
ret_t rtl8367c_setAsicEeeGiga(rtksw_uint32 port, rtksw_uint32 enable)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      regData;
...
@comm
    This API get the 100M EEE function.
*/
ret_t rtl8367c_getAsicEeeGiga(rtksw_uint32 port, rtksw_uint32 *enable)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      regData;
    ...
    *enable = (regData & (0x0001 << 2)) ? RTKSW_ENABLED : RTKSW_DISABLED;
    return RT_ERR_OK;
}
