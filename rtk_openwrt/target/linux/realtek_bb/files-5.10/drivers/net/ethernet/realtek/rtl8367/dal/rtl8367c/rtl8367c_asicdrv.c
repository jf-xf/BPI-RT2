 ...
 */
ret_t rtl8367c_setAsicRegBit(rtksw_uint32 reg, rtksw_uint32 bit, rtksw_uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRegBit(rtksw_uint32 reg, rtksw_uint32 bit, rtksw_uint32 *pValue)
{
 ...
 */
ret_t rtl8367c_setAsicRegBits(rtksw_uint32 reg, rtksw_uint32 bits, rtksw_uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRegBits(rtksw_uint32 reg, rtksw_uint32 bits, rtksw_uint32 *pValue)
{
 ...
 */
ret_t rtl8367c_setAsicReg(rtksw_uint32 reg, rtksw_uint32 value)
{
 ...
 */
ret_t rtl8367c_getAsicReg(rtksw_uint32 reg, rtksw_uint32 *pValue)
{
