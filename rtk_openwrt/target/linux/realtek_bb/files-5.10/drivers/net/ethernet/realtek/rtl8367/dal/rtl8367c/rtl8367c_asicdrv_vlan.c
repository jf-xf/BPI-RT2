...
static void _rtl8367c_VlanMCStUser2Smi(rtl8367c_vlanconfiguser *pVlanCg, rtksw_uint16 *pSmiVlanCfg)
{
...
static void _rtl8367c_VlanMCStSmi2User(rtksw_uint16 *pSmiVlanCfg, rtl8367c_vlanconfiguser *pVlanCg)
{
...
static void _rtl8367c_Vlan4kStUser2Smi(rtl8367c_user_vlan4kentry *pUserVlan4kEntry, rtksw_uint16 *pSmiVlan4kEntry)
{
...
static void _rtl8367c_Vlan4kStSmi2User(rtksw_uint16 *pSmiVlan4kEntry, rtl8367c_user_vlan4kentry *pUserVlan4kEntry)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanMemberConfig(rtksw_uint32 index, rtl8367c_vlanconfiguser *pVlanCg)
{
    ret_t  retVal;
    ...
    rtksw_uint16 smi_vlancfg[RTL8367C_VLAN_MBRCFG_LEN];
    ...
    memset(smi_vlancfg, 0x00, sizeof(rtksw_uint16) * RTL8367C_VLAN_MBRCFG_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanMemberConfig(rtksw_uint32 index, rtl8367c_vlanconfiguser *pVlanCg)
{
    ret_t  retVal;
    rtksw_uint32 page_idx;
    rtksw_uint32 regAddr;
    ...
    for(page_idx = 0; page_idx < 4; page_idx++)  /* 4 pages per VLAN Member Config */
    {
        ...
        *tableAddr = (rtksw_uint16)regData;
        tableAddr++;
    }
...
{
    rtksw_uint16              vlan_4k_entry[RTL8367C_VLAN_4KTABLE_LEN];
    rtksw_uint32                  page_idx;
    rtksw_uint16                  *tableAddr;
    ret_t                   retVal;
    rtksw_uint32                  regData;
    ...
    memset(vlan_4k_entry, 0x00, sizeof(rtksw_uint16) * RTL8367C_VLAN_4KTABLE_LEN);
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanAccpetFrameType(rtksw_uint32 port, rtl8367c_accframetype frameType)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanAccpetFrameType(rtksw_uint32 port, rtl8367c_accframetype *pFrameType)
{
    rtksw_uint32 regData;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanIngressFilter(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanIngressFilter(rtksw_uint32 port, rtksw_uint32 *pEnable)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanEgressTagMode(rtksw_uint32 port, rtl8367c_egtagmode tagMode)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanEgressTagMode(rtksw_uint32 port, rtl8367c_egtagmode *pTagMode)
{
    rtksw_uint32 regData;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanPortBasedVID(rtksw_uint32 port, rtksw_uint32 index, rtksw_uint32 pri)
{
    rtksw_uint32 regAddr, bit_mask;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanPortBasedVID(rtksw_uint32 port, rtksw_uint32 *pIndex, rtksw_uint32 *pPri)
{
    rtksw_uint32 regAddr,bit_mask;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanProtocolBasedGroupData(rtksw_uint32 index, rtl8367c_protocolgdatacfg *pPbCfg)
{
    rtksw_uint32  frameType;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanProtocolBasedGroupData(rtksw_uint32 index, rtl8367c_protocolgdatacfg *pPbCfg)
{
    rtksw_uint32  frameType;
    rtksw_uint32  etherType;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanPortAndProtocolBased(rtksw_uint32 port, rtksw_uint32 index, rtl8367c_protocolvlancfg *pPpbCfg)
{
    rtksw_uint32  reg_addr, bit_mask, bit_value;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanPortAndProtocolBased(rtksw_uint32 port, rtksw_uint32 index, rtl8367c_protocolvlancfg *pPpbCfg)
{
    rtksw_uint32  reg_addr, bit_mask, bit_value;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanFilter(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanFilter(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanUntagDscpPriorityEn(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanUntagDscpPriorityEn(rtksw_uint32* enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBasedFid(rtksw_uint32 port, rtksw_uint32 fid)
{
    rtksw_uint32  reg_addr;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBasedFid(rtksw_uint32 port, rtksw_uint32* pFid)
{
    rtksw_uint32  reg_addr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBasedFidEn(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBasedFidEn(rtksw_uint32 port, rtksw_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSpanningTreeStatus(rtksw_uint32 port, rtksw_uint32 msti, rtksw_uint32 state)
{
    rtksw_uint32  reg_addr,bits_msk;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSpanningTreeStatus(rtksw_uint32 port, rtksw_uint32 msti, rtksw_uint32* pState)
{
    rtksw_uint32  reg_addr,bits_msk;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanTransparent(rtksw_uint32 port, rtksw_uint32 portmask)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanTransparent(rtksw_uint32 port, rtksw_uint32 *pPortmask)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanEgressKeep(rtksw_uint32 port, rtksw_uint32 portmask)
{
    rtksw_uint32 regAddr, bit_mask;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanEgressKeep(rtksw_uint32 port, rtksw_uint32* pPortmask)
{
    rtksw_uint32 regAddr, bit_mask, regval_l, regval_h;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setReservedVidAction(rtksw_uint32 vid0Action, rtksw_uint32 vid4095Action)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getReservedVidAction(rtksw_uint32 *pVid0Action, rtksw_uint32 *pVid4095Action)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setRealKeepRemarkEn(rtksw_uint32 enabled)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getRealKeepRemarkEn(rtksw_uint32 *pEnabled)
{
    ret_t   retVal;
