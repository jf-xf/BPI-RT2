...
return view.extend({
	...
	render: function(stats) {
		...
		m = new form.Map('samba', _('Network Shares'));
		...
		o.cfgvalue = function(section_id) {
			return L.toArray(uci.get('samba', section_id, 'interface'));
		};
		o.write = function(section_id, formvalue) {
			...
			if (oldNetworks.join(' ') == newNetworks.join(' '))
				return;
			return uci.set('samba', section_id, 'interface', newNetworks.join(' '));
		};
		...
		*/
		...
		o = s.option(form.Value, 'description', _('Server String'));
