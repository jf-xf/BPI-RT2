...
var callInitAction, callUpnpGetStatus, callUpnpDeleteRule, handleDelRule, callNetworkDevices;
...
return view.extend({		
	...
	render: function(data) {
		...
		o = s.option(form.Flag, 'enabled', _('Start UPnP and NAT-PMP Service'));
		o.rmempty  = false;

		o = s.option(rtkwidgets.NetworkSelect, 'external_iface', _('Interface'));
		o.valueType="IPv4";
		o.ipmodefilter="IPv4";
		o.ignoreBridge=1;
		o.nocreate=true;
...
/*
		o = s.option(form.ListValue, 'external_iface', _('Interface'), _(''));
		o.rmempty = false;
