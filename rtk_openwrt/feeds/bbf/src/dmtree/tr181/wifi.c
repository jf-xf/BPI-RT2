...
static int get_linker_AC(char *refparam, struct dmctx *dmctx, void *data, char *instance, char **linker)
{
	*linker = data ? dmjson_get_value((json_object *)data, 1, "AccessCategory") : "";
	return 0;
}
...
static int browse_wifi_AC(struct dmctx *dmctx, DMNODE *parent_node, void *prev_data, char *prev_instance)
{
	struct ap_ac_data_args ac_args={0};
	json_object *res = NULL, *statusobj = NULL, *arrobj = NULL;
	json_object *res2 = NULL, *statsobj = NULL, *arr2obj = NULL;
	char object[32], *inst = NULL;
	int id = 0, i = 0, j = 0;

	snprintf(object, sizeof(object), "wifi.ap.%s", ((struct wifi_acp_args *)prev_data)->ifname);
	dmubus_call(object, "status", UBUS_ARGS{0}, 0, &res);
	dmjson_foreach_obj_in_array(res, arrobj, statusobj, i, 1, "wmm_params") {
		ac_args.status_obj=statusobj;
		ac_args.stats_obj=NULL;
		dmubus_call(object, "stats", UBUS_ARGS{0}, 0, &res2);
		dmjson_foreach_obj_in_array(res2, arr2obj, statsobj, j, 1, "wmm_stats") {
			if (DM_STRCMP(dmjson_get_value(statusobj, 1, "ac"), dmjson_get_value(statsobj, 1, "ac")) != 0){
				ac_args.stats_obj=statsobj;
				break;
			}
		}
		inst = handle_instance_without_section(dmctx, parent_node, ++id);
		if (DM_LINK_INST_OBJ(dmctx, parent_node, (void *)&ac_args, inst) == DM_STOP)
			return 0;
	}
	return 0;
}
...
static int set_access_point_security_shared_key(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
	...
	switch (action) {
		...
		case VALUESET:
			...
			// psk for wpa/wpa2
			// sae for wpa3
			if (DM_LSTRSTR(encryption, "psk") || DM_LSTRSTR(encryption, "sae")) {
...
/*#Device.WiFi.AccessPoint.{i}.AC.{i}.AccessCategory!UBUS:wifi.ap.@Name/wmm_params[i-1].ac*/
static int get_WiFiAccessPointAC_AccessCategory(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->status_obj, 1, "ac");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.Alias!UBUS:wifi.ap.@Name/wmm_params[i-1].alias*/
static int get_WiFiAccessPointAC_Alias(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->status_obj, 1, "alais");
	if ((*value)[0] == '\0')
		dmasprintf(value, "cpe-%s", instance);
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.AIFSN!UBUS:wifi.ap.@Name/wmm_params[i-1].aifsn*/
static int get_WiFiAccessPointAC_AIFSN(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->status_obj, 1, "aifsn");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.ECWMin!UBUS:wifi.ap.@Name/wmm_params[i-1].cwmin*/
static int get_WiFiAccessPointAC_ECWMin(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->status_obj, 1, "cwmin");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.ECWMax!UBUS:wifi.ap.@Name/wmm_params[i-1].cwmax*/
static int get_WiFiAccessPointAC_ECWMax(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->status_obj, 1, "cwmax");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.TxOpMax!UBUS:wifi.ap.@Name/wmm_params[i-1].TxOpMax*/
static int get_WiFiAccessPointAC_TxOpMax(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->status_obj, 1, "txop");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.BytesSent!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].tx_bytes*/
static int get_WiFiAPACStats_BytesSent(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "tx_bytes");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.BytesReceived!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].rx_bytes*/
static int get_WiFiAPACStats_BytesReceived(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "rx_bytes");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.PacketsSent!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].tx_packets*/
static int get_WiFiAPACStats_PacketsSent(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "tx_packets");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.PacketsReceived!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].rx_packets*/
static int get_WiFiAPACStats_PacketsReceived(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "rx_packets");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.ErrorsSent!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].tx_error_packets*/
static int get_WiFiAPACStats_ErrorsSent(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "tx_error_packets");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.ErrorsReceived!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].rx_error_packets*/
static int get_WiFiAPACStats_ErrorsReceived(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "rx_error_packets");
	return 0;
}

/*#Device.WiFi.AccessPoint.{i}.AC.{i}.stats.RetransCount!UBUS:wifi.ap.@Name/stats/wmm_stats[i-1].tx_retrans_packets*/
static int get_WiFiAPACStats_RetransCount(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value)
{
	*value = dmjson_get_value(((struct ap_ac_data_args *)data)->stats_obj, 1, "tx_retrans_packets");
	return 0;
}
...
{"AC", &DMREAD, NULL, NULL, NULL, browse_wifi_AC, NULL, NULL, tWiFiAccessPointACObj, tWiFiAccessPointACParams, get_linker_AC, BBFDM_BOTH, LIST_KEY{"AccessCategory", NULL}, "2.0"},
...
DMOBJ tWiFiAccessPointACObj[] = {
/* OBJ, permission, addobj, delobj, checkdep, browseinstobj, nextdynamicobj, dynamicleaf, nextobj, leaf, linker, bbfdm_type, uniqueKeys, version*/
{"Stats", &DMREAD, NULL, NULL, NULL, NULL, NULL, NULL, NULL, tWiFiAccessPointACStatsParams, NULL, BBFDM_BOTH, NULL, "2.8"},
{0}
};

DMLEAF tWiFiAccessPointACParams[] = {
/* PARAM, permission, type, getvalue, setvalue, bbfdm_type, version*/
{"AccessCategory", &DMREAD, DMT_STRING, get_WiFiAccessPointAC_AccessCategory, NULL, BBFDM_BOTH, "2.12"},
{"Alias", &DMWRITE, DMT_STRING, get_WiFiAccessPointAC_Alias, NULL/*set_WiFiAccessPointAC_Alias*/, BBFDM_BOTH, "2.0"},
{"AIFSN", &DMWRITE, DMT_UNINT, get_WiFiAccessPointAC_AIFSN, NULL/*set_WiFiAccessPointAC_AIFSN*/, BBFDM_BOTH, "2.12"},
{"ECWMin", &DMWRITE, DMT_UNINT, get_WiFiAccessPointAC_ECWMin, NULL/*set_WiFiAccessPointAC_ECWMin*/, BBFDM_BOTH, "2.12"},
{"ECWMax", &DMWRITE, DMT_UNINT, get_WiFiAccessPointAC_ECWMax, NULL/*set_WiFiAccessPointAC_ECWMax*/, BBFDM_BOTH, "2.12"},
{"TxOpMax", &DMWRITE, DMT_UNINT, get_WiFiAccessPointAC_TxOpMax, NULL/*set_WiFiAccessPointAC_TxOpMax*/, BBFDM_BOTH, "2.12"},
{0}
};

/* *** Device.WiFi.AccessPoint.{i}.AC.{i}.stats *** */
DMLEAF tWiFiAccessPointACStatsParams[] = {
/* PARAM, permission, type, getvalue, setvalue, bbfdm_type, version*/
{"BytesSent", &DMREAD, DMT_UNLONG, get_WiFiAPACStats_BytesSent, NULL, BBFDM_BOTH, "2.0"},
{"BytesReceived", &DMREAD, DMT_UNLONG, get_WiFiAPACStats_BytesReceived, NULL, BBFDM_BOTH, "2.0"},
{"PacketsSent", &DMREAD, DMT_UNLONG, get_WiFiAPACStats_PacketsSent, NULL, BBFDM_BOTH, "2.0"},
{"PacketsReceived", &DMREAD, DMT_UNLONG, get_WiFiAPACStats_PacketsReceived, NULL, BBFDM_BOTH, "2.0"},
{"ErrorsSent", &DMREAD, DMT_UNINT, get_WiFiAPACStats_ErrorsSent, NULL, BBFDM_BOTH, "2.0"},
{"ErrorsReceived", &DMREAD, DMT_UNINT, get_WiFiAPACStats_ErrorsReceived, NULL, BBFDM_BOTH, "2.0"},
{"RetransCount", &DMREAD, DMT_UNINT, get_WiFiAPACStats_RetransCount, NULL, BBFDM_BOTH, "2.0"},
{0}
};
