...
/* Octoscope Test Refine */
#define CONFIG_OCTOSCOPE_REFINE

//#define WKARD_CHANGESELF_STA_AMSDU_LEN
...
#define CONFIG_DL_SW_GRP

/* === Green channel =========== */
#define CONFIG_GREEN_CHANNEL_FOR_LATENCY_STA
...
#define RTW_STA_ALLOC_FREE_SAFE
...
//#define RTW_MAP_BACKHAUL_A4_EAPOL	/* Send 4-address EAP packet between backhaul AP and backhaul STA  */
#endif
...
#ifdef RTK_WLAN_EVENT_INDICATE_GENL
#ifndef WLAN_INFO_LEN
#define WLAN_INFO_LEN		2048
#endif
#endif
...
/* WFO specific config */
#ifdef PLATFORM_ECOS
/* We don't need this in eCos */
#ifdef RTW_TX_CPU_BALANCE
#undef RTW_TX_CPU_BALANCE
#endif

#ifdef RTW_RX_CPU_BALANCE
#undef RTW_RX_CPU_BALANCE
#endif

#ifdef CPU_ID_TX_CORE
#undef CPU_ID_TX_CORE
#endif

#ifdef CPU_ID_RX_CORE
#undef CPU_ID_RX_CORE
#endif

#ifdef CPU_ID_RX_REFILL
#undef CPU_ID_RX_REFILL
#endif
...
#ifdef CPU_ID_RX_RECYCLE
#undef CPU_ID_RX_RECYCLE
#endif

#ifdef CPU_ID_NETIF_RX
#undef CPU_ID_NETIF_RX
#endif

#ifdef CONFIG_SMP_NETIF_RX
#undef CONFIG_SMP_NETIF_RX
#endif

//#ifdef CONFIG_BW160M_EXTREME_THROUGHPUT_TX
//#undef CONFIG_BW160M_EXTREME_THROUGHPUT_TX
//#endif

#ifdef CONFIG_TX_DEFER
#undef CONFIG_TX_DEFER
#endif
...
#ifdef RTW_VW_TXAMSDU_ENHANCE
#undef RTW_VW_TXAMSDU_ENHANCE
#endif

#ifdef CONFIG_CPU_PROFILING
#undef CONFIG_CPU_PROFILING
#endif

#ifdef RTW_WKARD_APSEC_MAXTXTP
#undef RTW_WKARD_APSEC_MAXTXTP
#endif

#ifdef RTW_WKARD_REFINE_DBCC_TXTP
#undef RTW_WKARD_REFINE_DBCC_TXTP
#endif

#ifdef STA_BWC_NUM_TXPKT_QUEUE
#undef STA_BWC_NUM_TXPKT_QUEUE
#endif

#ifdef CONFIG_ETHER_PKT_AGG
#undef CONFIG_ETHER_PKT_AGG
#endif

#ifdef CONFIG_RTW_DBG_TX_MGNT
#undef CONFIG_RTW_DBG_TX_MGNT
#endif

/* eCos specific config */
#define CONFIG_TXSC_ONE_LOCK // for CPU loading in Single CPU
#define  CORE_RX_PRIO_HIGH 1

#ifdef MAX_RX_BD_NUM_RXQ_0_CORE
#undef MAX_RX_BD_NUM_RXQ_0_CORE
#endif
#define MAX_RX_BD_NUM_RXQ_0_CORE	(256)

#ifdef MAX_RX_BUF_NUM_RXQ_0_CORE
#undef MAX_RX_BUF_NUM_RXQ_0_CORE
#endif
#define MAX_RX_BUF_NUM_RXQ_0_CORE	(MAX_RX_BD_NUM_RXQ_0_CORE * 3)

#ifdef MAX_RX_BD_NUM_RXQ_1_CORE
#undef MAX_RX_BD_NUM_RXQ_1_CORE
#endif
#define MAX_RX_BD_NUM_RXQ_1_CORE	(256)
