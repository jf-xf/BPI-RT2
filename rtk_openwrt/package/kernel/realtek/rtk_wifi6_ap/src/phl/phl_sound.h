...
#define MAX_BW_SU_SND_NUM 4
#define MAX_SND_MU_STA_NUM 6
...
void
_phl_snd_get_available_f2p_idx(struct phl_info_t *phl_info, struct phl_snd_grp *grp);

void
_phl_snd_remove_f2p_idx(struct phl_info_t *phl_info, struct rtw_phl_stainfo_t *psta);
