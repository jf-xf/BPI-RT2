...
enum rfk_tri_type {
	...
	RFK_TYPE_CONNECT,
	/* INIT related */
	RFK_TYPE_PLATFORM_INIT,
	/* ECSA related */
	RFK_TYPE_ECSA,
	/* change OP related */
	RFK_TYPE_CHG_OP,
	/* MP related */
	RFK_TYPE_MP_SET_CHBW,
	RFK_TYPE_MAX
};
...
struct rtw_grp_info {
	...
	u8 is_dlru_sta;
	u16 tx_cap_grp_idx; /* 0~127, bit 0~1:BW ; bit 2:stbc_he_rx ; bit 3~4:rate ; bit 5~6:iface_id */
	u8 tx_grp_idx;/* 0~254: grp idx, 255: No grp */

	u8 is_ulru_sta;
	u16 rx_cap_grp_idx;	/* 0~255, bit 0~1:BW ; bit 2:stbc_he_rx ; bit 3~4:rate ; bit 5~6:iface_id ; bit 7:latency*/
...
enum phl_msg_evt_id {
	...
	MSG_EVT_SER_PRE_M0_PREPARE = 42,
	MSG_EVT_SER_M1_PAUSE_TRX = 43,
	MSG_EVT_SER_IO_TIMER_EXPIRE = 44,
	MSG_EVT_SER_FW_TIMER_EXPIRE = 45,
	MSG_EVT_SER_M3_DO_RECOV = 46,
	MSG_EVT_SER_M5_READY = 47,
	MSG_EVT_SER_M9_L2_RESET = 48,
	MSG_EVT_SER_EVENT_CHK = 49,
	MSG_EVT_SER_POLLING_CHK = 50,
	MSG_EVT_ECSA_START = 51,
	MSG_EVT_ECSA_UPDATE_FIRST_BCN_DONE = 52,
	MSG_EVT_ECSA_COUNT_DOWN = 53,
	MSG_EVT_ECSA_SWITCH_START = 54,
	MSG_EVT_ECSA_SWITCH_DONE = 55,
	MSG_EVT_ECSA_CHECK_TX_RESUME = 56,
	MSG_EVT_ECSA_DONE = 57,
	MSG_EVT_LISTEN_STATE_EXPIRE = 58,
	/* beamform */
	MSG_EVT_SET_VHT_GID = 59,
	MSG_EVT_WATCHDOG = 60,
	MSG_EVT_DEV_CANNOT_IO = 61,
	MSG_EVT_DEV_RESUME_IO = 62,
	MSG_EVT_FORCE_USB_SW = 63,
	MSG_EVT_GET_USB_SPEED = 64,
	MSG_EVT_GET_USB_SW_ABILITY = 65,
	MSG_EVT_CFG_AMPDU = 66,
	MSG_EVT_DFS_PAUSE_TX = 67,
	MSG_EVT_ROLE_RECOVER = 68,
	MSG_EVT_ROLE_SUSPEND = 69,
	MSG_EVT_HAL_SET_L2_LEAVE = 70,
	MSG_EVT_NOTIFY_HAL = 71,
	MSG_EVT_ISSUE_BCN = 72,
	MSG_EVT_FREE_BCN = 73,
	MSG_EVT_STOP_BCN = 74,
	MSG_EVT_SEC_KEY = 75,
	MSG_EVT_ROLE_START = 76,
	MSG_EVT_ROLE_CHANGE = 77,
	MSG_EVT_ROLE_STOP = 78,
	MSG_EVT_STA_INFO_CTRL = 79,
	MSG_EVT_STA_MEDIA_STATUS_UPT = 80,
	MSG_EVT_CFG_CHINFO = 81,
	MSG_EVT_STA_CHG_STAINFO = 82,
	MSG_EVT_HW_TRX_RST_RESUME = 83,
	MSG_EVT_HW_TRX_PAUSE = 84,
	MSG_EVT_SW_TX_RESUME = 85,
	MSG_EVT_SW_RX_RESUME = 86,
	MSG_EVT_SW_TX_PAUSE = 87,
	MSG_EVT_SW_RX_PAUSE = 88,
	MSG_EVT_SW_TX_RESET = 89,
	MSG_EVT_SW_RX_RESET = 90,
	MSG_EVT_TRX_SW_PAUSE = 91,
	MSG_EVT_TRX_SW_RESUME = 92,
	MSG_EVT_TRX_PAUSE_W_RST = 93,
	MSG_EVT_TRX_RESUME_W_RST = 94,
	/* Regulation*/
	MSG_EVT_REGU_SET_DOMAIN = 95,
	MSG_EVT_RF_ON = 96,
	MSG_EVT_RF_OFF = 97,
	MSG_EVT_WPS_PRESSED = 98,
	MSG_EVT_WPS_RELEASED = 99,
	MSG_EVT_SURPRISE_REMOVE = 100,
	MSG_EVT_DATA_PATH_START = 101,
	MSG_EVT_DATA_PATH_STOP = 102,
	MSG_EVT_TRX_PWR_REQ = 103,
	/* tdls */
	MSG_EVT_TDLS_SYNC = 104,
	/* beamformee */
	MSG_EVT_SET_BFEE_AID = 105,
	/* ccx */
	MSG_EVT_CCX_REPORT_TX_OK = 106,
	MSG_EVT_CCX_REPORT_TX_FAIL = 107,

	/* bfer sounding */
	MSG_EVT_BFER_SOUND = 108,

	/* MRC DBCC */
	MSG_EVT_DBCC_PROTOCOL_HDL = 109,
	MSG_EVT_DBCC_ENABLE = 110,
	MSG_EVT_DBCC_DISABLE = 111,

	/* PS */
	MSG_EVT_PS_CAP_CHG = 112,
	MSG_EVT_PS_PERIOD_CHK = 113,
	...
	/* tx pwr limit config*/
	MSG_EVT_SET_PWR_LIMIT_STD = 500,
	MSG_EVT_SET_PWR_LIMIT_LOW = 501,
	MSG_EVT_SET_PWR_LIMIT_VLOW = 502,
...
struct dev_cap_t {
	...
	struct rtw_wcpu_cap_t wcpu_cap;
	u8 hw_hdr_conv;
	u8 domain;
	u8 btc_mode;
...
struct rtw_stats {
	...
	u64 ser_event[10]; /* RTW_PHL_SER_MAX */
	...
	u32 HE_rx_cnt[4];
	u16 average_HE_rx_rate_new;
	u16 average_HE_rx_rate_last;
...
struct rtw_phl_stainfo_t {
	...
	u16 macid;
	u8 mac_addr[MAC_ALEN];
	ATOMIC_T wd_stbc_cnt;
	struct rtw_chan_def chandef;
	struct rtw_stats stats;
	ATOMIC_T already_inform_txbf_to_fw;
	...
	_os_atomic cur_dma_wd[6]; //ACH0~ACH3 ACH8, ACH9

	u32 current_wd_record;
	u32 pending_wd_record;
	u16 cur_dma_wd_record[6];
...
enum dfs_regd_t { /* sync with rtw_dfs_regd */
	DFS_REGD_UNKNOWN	= 0,
	DFS_REGD_FCC	= 1,
	DFS_REGD_JAP	= 2,
	DFS_REGD_ETSI	= 3,
...
struct rtw_dfs_t {
	...
	*/
	...
	bool is_radar_detected; /* if radar is detected */
};
#endif
...
struct ru_common_ctrl
{
	...
	*/
	...
	u8 UL_mode;	/* BIT0(1): UL trigger; BIT1(2): DL RU for TCP ack */
	u8 rsp_type;
	u8 prot_type;
	u8 DL_mode; /*(BIT0(1): SU-BA; BIT1(2): use trigger)*/
	u8 trigger_THRD;
	u8 trigger_len;
	u8 force_sumuru_en;
	u8 forceru;
...
struct rtw_phl_com_t {
	...
	#ifdef CONFIG_WFA_OFDMA_Logo_Test
	struct ru_grp_table	rugrptable[MAX_WIFI_ROLE_NUMBER];
	u8 tx_phase;
	u32 phl_wd_quota;
	#endif
 ...
 * @en_stbc: report by RA, 0: don't tx stbc; 1: could tx stbc
 */
...
struct rtw_phl_mac_ss_ul_grp_upd {
	u8 macid_u0;
	u8 macid_u1;
	u16 grp_bitmap;
};
...
#if defined(CONFIG_RTW_RECORD_STA_CSI)
//copy from halbb start
enum phl_ch_info_state_type {
	PHL_CH_RPT_START_TO_WAIT = 0,
	PHL_CH_RPT_GETTED = 1
};
...
enum phl_physts_bitmap_t {
	PHL_TD_SEARCH_FAIL	= 0,
	PHL_BRK_BY_TX_PKT	= 1,
	PHL_CCA_SPOOF	= 2,
	PHL_OFDM_BRK	= 3,
	PHL_CCK_BRK		= 4,
	PHL_DL_MU_SPOOFING	= 5,
	PHL_HE_MU		= 6,
	PHL_VHT_MU		= 7,
	PHL_UL_TB_SPOOFING	= 8,
	PHL_RSVD_9		= 9,
	PHL_TRIG_BASE_PPDU	= 10,
	PHL_CCK_PKT		= 11,
	PHL_LEGACY_OFDM_PKT = 12,
	PHL_HT_PKT		= 13,
	PHL_VHT_PKT		= 14,
	PHL_HE_PKT		= 15,
	PHL_PHYSTS_BITMAP_NUM
};

struct chinfo_cr_cfg{
	...
	bool	ch_i_type; /*0~1: Legacy-CH, MIMO-CH*/
