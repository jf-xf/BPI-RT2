...
void rtw_phl_set_vow_vi_lowest_thr(void *phl, u32 value);
u8 rtw_phl_get_vow_vi_lowest_thr(void *phl) ;
#endif
...
rtw_phl_ru_query_ulru_tbl_res(void *phl,
			      struct rtw_phl_stainfo_t *psta,
			      enum rtw_phl_ru_tbl_type type, u8 latency,
			      bool init_tbl,
			      struct rtw_phl_ulru_tbl **tbl);
...
rtw_phl_mac_set_ul_grp_info(void *phl,
					struct rtw_phl_mac_ss_ul_grp_upd *info);
...
enum rtw_phl_status rtw_phl_check_bf_mu_entry(void *phl, struct rtw_phl_stainfo_t *phl_sta);
...
void rtw_phl_set_manual_giltf(void *phl, struct rtw_phl_stainfo_t *phl_sta, u8 ax_sgi);

#ifdef CONFIG_24G_256QAM
void rtw_phl_ra_update(void *phl, struct rtw_phl_stainfo_t *phl_sta);
#endif

enum rtw_phl_status rtw_phl_bb_ra_stbc_status(void *phl, struct rtw_phl_stainfo_t *phl_sta);

#ifdef CONFIG_GREEN_CHANNEL_FOR_LATENCY_STA
u8 rtw_phl_set_fw_latency_flow_ctrl(void *phl, u16 macid, u8 en, u32 max_int);
#endif
u8 rtw_phl_get_xtxr(void *phl_in);

enum rtw_phl_status
rtw_phl_mac_sifs_chk_cca_en(void *phl, struct rtw_wifi_role_t *wrole, u8 en);

enum rtw_phl_status
rtw_phl_mac_resp_chk_cca(void *phl, struct rtw_wifi_role_t *wrole, u8 en);
