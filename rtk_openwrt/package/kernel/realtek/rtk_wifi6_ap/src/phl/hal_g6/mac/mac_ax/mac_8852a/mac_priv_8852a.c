...
static struct mac_ax_priv_ops mac8852a_priv_ops = {
	...
	get_fw_cap_8852a, /*get fw capability*/
	dump_fw_cap_8852a, /*dump fw capability*/
#if MAC_AX_PCIE_SUPPORT
	...
	ltr_dyn_ctrl_8852a, /* ltr_dyn_ctrl */
...
#endif
	get_pcie_support_width_8852a, /* get_pcie_support_width */
	get_pcie_link_width_8852a, /* get_pcie_link_width */
	set_pcie_link_width_8852a, /* set_pcie_link_width */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_usb2phy_para_8852a, /* read_usb2phy_para */
	write_usb2phy_para_8852a, /* write_usb2phy_para */
	read_usb3phy_para_8852a, /* read_usb3phy_para */
	write_usb3phy_para_8852a, /* write_usb3phy_para */
#endif
	get_wake_reason_8852a, /* get_wake_reason */
};
