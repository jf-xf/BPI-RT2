...
// AP SELF_DIAG_DEFINE
#define COMMON_WARN_PKT_ERR_RATE                BIT(0)
#define COMMON_WARN_SS2FRPT_INTVL               BIT(1)
#define COMMON_WARN_DL_SS2FRPT_EMPTY            BIT(2)
#define COMMON_WARN_UL_SS2FRPT_EMPTY            BIT(3)
#define COMMON_WARN_RTS_ABORT_CNT               BIT(4)
#define COMMON_WARN_PRI_U_FAIL_CNT              BIT(5)
#define COMMON_WARN_CCA_ABORT_CNT               BIT(6)
#define COMMON_WARN_HW_MU2SU_CNT                BIT(7)
#define COMMON_WARN_HW_RU2SU_CNT                BIT(8)
#define COMMON_WARN_PRI_STA_NOT_VLD_CNT         BIT(9)

#define COMMON_ERR_SW_TX_MODE_SETTING           BIT(0)
#define COMMON_ERR_SS2FRPT_QUERY_STUCK          BIT(1)
#define COMMON_ERR_NOT_ISSUE_ANY_TXCMD          BIT(2)
#define COMMON_ERR_TXCMD_FULL_HAPPEND           BIT(3)
