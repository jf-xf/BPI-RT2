...
u8
hal_get_sta_mu_entry_idx(void *hal, struct rtw_phl_stainfo_t *sta);
...
enum rtw_hal_status
rtw_hal_set_beacon_ignore_edcca(void *hal, struct rtw_wifi_role_t *wrole, u8 enable);
...
enum rtw_hal_status
rtw_hal_mac_set_fw_flow_ctrl(void *hal, u16 macid, u8 en, u32 max_int);
#endif

enum rtw_hal_status
rtw_hal_check_bf_mu_entry(void *hal, void *bf_entry);

enum rtw_hal_status
rtw_hal_bb_ra_stbc_status(void *hal,
				struct rtw_phl_stainfo_t *sta);
