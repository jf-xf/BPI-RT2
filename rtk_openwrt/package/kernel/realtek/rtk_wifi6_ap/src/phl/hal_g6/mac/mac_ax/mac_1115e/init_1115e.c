...
static struct mac_ax_intf_ops mac1115e_pcie_ops = {
	...
	set_pcie_speed_1115e, /*set_pcie_speed*/
	get_pcie_speed_1115e, /*get_pcie_speed*/
	get_pcie_sup_speed_1115e, /*get_pcie_sup_speed*/
...
static struct mac_ax_ops mac1115e_ops = {
	...
	mac_chk_l1_rvy_status, /* chk_ser_status */
	NULL,
...
struct mac_ax_drv_info mac_1115e_drv_info = {
	{{{0}, {0}, 0}}, /* cust_proc_id */
...
static struct mac_txrpt_dbg_stat mac_1115e_txrpt_dbg_stat;
#endif
...
static struct mac_ax_adapter mac_1115e_adapter = {
	...
	NULL, /* hw_info */
	{0}, /* fw_info */
	&mac_1115e_drv_info, /* drv_info */
	{{0}}, /* ser_info */
	{0}, /* efuse_param */
	{0, 0, NULL, pwr_on_seq_1115e,
	 pwr_off_seq_1115e}, /* mac_pwr_info */
	...
	{0}, /* wdt_log_en */
#ifdef MAC_TXRPT_STATISTIC
	&mac_1115e_txrpt_dbg_stat, /* txrpt_dbg_stat */
#endif
	{0, {0}, {0}}, /* sta_diag_info */
};
