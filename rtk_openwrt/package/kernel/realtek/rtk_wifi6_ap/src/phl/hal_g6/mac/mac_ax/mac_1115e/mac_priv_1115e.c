...
static struct mac_ax_priv_ops mac1115e_priv_ops = {
	...
	get_fw_cap_1115e, /*get fw capability*/
	dump_fw_cap_1115e, /*dump fw capability*/
#if MAC_AX_PCIE_SUPPORT
	...
	ltr_dyn_ctrl_1115e, /* ltr_dyn_ctrl */
...
#endif
	get_pcie_support_width_1115, /* get_pcie_support_width */
	get_pcie_link_width_1115, /* get_pcie_link_width */
	set_pcie_link_width_1115, /* set_pcie_link_width */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_usb2phy_para_1115e, /* read_usb2phy_para */
	write_usb2phy_para_1115e, /* write_usb2phy_para */
	read_usb3phy_para_1115e, /* read_usb3phy_para */
	write_usb3phy_para_1115e, /* write_usb3phy_para */
#endif
};
