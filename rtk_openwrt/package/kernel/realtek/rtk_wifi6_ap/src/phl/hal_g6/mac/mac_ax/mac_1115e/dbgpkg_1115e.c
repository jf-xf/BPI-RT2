...
u32 crit_dbg_dump_1115e(struct mac_ax_adapter *adapter)
{
	...
	if (adapter->hw_info->intf == MAC_AX_INTF_PCIE) {
		...
		/* RXDMA: [15:0], TXDMA: [31:16] */
		PLTFM_MSG_ALWAYS("R_BE_USB2_WLAN_TRX_DBG_PAR2=0x%x\n",
				 MAC_REG_R32(R_BE_USB2_WLAN_TRX_DBG_PAR2));
		/* ep9 bulk out cnt: [31:24] */
		PLTFM_MSG_ALWAYS("R_BE_USB2_WLAN_TRX_DBG_PAR6=0x%x\n",
				 MAC_REG_R32(R_BE_USB2_WLAN_TRX_DBG_PAR6));
		/* ep4 bulk in cnt: [31:24] */
		PLTFM_MSG_ALWAYS("R_BE_USB2_WLAN_TRX_DBG_PAR7=0x%x\n",
				 MAC_REG_R32(R_BE_USB2_WLAN_TRX_DBG_PAR7));
	}
