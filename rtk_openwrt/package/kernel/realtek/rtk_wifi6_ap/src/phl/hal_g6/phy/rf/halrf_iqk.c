...
#ifdef RF_8832D_SUPPORT
		case RF_RTL8832D:
			isfail = halrf_check_fwiqk_done_8832d(rf);
		break;
#endif
...
#ifdef RF_8832D_SUPPORT
		case RF_RTL8832D:
			iqk_get_ch_info_8832d(rf, phy_idx, path); 
		break;
#endif
...
#ifdef RF_8832D_SUPPORT
		case RF_RTL8832D:
			iqk_set_info_8832d(rf, phy_idx, path); 
		break;
#endif
...
#ifdef RF_8832D_SUPPORT
		case RF_RTL8832D:
			times = halrf_get_iqk_times_8832d(rf); 
		break;
#endif
...
#ifdef RF_8832CRVU_SUPPORT
		case RF_RTL8832CR_VU:				
			halrf_iqk_tx_bypass_8832crvu(rf, path);
		break;
#endif		
#ifdef RF_8832BRVT_SUPPORT
		case RF_RTL8832BR_VT:				
			halrf_iqk_tx_bypass_8832brvt(rf, path);
		break;
#endif
...
#ifdef RF_8832CRVU_SUPPORT
		case RF_RTL8832CR_VU:				
			halrf_iqk_rx_bypass_8832crvu(rf, path);
		break;
#endif		
#ifdef RF_8832BRVT_SUPPORT
		case RF_RTL8832BR_VT:				
			halrf_iqk_rx_bypass_8832brvt(rf, path);
		break;
#endif
...
#ifdef RF_8832CRVU_SUPPORT
		case RF_RTL8832CR_VU:				
			halrf_iqk_lok_bypass_8832crvu(rf, path);
		break;
#endif		
#ifdef RF_8832BRVT_SUPPORT
		case RF_RTL8832BR_VT:				
			halrf_iqk_lok_bypass_8832brvt(rf, path);
		break;
#endif
		default:
		break;
...
#ifdef RF_8832CRVU_SUPPORT
		case RF_RTL8832CR_VU:				
			halrf_nbiqk_enable_8832crvu(rf, iqk_nbiqk_en);
		break;
#endif		
#ifdef RF_8832BRVT_SUPPORT
		case RF_RTL8832BR_VT:				
			halrf_nbiqk_enable_8832brvt(rf, iqk_nbiqk_en);
		break;
#endif
		default:
		break;
...
#ifdef RF_8832CRVU_SUPPORT
		case RF_RTL8832CR_VU:				
			halrf_iqk_xym_enable_8832crvu(rf, iqk_xym_en);
		break;
#endif		
#ifdef RF_8832BRVT_SUPPORT
		case RF_RTL8832BR_VT:				
			halrf_iqk_xym_enable_8832brvt(rf, iqk_xym_en);
		break;
#endif
		default:
		break;
...
#ifdef RF_8832CRVU_SUPPORT
		case RF_RTL8832CR_VU:				
			halrf_iqk_sram_enable_8832crvu(rf, iqk_sram_en);
		break;
#endif		
#ifdef RF_8832BRVT_SUPPORT
		case RF_RTL8832BR_VT:				
			halrf_iqk_sram_enable_8832brvt(rf, iqk_sram_en);
		break;
#endif
