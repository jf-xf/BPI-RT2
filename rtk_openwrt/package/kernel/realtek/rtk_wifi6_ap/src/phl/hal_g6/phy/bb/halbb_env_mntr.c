...
bool halbb_nhm_get_result(struct bb_info *bb)
{
	...
	if (!(halbb_get_reg(bb, cr->nhm_rdy, cr->nhm_rdy_m)) || env->ccx_period == 0) {
...
halbb_clm_get_result(struct bb_info *bb)
{
	...
	if (!(halbb_get_reg(bb, cr->clm_rdy, cr->clm_rdy_m)) || env->ccx_period == 0) {
...
halbb_ifs_clm_get_result(struct bb_info *bb)
{
	...
	if (!(halbb_get_reg(bb, cr->ifs_clm_rdy, cr->ifs_clm_rdy_m)) || env->ccx_period == 0) {
...
bool halbb_fahm_get_result(struct bb_info *bb)
{
	...
	if (!(halbb_get_reg(bb, cr->fahm_rdy, cr->fahm_rdy_m)) || env->fahm_period== 0) {
...
halbb_edcca_clm_get_result(struct bb_info *bb)
{
	...
	if (!(halbb_get_reg(bb, cr->edcca_clm_rdy, cr->edcca_clm_rdy_m)) || env->ccx_period == 0) {
