...
static struct mac_ax_intf_ops mac8851e_pcie_ops = {
	...
	set_pcie_speed_8851e, /*set_pcie_speed*/
	get_pcie_speed_8851e, /*get_pcie_speed*/
	get_pcie_sup_speed_8851e, /*get_pcie_sup_speed*/
...
static struct mac_ax_ops mac8851e_ops = {
	...
	mac_dump_efuse_ofld,
	mac_efuse_ofld_map,
	mac_upd_dctl_info_v1, /* update dmac ctrl info */
...
struct mac_ax_drv_info mac_8851e_drv_info = {
	{{{0}, {0}, 0}}, /* cust_proc_id */
...
static struct mac_txrpt_dbg_stat mac_8851e_txrpt_dbg_stat;
#endif
...
static struct mac_ax_adapter mac_8851e_adapter = {
	...
	NULL, /* hw_info */
	{0}, /* fw_info */
	&mac_8851e_drv_info, /* drv_info */
	{{0}}, /* ser_info */
	{0}, /* efuse_param */
	{0, 0, NULL, pwr_on_seq_8851e,
	 pwr_off_seq_8851e}, /* mac_pwr_info */
	...
	{0}, /* wdt_log_en */
#ifdef MAC_TXRPT_STATISTIC
	&mac_8851e_txrpt_dbg_stat, /* txrpt_dbg_stat */
#endif
	{0, {0}, {0}}, /* sta_diag_info */
};
