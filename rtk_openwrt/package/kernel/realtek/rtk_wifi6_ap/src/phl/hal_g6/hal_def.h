...
struct rtw_hal_stainfo_t {
	...
	void *hw_cfg_tab;
	void *bb_sta;
	struct rtw_stbc_info stbc_info;
};
...
#define TPU_SIZE_BF		2 /*{NON_BF, BF}*/
	...
	#define HAL_COMPILE_IC_1SS
     ...
     defined(CONFIG_RTL8852B) || defined(CONFIG_RTL8852BP) || \
     defined(CONFIG_RTL8852C) || \
     defined(CONFIG_RTL8852D) || \
