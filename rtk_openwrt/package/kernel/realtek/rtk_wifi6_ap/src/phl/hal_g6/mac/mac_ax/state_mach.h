...
#define MAC_AX_FW_RESET_PRE_RECV 4
	u8 fw_rst;
...
#define MAC_AX_H2C_C2H_MON_ON 1
	u8 h2c_c2h_mon;
#define MAC_AX_AP_SELF_DIAG_H2C_DONE 0
#define MAC_AX_AP_SELF_DIAG_C2H_DONE 1
	u8 ap_self_diag_state;
	u8 ap_self_diag_check_number;
	u8 ap_self_diag_total_number;
	u8 ap_self_diag_feature[8];
	u32 ap_self_diag_warn_bitmap[8];
	u32 ap_self_diag_err_bitmap[8];
};
