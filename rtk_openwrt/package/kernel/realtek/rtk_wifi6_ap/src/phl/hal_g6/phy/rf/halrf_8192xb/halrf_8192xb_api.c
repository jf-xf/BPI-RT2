...
u32 ck1920_cav_8192xb[] = {0x9, 0x0, 0x0, 0x3, 0xf, 0xa};
u32 ck960_cbv_8192xb[] = {0x8, 0x2, 0x2, 0x4, 0xf, 0xa};
u32 ck1920_new_8192xb[] = {0x9, 0x0, 0x0, 0x3, 0xf, 0xa};
...
void halrf_set_gpio_8192xb(struct rf_info *rf, enum phl_phy_idx phy)
{
	...
	} else if (rfe_type == 53 || rfe_type == 54 || rfe_type == 94) {
		/*Set BB GPIO Setting*/
		/*PathA=0x1*/
	...
	if (rfe_type > 50) {
		/*Set eFEM diversity*/
		halrf_gpio_setting(rf, 12, 1, true, HALRF_ZERO);
		halrf_set_gpio_func(rf, RTW_MAC_GPIO_WL_RFE_CTRL, 12);
	}
}
