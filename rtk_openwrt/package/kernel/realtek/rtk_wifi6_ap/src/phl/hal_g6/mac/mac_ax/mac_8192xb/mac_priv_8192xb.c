...
#include "wowlan_8192xb.h"
#include "fw_cap_8192xb.h"
...
static struct mac_ax_priv_ops mac8192xb_priv_ops = {
	...
	get_fw_cap_8192xb, /*get fw capability*/
	dump_fw_cap_8192xb, /*dump fw capability*/
#if MAC_AX_PCIE_SUPPORT
	...
	ltr_dyn_ctrl_8192xb, /* ltr_dyn_ctrl */
...
#endif
	get_pcie_support_width_8192xb, /* get_pcie_support_width */
	get_pcie_link_width_8192xb, /* get_pcie_link_width */
	set_pcie_link_width_8192xb, /* set_pcie_link_width */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_usb2phy_para_8192xb, /* read_usb2phy_para */
	write_usb2phy_para_8192xb, /* write_usb2phy_para */
	read_usb3phy_para_8192xb, /* read_usb3phy_para */
	write_usb3phy_para_8192xb, /* write_usb3phy_para */
#endif
	get_wake_reason_8192xb, /* get_wake_reason */
};
