	...
	(struct rf_info *rf, enum phl_phy_idx phy, enum rf_path path)
{
	...
	halrf_wreg(rf, 0x8010, 0x000000ff, 0x00);
	#else
	txgapk_info->is_txgapk_ok = halrf_do_one_shot_8832br(rf, path, 0x8000, MASKDWORD, process_id1[path]);
	...
	halrf_wreg(rf, 0x8010, 0x000000ff, 0x00);
	#else
	txgapk_info->is_txgapk_ok = halrf_do_one_shot_8832br(rf, path, 0x8000, MASKDWORD, process_id2[path]);
	#endif
...
#else
		txgapk_info->is_txgapk_ok = halrf_do_one_shot_8832br(rf, path, 0x8000, MASKDWORD, process_id[path]);
