 ...
 * @var mac_ax_hw_id::MAC_AX_HW_GET_WD_CHECKSUM_CFG
 * for Get wd_checksum_en/hw checker
...
enum mac_ax_csi_release_ctrl {
	MAC_AX_CSI_KEEP = 0,
	MAC_AX_CSI_RELEASE = 1
};
 ...
 * Please Place Description here.
 * @var mac_ax_ft_status::test_l12_busy
 * Please Place Description here.
...
/**
 * @struct mac_ax_intf_deinit_info
 * @brief mac_ax_intf_deinit_info
 *
 * @var mac_ax_intf_deinit_info::fast_deinit_flag
 * Please Place Description here.
 */
struct mac_ax_intf_deinit_info {
	u8 fast_deinit_flag;
...
/**
 * @struct mac_ax_fw_flow_ctrl_tbl
 * @brief mac_ax_fw_flow_ctrl_tbl
 *
 * @var flow_ctrl_en::flow_ctrl_en
 * Please Place Description here.
 * @var macid_nums::macid_nums
 * Please Place Description here.
 * @var rsvd::rsvd
 * Please Place Description here.
 * @var macid::macid
 ...
 * Please Place Description here.
 * @var max_interval::max_interval
 * Please Place Description here.
 * @var min_interval::min_interval
 * Please Place Description here.
 * @var target_throughput::target_throughput
 * Please Place Description here.
 */
struct mac_ax_fw_flow_ctrl_tbl {
	u32 flow_ctrl_en : 1;
	...
	/******************************************************************************
	 * 0 : Normal Flow , no special control
	 * 1 : Latency Flow, guarantee service interval
	 * 2 : Throughput Flow , guarantee throughput
	 * 3 : Hybrid Flow, guarantee throughput and service interval
	 ******************************************************************************/

	u8 flow_type[8];
	u8 max_interval[8]; // in ms
	u8 min_interval[8]; // in ms
	u8 target_throughput[8]; // in 32Mbps
};
...
struct mac_ax_bcn_dynamic_mech {
	u32 bcn_dm_tbtt_shft_en : 1;
	u32 rsvd0: 31;
};
...
/**
 * @struct mac_wdt_log_en
 * @brief mac_wdt_log_en
 *
 * @var mac_wdt_log_en::fw_pc_en
 * Please Place Description here.
 * @var mac_wdt_log_en::fw_st_en
 * Please Place Description here.
 * @var mac_wdt_log_en::tx_cnt_en
 * Please Place Description here.
 * @var mac_wdt_log_en::rx_cnt_en
 * Please Place Description here.
 * @var mac_wdt_log_en::dle_status_en
 * Please Place Description here.
 * @var mac_wdt_log_en::crit_dbg_en
 * Please Place Description here.
 * @var mac_wdt_log_en::rsvd0
 * Please Place Description here.
 */
struct mac_wdt_log_en {
	u8 fw_pc_en:1;
...
/**
 * @struct mac_ax_dctl_extend_macid
 * @brief mac_ax_dctl_extend_macid
 *
 * @var macid::macid
 * Please Place Description here.
 * @var extend_macid::ext macid
 * Please Place Description here.
 */
struct mac_ax_dctl_extend_macid {
	u8 macid;
...
/**
 * @struct mac_ax_wd_checksum_cfg
 * @brief mac_ax_wd_checksum_cfg
 *
 * @var mac_ax_wd_checksum_cfg::sw_fill_wd_checksum_en
 * Please Place Description here.
 * @var mac_ax_wd_checksum_cfg::host_check_en
 * Please Place Description here.
 * @var mac_ax_wd_checksum_cfg::cpu_check_en
 * Please Place Description here.
 */
struct mac_ax_wd_checksum_cfg {
	u8 sw_fill_wd_checksum_en;
	u8 host_check_en;
	u8 cpu_check_en;
};
...
struct mac_ax_coex_gnt {
	...
	struct mac_ax_wl_act bt0;
	struct mac_ax_wl_act bt1;
};
...
/**
 * @struct mac_ax_test_l12_info
 * @brief
 *
 * @var mac_ax_test_l12_info::busy
 * Test L1.2 done or not
 * @var mac_ax_test_l12_info::status
 * Test L1.2 result
 */
struct mac_ax_test_l12_info{
	bool busy;
...
/**
 * @struct mac_ax_mru_grp_info
 * @brief mac_ax_mru_grp_info
 *
 * @var mac_ax_mru_grp_info::dl_ul
 * 0: DL OFDMA Table
 * 1: UL OFDMA Table
 * @var mac_ax_mru_grp_info::grp_vld
 * 0: grp enable bit
 * 1: grp disable bit
 * @var mac_ax_mru_grp_info::is_hw_grp
 * 0: sw grp
 * 1: hw grp
 * @var mac_ax_mru_grp_info::band
 * MLO / DBCC band selection
 * @var mac_ax_mru_grp_info::mru
 * 0 : mu
 * 1 : ru
 * @var mac_ax_mru_grp_info::sta_cnt
 * the OFDMA table station count
 * @var mac_ax_mru_grp_info::grp_id
 * the OFDMA table group id
 * @var mac_ax_mru_grp_info::trigger_len
 * the trigger tcp ack apep length
 * @var mac_ax_mru_grp_info::trigger_threshold
 * the trigger tcp ack threshold
 * @var mac_ax_mru_grp_info::ul_bsr_sel
 * the UL BSR selection (only 0 and 1 )
 * @var mac_ax_mru_grp_info::macid
 * the macid of station
 */
...
struct mac_ax_nan_avail_t_bitmap_info {
	/* dword0 */
	u8 module_id;
	u8 option;
	u16 start_offset_16tu;
	/* dword1 */
	u16 period_tu;
	u8 bit_duration_tu;
	u8 time_bitmap_len;
	...
	u32 time_bitmap_4_7;
	/* dword4 */
	u32 time_bitmap_8_11;
	/* dword5 */
	u32 time_bitmap_12_15;
	/* dword6 */
	u8 channel;
	u8 bw;
	u8 primary_ch_idx;
...
struct mac_fw_cap_info {
	u32 ser_support_map;
	u8 is_support[LAST_FEAT_SEL];
	u8 version[LAST_FEAT_SEL];
	u8 sub_version[LAST_FEAT_SEL];
};
...
struct mac_ax_intf_ops {
	 ...
	 * may cause system crash or segmentation fault.
	 */
	u32 (*get_pcie_sup_speed)(struct mac_ax_adapter *adapter);
	/**
	 * @ctrl_txhci
	 * Only support PCIE interface. Using this API in other interface
	 * may cause system crash or segmentation fault.
...
struct mac_ax_ops {
	...
	u32 (*fw_flow_ctrl_upd)(struct mac_ax_adapter *adapter,
				struct mac_ax_fw_flow_ctrl_tbl *info);
	u32 (*mru_grp_upd)(struct mac_ax_adapter *adapter,
	...
	u32 (*set_hwseq_reg)(struct mac_ax_adapter *adapter,
			     u8 reg_seq_idx,
			     u16 reg_seq_val);
	u32 (*set_hwseq_extend_macid)(struct mac_ax_adapter *adapter,
				      struct mac_ax_dctl_extend_macid *seq_info);
	u32 (*set_hwseq_dctl_seq_val)(struct mac_ax_adapter *adapter,
	...
	u32 (*trx_mode_switch)(struct mac_ax_adapter *adapter,
			       enum mac_ax_trx_mode trx_mode);
	...
	u32 (*chk_l1_rvy_status)(struct mac_ax_adapter *adapter, u32 *rvy_status);
	...
	u32 (*get_test_l12_done)(struct mac_ax_adapter *adapter);
	u32 (*get_test_l12_rpt)(struct mac_ax_adapter *adapter, u32 *test_l12_status_code);
