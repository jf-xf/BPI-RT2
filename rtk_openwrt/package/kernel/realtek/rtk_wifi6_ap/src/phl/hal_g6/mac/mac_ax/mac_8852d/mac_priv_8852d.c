...
#include "dle_8852d.h"
#include "wowlan_8852d.h"
#include "fw_cap_8852d.h"
...
static struct mac_ax_priv_ops mac8852d_priv_ops = {
	...
	get_fw_cap_8852d, /*get fw capability*/
	dump_fw_cap_8852d, /*dump fw capability*/
#if MAC_AX_PCIE_SUPPORT
	...
	ltr_dyn_ctrl_8852d, /* ltr_dyn_ctrl */
...
#endif
	get_pcie_support_width_8852d, /* get_pcie_support_width */
	get_pcie_link_width_8852d, /* get_pcie_link_width */
	set_pcie_link_width_8852d, /* set_pcie_link_width */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_usb2phy_para_8852d, /* read_usb2phy_para */
	write_usb2phy_para_8852d, /* write_usb2phy_para */
	read_usb3phy_para_8852d, /* read_usb3phy_para */
	write_usb3phy_para_8852d, /* write_usb3phy_para */
#endif
	get_wake_reason_8852d, /* get_wake_reason */
};
