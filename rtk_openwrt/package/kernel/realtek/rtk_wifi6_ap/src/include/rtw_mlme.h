...
enum {
	...
	SS_DENY_SELF_AP_UNDER_STA_LINKING,
...
#define SET_EXT_CAPABILITY_ELE_EXT_CH_SWITCH(_pEleStart, _val)	SET_BITS_TO_LE_1BYTE(((u8 *)(_pEleStart)), 2, 1, _val)
#define GET_EXT_CAPABILITY_ELE_EXT_CH_SWITCH(_pEleStart)		LE_BITS_TO_1BYTE(((u8 *)(_pEleStart)), 2, 1)
#endif
