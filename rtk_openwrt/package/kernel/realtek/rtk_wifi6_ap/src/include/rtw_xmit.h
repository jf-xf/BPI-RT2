...
// max sub pkt size is defined to 2047(2^11 - 1) in both hal_trx_8852ce.h and hal_trx_8192xbe.h
// if the value is changed in hal layer, should also update here
#define MAX_SUB_PKT_SIZE 2047
#endif
...
//updated by rtw_core_update_xmitframe
	...
	u32 tx_force_rate; /* for checking supported data rate */
#endif
};
#endif
