...
#define WLAN_STA_MULTI_AP_FRONTHAUL_BSS BIT(17)
#define WLAN_STA_MULTI_AP_BACKHAUL_BSS BIT(18)
#define WLAN_STA_MULTI_AP_BACKHAUL_STA BIT(19)
#define WLAN_STA_MULTI_AP (WLAN_STA_MULTI_AP_FRONTHAUL_BSS | WLAN_STA_MULTI_AP_BACKHAUL_BSS | WLAN_STA_MULTI_AP_BACKHAUL_STA)
#endif
...
/* Alias for compiling, should be removed in future */
#define WLAN_EID_SUPPORTED_REGULATORY_CLASSES WLAN_EID_SUPPORTED_OPERATING_CLASSES
#define WLAN_EID_EXTENDED_CHANNEL_SWITCH WLAN_EID_EXT_CHANSWITCH_ANN
#define WLAN_EID_MPM WLAN_EID_PEER_MGMT
#define WLAN_EID_EXT_CAPABILITY WLAN_EID_EXT_CAPAB
#define WLAN_EID_VHT_CAPABILITY WLAN_EID_VHT_CAP
#define WLAN_EID_WIDE_BANDWIDTH_CHANNEL_SWITCH WLAN_EID_WIDE_BW_CHSWITCH
#define WLAN_EID_VHT_TRANSMIT_POWER_ENVELOPE WLAN_EID_TRANSMIT_POWER_ENVELOPE
#define WLAN_EID_VHT_OP_MODE_NOTIFY WLAN_EID_OPERATING_MODE_NOTIFICATION
#define WLAN_EID_GENERIC WLAN_EID_VENDOR_SPECIFIC

#define WLAN_EID_EXTENSION_HE_CAPABILITY WLAN_EID_EXT_HE_CAPABILITIES
#define WLAN_EID_EXTENSION_HE_OPERATION WLAN_EID_EXT_HE_OPERATION
#define WLAN_EID_EXTENSION_MU_EDCA WLAN_EID_EXT_HE_MU_EDCA_PARAMS
#define WLAN_EID_EXT_HE_6G_CAP WLAN_EID_EXT_HE_6GHZ_BAND_CAP
...
u8 *rtw_set_ie_extended_ch_switch(u8 *buf, u32 *buf_len, u8 ch_switch_mode, u8 op_class, u8 new_ch, u8 ch_switch_cnt);
#endif
