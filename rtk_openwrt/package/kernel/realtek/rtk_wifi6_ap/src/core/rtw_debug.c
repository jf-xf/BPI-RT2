...
#ifdef CONFIG_RTW_TRIBAND_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_TRIBAND_SUPPORT\n");
#endif

#ifdef CONFIG_RTW_DRV_HAS_NVM
	RTW_PRINT_SEL(sel, "CONFIG_RTW_DRV_HAS_NVM\n");
#endif
#ifdef CONFIG_LIMITED_AP_NUM
	RTW_PRINT_SEL(sel, "CONFIG_LIMITED_AP_NUM=%d\n", CONFIG_LIMITED_AP_NUM);
#endif
#ifdef CONFIG_LIMITED_STA_NUM
	RTW_PRINT_SEL(sel, "CONFIG_LIMITED_STA_NUM=%d\n", CONFIG_LIMITED_STA_NUM);
#endif
#ifdef CONFIG_2G_ON_WLAN0
	RTW_PRINT_SEL(sel, "CONFIG_2G_ON_WLAN0\n");
#endif
#ifdef CONFIG_2G_ON_PCIE_SLOT0
	RTW_PRINT_SEL(sel, "CONFIG_2G_ON_PCIE_SLOT0\n");
#endif
#ifdef CONFIG_AX_SHARE_XTAL
	RTW_PRINT_SEL(sel, "CONFIG_AX_SHARE_XTAL\n");
#ifdef CONFIG_WLAN_SHARE_XTAL
	RTW_PRINT_SEL(sel, "  > CONFIG_WLAN_SHARE_XTAL\n");
#endif
#ifdef CONFIG_SOC_SHARE_XTAL
	RTW_PRINT_SEL(sel, "  > CONFIG_SOC_SHARE_XTAL\n");
#endif
#endif
#ifdef CONFIG_DMA_NONCOHERENT
	RTW_PRINT_SEL(sel, "CONFIG_DMA_NONCOHERENT\n");
#endif
#ifdef CONFIG_RTW_EFEM_IDENTIFY_WITH_FLASH
	RTW_PRINT_SEL(sel, "CONFIG_RTW_EFEM_IDENTIFY_WITH_FLASH\n");
#endif
#ifdef CONFIG_24G_256QAM
	RTW_PRINT_SEL(sel, "CONFIG_24G_256QAM\n");
#endif
#ifdef CONFIG_RTW_80211W_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_80211W_SUPPORT\n");
#endif
#ifdef CONFIG_WIFI6_WPA3
	RTW_PRINT_SEL(sel, "CONFIG_WIFI6_WPA3\n");
#endif
#ifdef CONFIG_RTW_CLIENT_MODE_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_CLIENT_MODE_SUPPORT\n");
#endif
#ifdef CONFIG_RTW_REPEATER_MODE_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_REPEATER_MODE_SUPPORT\n");
#endif
#ifdef CONFIG_RTW_A4_STA
	RTW_PRINT_SEL(sel, "CONFIG_RTW_A4_STA\n");
#endif
#ifdef CONFIG_WLAN_EVENT_INDICATE_GENL
	RTW_PRINT_SEL(sel, "CONFIG_WLAN_EVENT_INDICATE_GENL\n");
#endif
#ifdef CONFIG_RTW_SBWC
	RTW_PRINT_SEL(sel, "CONFIG_RTW_SBWC\n");
#endif
#ifdef CONFIG_RTW_GBWC
	RTW_PRINT_SEL(sel, "CONFIG_RTW_GBWC\n");
#endif
#ifdef CONFIG_AP_NEIGHBOR_INFO
	RTW_PRINT_SEL(sel, "CONFIG_AP_NEIGHBOR_INFO\n");
#endif
#ifdef CONFIG_RTW_CURRENT_RATE_ACCOUNTING
	RTW_PRINT_SEL(sel, "CONFIG_RTW_CURRENT_RATE_ACCOUNTING\n");
#endif
#ifdef CONFIG_ETHER_PKT_AGG
	RTW_PRINT_SEL(sel, "CONFIG_ETHER_PKT_AGG\n");
#endif
#ifdef CONFIG_RTW_MULTI_AP
	RTW_PRINT_SEL(sel, "CONFIG_RTW_MULTI_AP\n");
#ifdef CONFIG_RTW_MULTI_AP_R1
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_MULTI_AP_R1\n");
#endif
#ifdef CONFIG_RTW_MULTI_AP_R2
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_MULTI_AP_R2\n");
#endif
#ifdef CONFIG_RTW_MULTI_AP_R3
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_MULTI_AP_R3\n");
#endif
#ifdef CONFIG_RTW_MULTI_AP_R4
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_MULTI_AP_R4\n");
#endif
#ifdef CONFIG_RTW_MULTI_AP_LOGO
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_MULTI_AP_LOGO\n");
#endif
#endif
#ifdef CONFIG_RTW_80211K
	RTW_PRINT_SEL(sel, "CONFIG_RTW_80211K\n");
#endif
#ifdef CONFIG_RTW_80211V
	RTW_PRINT_SEL(sel, "CONFIG_RTW_80211V\n");
#endif
#ifdef CONFIG_RTW_80211R
	RTW_PRINT_SEL(sel, "CONFIG_RTW_80211R\n");
#endif
#ifdef CONFIG_WLAN_MANAGER
	RTW_PRINT_SEL(sel, "CONFIG_WLAN_MANAGER\n");
#endif
#ifdef CONFIG_BAND_STEERING
	RTW_PRINT_SEL(sel, "CONFIG_BAND_STEERING\n");
#endif
#ifdef CONFIG_RTW_CROSSBAND_REPEATER_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_CROSSBAND_REPEATER_SUPPORT\n");
#endif
#ifdef CONFIG_RTW_COMMON_NETLINK
	RTW_PRINT_SEL(sel, "CONFIG_RTW_COMMON_NETLINK\n");
#endif
#ifdef CONFIG_RECORD_CLIENT_HOST
	RTW_PRINT_SEL(sel, "CONFIG_RECORD_CLIENT_HOST\n");
#endif
#ifdef CONFIG_RTW_SSID_PRIORITY
	RTW_PRINT_SEL(sel, "CONFIG_RTW_SSID_PRIORITY\n");
#endif
#ifdef CONFIG_CTC_FEATURE
	RTW_PRINT_SEL(sel, "CONFIG_CTC_FEATURE\n");
#endif
#ifdef CONFIG_CMCC_FEATURE
	RTW_PRINT_SEL(sel, "CONFIG_CMCC_FEATURE\n");
#endif
#ifdef CONFIG_RTW_DE_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_DE_SUPPORT\n");
#endif
#ifdef CONFIG_RTL_CFG80211_WAPI_SUPPORT
	RTW_PRINT_SEL(sel, "CONFIG_RTL_CFG80211_WAPI_SUPPORT\n");
#endif
#ifdef CONFIG_WIFI_LED_SHARE_WITH_WPS
	RTW_PRINT_SEL(sel, "CONFIG_WIFI_LED_SHARE_WITH_WPS\n");
#endif
#ifdef CONFIG_RTW_SW_LED_SHARED
	RTW_PRINT_SEL(sel, "CONFIG_RTW_SW_LED_SHARED\n");
#ifdef CONFIG_RTW_SW_LED_SHARED_USING_2G
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_SW_LED_SHARED_USING_2G\n");
#endif
#ifdef CONFIG_RTW_SW_LED_SHARED_USING_5G
	RTW_PRINT_SEL(sel, "  > CONFIG_RTW_SW_LED_SHARED_USING_5G\n");
#endif
#endif
#ifdef CONFIG_RTW_BYPASS_DEAMSDU
	RTW_PRINT_SEL(sel, "CONFIG_RTW_BYPASS_DEAMSDU\n");
#endif
#ifdef CONFIG_RTW_CUSTOM_PWRLMT
	RTW_PRINT_SEL(sel, "CONFIG_RTW_CUSTOM_PWRLMT\n");
#endif
...
#ifdef CONFIG_RTW_DEBUG_CAM_CACHE
...
int proc_get_ap_info(struct seq_file *m, void *v)
{
	...
	if (psta) {
		...
		if(tmp_wireless_mode & WLAN_MD_11AX)
		{
			...
			tmp_wireless_mode |= WLAN_MD_11N;
		wireless_mode_to_str(pregpriv->band, wl_mode);
		...
		RTW_PRINT_SEL(m, "wireless_mode=0x%x(%s), cur_wireless_mode=0x%x(%s), rtsen=%d, cts2slef=%d\n", pregpriv->band, wl_mode, tmp_wireless_mode, cur_wl_mode, psta->phl_sta->rts_en, psta->phl_sta->cts2self);
	...
	RTW_PRINT_SEL(m,"txbf mu apply bitmap :%x\n", padapter->dvobj->txbf_mu_apply_bitmap);
#endif
	return 0;
}
...
{
	if (rate >= RTW_DATA_RATE_CCK1 && rate <= RTW_DATA_RATE_MCS31) {
		switch (rate) {
...
#undef CASE_HT_RATE
		default:
			return "CCK_UNKNOWN, OFDM_UNKNOWN, or HT_UNKNOWN";
		}
	}
...
int proc_get_tx_logs(struct seq_file *m, void *v)
{
	...
	RTW_PRINT_SEL(m,
			  ...
			  "core_tx_data_frame(tx/ok/fail)= %d/%d/%d\n"
		      ...
		      tx_logs->core_tx_add_req_data,
		  	  tx_logs->core_tx_add_req_data,
			  tx_logs->core_tx_recycle_data_frame_ok,
			  tx_logs->core_tx_recycle_data_frame_fail,
	...
	RTW_PRINT_SEL(m,
		      ...
		      "dhcp_discover(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_offer(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_request(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_decline(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_ack(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_nak(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_release(tx/ok/fail)= %d/%d/%d\n"
		      "dhcp_inform(tx/ok/fail)= %d/%d/%d\n",
		      ...
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_DISCOVER],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_DISCOVER],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_DISCOVER],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_OFFER],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_OFFER],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_OFFER],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_REQUEST],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_REQUEST],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_REQUEST],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_DECLINE],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_DECLINE],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_DECLINE],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_ACK],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_ACK],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_ACK],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_NAK],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_NAK],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_NAK],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_RELEASE],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_RELEASE],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_RELEASE],
		      tx_logs->core_hndsk_tx_cnt[HNDSK_DHCP_INFORM],
		      tx_logs->core_hndsk_tx_ok_cnt[HNDSK_DHCP_INFORM],
		      tx_logs->core_hndsk_tx_fail_cnt[HNDSK_DHCP_INFORM]);
#endif
	RTW_PRINT_SEL(m,
		      "tx_wmm_pkts[BE]=%llu\n"
		      "tx_wmm_pkts[BK]=%llu\n"
...
ssize_t proc_set_rx_ampdu(struct file *file, const char __user *buffer, size_t count, loff_t *pos, void *data)
{
	...
	if (buffer && !copy_from_user(tmp, buffer, count)) {
		...
		if (num >= 2) {
			RTW_PRINT("set fix_rx_ampdu_size = %d\n", size);
...
int proc_get_rx_ampdu_factor(struct seq_file *m, void *v)
{
	...
	if (padapter) {
		RTW_PRINT_SEL(m, "rx_ampdu_factor is set in HT_IE\n");
		RTW_PRINT_SEL(m, "rx_ampdu_factor = %d (0:8k, 1:16k, 2:32k, 3:64k)(def:0xff)\n",
						padapter->driver_rx_ampdu_factor);/* RX_AMPDU_SIZE_INVALID */
	}
				 ...
				 , size_t count, loff_t *pos, void *data)
{
	...
	if (buffer && !copy_from_user(tmp, buffer, count)) {
		...
		if (padapter && (num == 1)) {
			if (factor > 3) {
				RTW_PRINT("manual rx_ampdu_factor max is 3\n");
			} else
				padapter->driver_rx_ampdu_factor = factor;

			RTW_PRINT("set rx_ampdu_factor = %d (0:8k, 1:16k, 2:32k, 3:64k)(def:0xff)\n",
				padapter->driver_rx_ampdu_factor);/* RX_AMPDU_SIZE_INVALID */
		}
	}
