...
INT8U *parse_multi_ap_TLV_from_packet(INT8U *packet_stream)
{
	...
	default: {
		// Ignore
		//
		return parse_1905_TLV_from_packet(packet_stream);
	}
	}
...
INT8U *forge_multi_ap_TLV_from_structure(INT8U *memory_structure, INT16U *len)
{
	...
	default: {
		// Ignore
		//
		return forge_1905_TLV_from_structure(memory_structure, len, 0);
	}
	}
...
void free_multi_ap_TLV_structure(INT8U *memory_structure)
{
	...
	default: {
		// Ignore
		//
		free_1905_TLV_structure(memory_structure);
		return;
	}
	}
...
INT8U compare_multi_ap_TLV_structures(INT8U *memory_structure_1, INT8U *memory_structure_2)
{
	...
	default: {
		...
		//
		return compare_1905_TLV_structures(memory_structure_1, memory_structure_2);
	}
	}
...
void visit_multi_ap_TLV_structure(
...
#define MAX_PREFIX 100
	...
	default: {
		// Ignore
		//
		visit_1905_TLV_structure(memory_structure, callback, write_function, prefix);
		break;
	}
	}
