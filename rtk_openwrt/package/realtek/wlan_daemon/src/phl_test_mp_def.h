...
enum mp_flash_cmd {
	MP_FLASH_CMD_READ,
	MP_FLASH_CMD_WRITE,
	MP_FLASH_CMD_READ_XCAP,
	MP_FLASH_CMD_WRITE_XCAP,
	MP_FLASH_CMD_READ_THERMAL,
	MP_FLASH_CMD_WRITE_THERMAL,
	MP_FLASH_CMD_READ_TSSI_TABLE,
	MP_FLASH_CMD_WRITE_TSSI_TABLE,
    MP_FLASH_CMD_MAX,
};
